module github.com/pulumi/pulumi-digitalocean/provider
...
require (
	...
	github.com/terraform-providers/terraform-provider-digitalocean v1.15.1
)
...
replace (
	...
	golang.org/x/crypto => golang.org/x/crypto v0.0.0-20190923035154-9ee001bba392
