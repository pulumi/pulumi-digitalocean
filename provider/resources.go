		...
		ExtraTypes: map[string]schema.ComplexTypeSpec{
			...
			"digitalocean:index:DropletSlug": {
				...
				Enum: []schema.EnumValueSpec{
					...
					{Name: "DropletS1VCPU1GBAMD", Value: "s-1vcpu-1gb-amd"},
					{Name: "DropletS1VCPU1GBINTEL", Value: "s-1vcpu-1gb-intel"},
					{Name: "DropletS1VCPU1GB35GBINTEL", Value: "s-1vcpu-1gb-35gb-intel"},
					{Name: "DropletS1VCPU2GB", Value: "s-1vcpu-2gb"},
					{Name: "DropletS1VCPU2GBAMD", Value: "s-1vcpu-2gb-amd"},
					{Name: "DropletS1VCPU2GBINTEL", Value: "s-1vcpu-2gb-intel"},
					{Name: "DropletS1VCPU2GB70GBINTEL", Value: "s-1vcpu-2gb-70gb-intel"},
					{Name: "DropletS2VCPU2GB", Value: "s-2vcpu-2gb"},
					{Name: "DropletS2VCPU2GBAMD", Value: "s-2vcpu-2gb-amd"},
					{Name: "DropletS2VCPU2GBINTEL", Value: "s-2vcpu-2gb-intel"},
					{Name: "DropletS2VCPU2GB90GBINTEL", Value: "s-2vcpu-2gb-90gb-intel"},
					{Name: "DropletS2VCPU4GB", Value: "s-2vcpu-4gb"},
					{Name: "DropletS2VCPU4GBAMD", Value: "s-2vcpu-4gb-amd"},
					{Name: "DropletS2VCPU4GBINTEL", Value: "s-2vcpu-4gb-intel"},
					{Name: "DropletS2VCPU4GB120GBINTEL", Value: "s-2vcpu-4gb-120gb-intel"},
					{Name: "DropletS2VCPU8GBAMD", Value: "s-2vcpu-8gb-amd"},
					{Name: "DropletC2", Value: "c-2"},
					{Name: "DropletC22VCPU4GB", Value: "c2-2vcpu-4gb"},
					{Name: "DropletS2VCPU8GB160GBINTEL", Value: "s-2vcpu-8gb-160gb-intel"},
					{Name: "DropletS4VCPU8GB", Value: "s-4vcpu-8gb"},
					{Name: "DropletS4VCPU8GBAMD", Value: "s-4vcpu-8gb-amd"},
					{Name: "DropletS4VCPU8GBINTEL", Value: "s-4vcpu-8gb-intel"},
					{Name: "DropletG2VCPU8GB", Value: "g-2vcpu-8gb"},
					{Name: "DropletS4VCPU8GB240GBINTEL", Value: "s-4vcpu-8gb-240gb-intel"},
					{Name: "DropletGD2VCPU8GB", Value: "gd-2vcpu-8gb"},
					{Name: "DropletG2VCPU8GBINTEL", Value: "g-2vcpu-8gb-intel"},
					{Name: "DropletGD2VCPU8GBINTEL", Value: "gd-2vcpu-8gb-intel"},
					{Name: "DropletS4VCPU16GBAMD", Value: "s-4vcpu-16gb-amd"},
					{Name: "DropletM2VCPU16GB", Value: "m-2vcpu-16gb"},
					{Name: "DropletC4", Value: "c-4"},
					{Name: "DropletC24VCPU8GB", Value: "c2-4vcpu-8gb"},
					{Name: "DropletS4VCPU16GB320GBINTEL", Value: "s-4vcpu-16gb-320gb-intel"},
					{Name: "DropletS8VCPU16GB", Value: "s-8vcpu-16gb"},
					{Name: "DropletM2VCPU16GBINTEL", Value: "m-2vcpu-16gb-intel"},
					{Name: "DropletM32VCPU16GB", Value: "m3-2vcpu-16gb"},
					{Name: "DropletC4INTEL", Value: "c-4-intel"},
					{Name: "DropletM32VCPU16GBINTEL", Value: "m3-2vcpu-16gb-intel"},
					{Name: "DropletS8VCPU16GBAMD", Value: "s-8vcpu-16gb-amd"},
					{Name: "DropletS8VCPU16GBINTEL", Value: "s-8vcpu-16gb-intel"},
					{Name: "DropletC24VCPU8GBINTEL", Value: "c2-4vcpu-8gb-intel"},
					{Name: "DropletG4VCPU16GB", Value: "g-4vcpu-16gb"},
					{Name: "DropletS8VCPU16GB480GBINTEL", Value: "s-8vcpu-16gb-480gb-intel"},
					{Name: "DropletSO2VCPU16GBINTEL", Value: "so-2vcpu-16gb-intel"},
					...
					{Name: "DropletSO1_52VCPU16GBINTEL", Value: "so1_5-2vcpu-16gb-intel"},
					{Name: "DropletG4VCPU16GBINTEL", Value: "g-4vcpu-16gb-intel"},
					{Name: "DropletGD4VCPU16GBINTEL", Value: "gd-4vcpu-16gb-intel"},
					{Name: "DropletSO1_52VCPU16GB", Value: "so1_5-2vcpu-16gb"},
					{Name: "DropletS8VCPU32GBAMD", Value: "s-8vcpu-32gb-amd"},
					{Name: "DropletM4VCPU32GB", Value: "m-4vcpu-32gb"},
					{Name: "DropletC8", Value: "c-8"},
					{Name: "DropletC28VCPU16GB", Value: "c2-8vcpu-16gb"},
					{Name: "DropletS8VCPU32GB640GBINTEL", Value: "s-8vcpu-32gb-640gb-intel"},
					{Name: "DropletM4VCPU32GBINTEL", Value: "m-4vcpu-32gb-intel"},
					{Name: "DropletM34VCPU32GB", Value: "m3-4vcpu-32gb"},
					{Name: "DropletC8INTEL", Value: "c-8-intel"},
					{Name: "DropletM34VCPU32GBINTEL", Value: "m3-4vcpu-32gb-intel"},
					{Name: "DropletC28VCPU16GBINTEL", Value: "c2-8vcpu-16gb-intel"},
					{Name: "DropletG8VCPU32GB", Value: "g-8vcpu-32gb"},
					{Name: "DropletSO4VCPU32GBINTEL", Value: "so-4vcpu-32gb-intel"},
					...
					{Name: "DropletSO1_54VCPU32GBINTEL", Value: "so1_5-4vcpu-32gb-intel"},
					{Name: "DropletG8VCPU32GBINTEL", Value: "g-8vcpu-32gb-intel"},
					{Name: "DropletGD8VCPU32GBINTEL", Value: "gd-8vcpu-32gb-intel"},
					...
					{Name: "DropletM8VCPU64GBINTEL", Value: "m-8vcpu-64gb-intel"},
					{Name: "DropletM38VCPU64GB", Value: "m3-8vcpu-64gb"},
					{Name: "DropletC16INTEL", Value: "c-16-intel"},
					{Name: "DropletM38VCPU64GBINTEL", Value: "m3-8vcpu-64gb-intel"},
					{Name: "DropletC216VCPU32GBINTEL", Value: "c2-16vcpu-32gb-intel"},
					{Name: "DropletG16VCPU64GB", Value: "g-16vcpu-64gb"},
					{Name: "DropletSO8VCPU64GBINTEL", Value: "so-8vcpu-64gb-intel"},
					...
					{Name: "DropletSO1_58VCPU64GBINTEL", Value: "so1_5-8vcpu-64gb-intel"},
					{Name: "DropletG16VCPU64GBINTEL", Value: "g-16vcpu-64gb-intel"},
					{Name: "DropletGD16VCPU64GBINTEL", Value: "gd-16vcpu-64gb-intel"},
					...
					{Name: "DropletM16VCPU128GBINTEL", Value: "m-16vcpu-128gb-intel"},
					{Name: "DropletM316VCPU128GB", Value: "m3-16vcpu-128gb"},
					{Name: "DropletC32INTEL", Value: "c-32-intel"},
					{Name: "DropletM316VCPU128GBINTEL", Value: "m3-16vcpu-128gb-intel"},
					{Name: "DropletC232VCPU64GBINTEL", Value: "c2-32vcpu-64gb-intel"},
					{Name: "DropletC48", Value: "c-48"},
					{Name: "DropletM24VCPU192GB", Value: "m-24vcpu-192gb"},
					{Name: "DropletG32VCPU128GB", Value: "g-32vcpu-128gb"},
					{Name: "DropletSO16VCPU128GBINTEL", Value: "so-16vcpu-128gb-intel"},
					...
					{Name: "DropletSO1_516VCPU128GBINTEL", Value: "so1_5-16vcpu-128gb-intel"},
					{Name: "DropletC248VCPU96GB", Value: "c2-48vcpu-96gb"},
					{Name: "DropletM24VCPU192GBINTEL", Value: "m-24vcpu-192gb-intel"},
					{Name: "DropletG32VCPU128GBINTEL", Value: "g-32vcpu-128gb-intel"},
					{Name: "DropletM324VCPU192GB", Value: "m3-24vcpu-192gb"},
					{Name: "DropletG40VCPU160GB", Value: "g-40vcpu-160gb"},
					{Name: "DropletGD32VCPU128GBINTEL", Value: "gd-32vcpu-128gb-intel"},
					{Name: "DropletSO1_516VCPU128GB", Value: "so1_5-16vcpu-128gb"},
					{Name: "DropletC48INTEL", Value: "c-48-intel"},
					{Name: "DropletM324VCPU192GBINTEL", Value: "m3-24vcpu-192gb-intel"},
					{Name: "DropletM32VCPU256GB", Value: "m-32vcpu-256gb"},
					{Name: "DropletGD40VCPU160GB", Value: "gd-40vcpu-160gb"},
					{Name: "DropletC248VCPU96GBINTEL", Value: "c2-48vcpu-96gb-intel"},
					{Name: "DropletSO24VCPU192GBINTEL", Value: "so-24vcpu-192gb-intel"},
					{Name: "DropletSO24VCPU192GB", Value: "so-24vcpu-192gb"},
					{Name: "DropletM624VCPU192GB", Value: "m6-24vcpu-192gb"},
					{Name: "DropletM32VCPU256GBINTEL", Value: "m-32vcpu-256gb-intel"},
					{Name: "DropletC60INTEL", Value: "c-60-intel"},
					{Name: "DropletM332VCPU256GB", Value: "m3-32vcpu-256gb"},
					{Name: "DropletSO1_524VCPU192GBINTEL", Value: "so1_5-24vcpu-192gb-intel"},
					{Name: "DropletM332VCPU256GBINTEL", Value: "m3-32vcpu-256gb-intel"},
					{Name: "DropletG48VCPU192GBINTEL", Value: "g-48vcpu-192gb-intel"},
					{Name: "DropletC260VCPU120GBINTEL", Value: "c2-60vcpu-120gb-intel"},
					{Name: "DropletGD48VCPU192GBINTEL", Value: "gd-48vcpu-192gb-intel"},
					{Name: "DropletSO1_524VCPU192GB", Value: "so1_5-24vcpu-192gb"},
					{Name: "DropletSO32VCPU256GBINTEL", Value: "so-32vcpu-256gb-intel"},
					{Name: "DropletSO32VCPU256GB", Value: "so-32vcpu-256gb"},
					{Name: "DropletM632VCPU256GB", Value: "m6-32vcpu-256gb"},
					{Name: "DropletSO1_532VCPU256GBINTEL", Value: "so1_5-32vcpu-256gb-intel"},
					{Name: "DropletG60VCPU240GBINTEL", Value: "g-60vcpu-240gb-intel"},
					{Name: "DropletM48VCPU384GBINTEL", Value: "m-48vcpu-384gb-intel"},
					{Name: "DropletGD60VCPU240GBINTEL", Value: "gd-60vcpu-240gb-intel"},
					{Name: "DropletGPUH100X180GB", Value: "gpu-h100x1-80gb"},
					{Name: "DropletSO1_532VCPU256GB", Value: "so1_5-32vcpu-256gb"},
					{Name: "DropletM348VCPU384GBINTEL", Value: "m3-48vcpu-384gb-intel"},
					{Name: "DropletSO48VCPU384GBINTEL", Value: "so-48vcpu-384gb-intel"},
