...
@CustomType
public final class GetAppSpecStaticSiteBitbucket {
    /**
    ...
    private GetAppSpecStaticSiteBitbucket() {}
    /**
     * @return The name of the branch to use.
     * 
     */
    ...
    public static Builder builder(GetAppSpecStaticSiteBitbucket defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String repo;
        public Builder() {}
        public Builder(GetAppSpecStaticSiteBitbucket defaults) {
        ...
        public GetAppSpecStaticSiteBitbucket build() {
            final var _resultValue = new GetAppSpecStaticSiteBitbucket();
