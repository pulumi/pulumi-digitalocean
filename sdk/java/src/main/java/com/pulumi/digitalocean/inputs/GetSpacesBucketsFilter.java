...
public final class GetSpacesBucketsFilter extends com.pulumi.resources.InvokeArgs {

    public static final GetSpacesBucketsFilter Empty = new GetSpacesBucketsFilter();
    ...
    private GetSpacesBucketsFilter(GetSpacesBucketsFilter $) {
        this.all = $.all;
        this.key = $.key;
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetSpacesBucketsFilter();
        }

        public Builder(GetSpacesBucketsFilter defaults) {
            $ = new GetSpacesBucketsFilter(Objects.requireNonNull(defaults));
        }
        ...
        public GetSpacesBucketsFilter build() {
            if ($.key == null) {
                throw new MissingRequiredPropertyException("GetSpacesBucketsFilter", "key");
            }
            if ($.values == null) {
                throw new MissingRequiredPropertyException("GetSpacesBucketsFilter", "values");
            }
            return $;
        }
    }
