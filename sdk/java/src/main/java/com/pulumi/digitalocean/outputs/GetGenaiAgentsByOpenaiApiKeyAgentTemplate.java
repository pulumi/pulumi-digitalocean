...
import com.pulumi.digitalocean.outputs.GetGenaiAgentsByOpenaiApiKeyAgentTemplateKnowledgeBase;
import com.pulumi.digitalocean.outputs.GetGenaiAgentsByOpenaiApiKeyAgentTemplateModel;
...
@CustomType
public final class GetGenaiAgentsByOpenaiApiKeyAgentTemplate {
    /**
     ...
     * 
     */
    private @Nullable List<GetGenaiAgentsByOpenaiApiKeyAgentTemplateKnowledgeBase> knowledgeBases;
    /**
     ...
     * 
     */
    private @Nullable List<GetGenaiAgentsByOpenaiApiKeyAgentTemplateModel> models;
    /**
    ...
    private GetGenaiAgentsByOpenaiApiKeyAgentTemplate() {}
    /**
     * @return Created At timestamp for the Knowledge Base
     * 
     */
     ...
     * 
     */
    public List<GetGenaiAgentsByOpenaiApiKeyAgentTemplateKnowledgeBase> knowledgeBases() {
     ...
     * 
     */
    public List<GetGenaiAgentsByOpenaiApiKeyAgentTemplateModel> models() {
    ...
    public static Builder builder(GetGenaiAgentsByOpenaiApiKeyAgentTemplate defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String uuid;
        public Builder() {}
        public Builder(GetGenaiAgentsByOpenaiApiKeyAgentTemplate defaults) {
        ...
        public Builder createdAt(String createdAt) {
            if (createdAt == null) {
              throw new MissingRequiredPropertyException("GetGenaiAgentsByOpenaiApiKeyAgentTemplate", "createdAt");
            }
        ...
        @CustomType.Setter
        public Builder knowledgeBases(@Nullable List<GetGenaiAgentsByOpenaiApiKeyAgentTemplateKnowledgeBase> knowledgeBases) {

            this.knowledgeBases = knowledgeBases;
            return this;
        }
        public Builder knowledgeBases(GetGenaiAgentsByOpenaiApiKeyAgentTemplateKnowledgeBase... knowledgeBases) {
        ...
        @CustomType.Setter
        public Builder models(@Nullable List<GetGenaiAgentsByOpenaiApiKeyAgentTemplateModel> models) {

            this.models = models;
            return this;
        }
        public Builder models(GetGenaiAgentsByOpenaiApiKeyAgentTemplateModel... models) {
        ...
        public Builder updatedAt(String updatedAt) {
            if (updatedAt == null) {
              throw new MissingRequiredPropertyException("GetGenaiAgentsByOpenaiApiKeyAgentTemplate", "updatedAt");
            }
        ...
        public GetGenaiAgentsByOpenaiApiKeyAgentTemplate build() {
            final var _resultValue = new GetGenaiAgentsByOpenaiApiKeyAgentTemplate();
