...
public final class GradientaiAgentChildAgentChatbotArgs extends com.pulumi.resources.ResourceArgs {

    public static final GradientaiAgentChildAgentChatbotArgs Empty = new GradientaiAgentChildAgentChatbotArgs();
    ...
    private GradientaiAgentChildAgentChatbotArgs() {}

    private GradientaiAgentChildAgentChatbotArgs(GradientaiAgentChildAgentChatbotArgs $) {
    ...
    public static Builder builder(GradientaiAgentChildAgentChatbotArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GradientaiAgentChildAgentChatbotArgs();
        }

        public Builder(GradientaiAgentChildAgentChatbotArgs defaults) {
            $ = new GradientaiAgentChildAgentChatbotArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GradientaiAgentChildAgentChatbotArgs build() {
            return $;
        }
    }
