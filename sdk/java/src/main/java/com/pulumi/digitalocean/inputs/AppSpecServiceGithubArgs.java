...
public final class AppSpecServiceGithubArgs extends com.pulumi.resources.ResourceArgs {

    public static final AppSpecServiceGithubArgs Empty = new AppSpecServiceGithubArgs();
    ...
    private AppSpecServiceGithubArgs() {}

    private AppSpecServiceGithubArgs(AppSpecServiceGithubArgs $) {
        this.branch = $.branch;
    ...
    public static Builder builder(AppSpecServiceGithubArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AppSpecServiceGithubArgs();
        }

        public Builder(AppSpecServiceGithubArgs defaults) {
            $ = new AppSpecServiceGithubArgs(Objects.requireNonNull(defaults));
        }
        ...
        public AppSpecServiceGithubArgs build() {
            return $;
        }
    }
