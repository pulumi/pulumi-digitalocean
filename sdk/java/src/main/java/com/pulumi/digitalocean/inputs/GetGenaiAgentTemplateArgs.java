...
import com.pulumi.digitalocean.inputs.GetGenaiAgentTemplateKnowledgeBaseArgs;
import com.pulumi.digitalocean.inputs.GetGenaiAgentTemplateModelArgs;
...
public final class GetGenaiAgentTemplateArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetGenaiAgentTemplateArgs Empty = new GetGenaiAgentTemplateArgs();
    ...
    private @Nullable Output<List<GetGenaiAgentTemplateKnowledgeBaseArgs>> knowledgeBases;

    /**
     * @return List of Knowledge Bases
     * 
     */
    public Optional<Output<List<GetGenaiAgentTemplateKnowledgeBaseArgs>>> knowledgeBases() {
     ...
     */
    @Import(name="models")
    private @Nullable Output<List<GetGenaiAgentTemplateModelArgs>> models;

    /**
     * @return Model of the Agent Template
     * 
     */
    public Optional<Output<List<GetGenaiAgentTemplateModelArgs>>> models() {
    ...
    private GetGenaiAgentTemplateArgs() {}

    private GetGenaiAgentTemplateArgs(GetGenaiAgentTemplateArgs $) {
    ...
    public static Builder builder(GetGenaiAgentTemplateArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetGenaiAgentTemplateArgs();
        }

        public Builder(GetGenaiAgentTemplateArgs defaults) {
            $ = new GetGenaiAgentTemplateArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder knowledgeBases(@Nullable Output<List<GetGenaiAgentTemplateKnowledgeBaseArgs>> knowledgeBases) {
         ...
         * 
         */
        public Builder knowledgeBases(List<GetGenaiAgentTemplateKnowledgeBaseArgs> knowledgeBases) {
         ...
         * 
         */
        public Builder knowledgeBases(GetGenaiAgentTemplateKnowledgeBaseArgs... knowledgeBases) {
         ...
         * 
         */
        public Builder models(@Nullable Output<List<GetGenaiAgentTemplateModelArgs>> models) {
            $.models = models;
            return this;
        }
         ...
         * 
         */
        public Builder models(List<GetGenaiAgentTemplateModelArgs> models) {
         ...
         * 
         */
        public Builder models(GetGenaiAgentTemplateModelArgs... models) {
        ...
        public GetGenaiAgentTemplateArgs build() {
            if ($.createdAt == null) {
                throw new MissingRequiredPropertyException("GetGenaiAgentTemplateArgs", "createdAt");
            }
            if ($.updatedAt == null) {
                throw new MissingRequiredPropertyException("GetGenaiAgentTemplateArgs", "updatedAt");
            }
            return $;
        }
    }
