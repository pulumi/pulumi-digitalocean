...
public final class GetGradientaiKnowledgeBaseLastIndexingJob extends com.pulumi.resources.InvokeArgs {

    public static final GetGradientaiKnowledgeBaseLastIndexingJob Empty = new GetGradientaiKnowledgeBaseLastIndexingJob();
    ...
    private GetGradientaiKnowledgeBaseLastIndexingJob() {}

    private GetGradientaiKnowledgeBaseLastIndexingJob(GetGradientaiKnowledgeBaseLastIndexingJob $) {
    ...
    public static Builder builder(GetGradientaiKnowledgeBaseLastIndexingJob defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetGradientaiKnowledgeBaseLastIndexingJob();
        }

        public Builder(GetGradientaiKnowledgeBaseLastIndexingJob defaults) {
            $ = new GetGradientaiKnowledgeBaseLastIndexingJob(Objects.requireNonNull(defaults));
        }
        ...
        public GetGradientaiKnowledgeBaseLastIndexingJob build() {
            if ($.createdAt == null) {
                throw new MissingRequiredPropertyException("GetGradientaiKnowledgeBaseLastIndexingJob", "createdAt");
            }
            if ($.finishedAt == null) {
                throw new MissingRequiredPropertyException("GetGradientaiKnowledgeBaseLastIndexingJob", "finishedAt");
            }
            if ($.knowledgeBaseUuid == null) {
                throw new MissingRequiredPropertyException("GetGradientaiKnowledgeBaseLastIndexingJob", "knowledgeBaseUuid");
            }
            if ($.startedAt == null) {
                throw new MissingRequiredPropertyException("GetGradientaiKnowledgeBaseLastIndexingJob", "startedAt");
            }
            if ($.updatedAt == null) {
                throw new MissingRequiredPropertyException("GetGradientaiKnowledgeBaseLastIndexingJob", "updatedAt");
            }
            return $;
        }
    }
