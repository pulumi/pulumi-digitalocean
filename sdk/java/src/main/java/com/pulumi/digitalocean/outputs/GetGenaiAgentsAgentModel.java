...
import com.pulumi.digitalocean.outputs.GetGenaiAgentsAgentModelAgreement;
import com.pulumi.digitalocean.outputs.GetGenaiAgentsAgentModelVersion;
...
@CustomType
public final class GetGenaiAgentsAgentModel {
    /**
     * @return Agreement information for the model
     * 
     */
    private @Nullable List<GetGenaiAgentsAgentModelAgreement> agreements;
    /**
     ...
     * 
     */
    private @Nullable List<GetGenaiAgentsAgentModelVersion> versions;

    private GetGenaiAgentsAgentModel() {}
    /**
     * @return Agreement information for the model
     * 
     */
    public List<GetGenaiAgentsAgentModelAgreement> agreements() {
     ...
     * 
     */
    public List<GetGenaiAgentsAgentModelVersion> versions() {
    ...
    public static Builder builder(GetGenaiAgentsAgentModel defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<GetGenaiAgentsAgentModelVersion> versions;
        public Builder() {}
        public Builder(GetGenaiAgentsAgentModel defaults) {
        ...
        @CustomType.Setter
        public Builder agreements(@Nullable List<GetGenaiAgentsAgentModelAgreement> agreements) {

            this.agreements = agreements;
            return this;
        }
        public Builder agreements(GetGenaiAgentsAgentModelAgreement... agreements) {
            return agreements(List.of(agreements));
        }
        @CustomType.Setter
        public Builder createdAt(String createdAt) {
            if (createdAt == null) {
              throw new MissingRequiredPropertyException("GetGenaiAgentsAgentModel", "createdAt");
            }
        ...
        public Builder updatedAt(String updatedAt) {
            if (updatedAt == null) {
              throw new MissingRequiredPropertyException("GetGenaiAgentsAgentModel", "updatedAt");
            }
        ...
        @CustomType.Setter
        public Builder versions(@Nullable List<GetGenaiAgentsAgentModelVersion> versions) {

            this.versions = versions;
            return this;
        }
        public Builder versions(GetGenaiAgentsAgentModelVersion... versions) {
            return versions(List.of(versions));
        }
        public GetGenaiAgentsAgentModel build() {
            final var _resultValue = new GetGenaiAgentsAgentModel();
