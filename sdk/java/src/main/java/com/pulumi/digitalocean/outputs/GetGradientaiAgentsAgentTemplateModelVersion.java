...
@CustomType
public final class GetGradientaiAgentsAgentTemplateModelVersion {
    /**
    ...
    private GetGradientaiAgentsAgentTemplateModelVersion() {}
    /**
     * @return Major version of the model
     * 
     */
    ...
    public static Builder builder(GetGradientaiAgentsAgentTemplateModelVersion defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer patch;
        public Builder() {}
        public Builder(GetGradientaiAgentsAgentTemplateModelVersion defaults) {
        ...
        public GetGradientaiAgentsAgentTemplateModelVersion build() {
            final var _resultValue = new GetGradientaiAgentsAgentTemplateModelVersion();
