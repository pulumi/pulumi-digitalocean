...
public final class AppSpecJobBitbucketArgs extends com.pulumi.resources.ResourceArgs {

    public static final AppSpecJobBitbucketArgs Empty = new AppSpecJobBitbucketArgs();
    ...
    private AppSpecJobBitbucketArgs() {}

    private AppSpecJobBitbucketArgs(AppSpecJobBitbucketArgs $) {
        this.branch = $.branch;
    ...
    public static Builder builder(AppSpecJobBitbucketArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AppSpecJobBitbucketArgs();
        }

        public Builder(AppSpecJobBitbucketArgs defaults) {
            $ = new AppSpecJobBitbucketArgs(Objects.requireNonNull(defaults));
        }
        ...
        public AppSpecJobBitbucketArgs build() {
            return $;
        }
    }
