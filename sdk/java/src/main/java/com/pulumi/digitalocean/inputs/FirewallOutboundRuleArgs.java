...
public final class FirewallOutboundRuleArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static Builder builder(FirewallOutboundRuleArgs defaults) {
    ...
    public static final class Builder {
        ...
        /**
         * @param destinationKubernetesIds An array containing the IDs of
         * the Kubernetes clusters to which the outbound traffic will be allowed.
         * 
         * @return builder
         * 
        ...
        public FirewallOutboundRuleArgs build() {
            if ($.protocol == null) {
                throw new MissingRequiredPropertyException("FirewallOutboundRuleArgs", "protocol");
            }
            return $;
        }
    }
