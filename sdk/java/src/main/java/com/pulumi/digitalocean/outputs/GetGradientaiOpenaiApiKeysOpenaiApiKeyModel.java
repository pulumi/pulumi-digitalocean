...
import com.pulumi.digitalocean.outputs.GetGradientaiOpenaiApiKeysOpenaiApiKeyModelAgreement;
import com.pulumi.digitalocean.outputs.GetGradientaiOpenaiApiKeysOpenaiApiKeyModelVersion;
...
@CustomType
public final class GetGradientaiOpenaiApiKeysOpenaiApiKeyModel {
    /**
     * @return Agreement information for the model
     * 
     */
    private @Nullable List<GetGradientaiOpenaiApiKeysOpenaiApiKeyModelAgreement> agreements;
    /**
     ...
     * 
     */
    private @Nullable List<GetGradientaiOpenaiApiKeysOpenaiApiKeyModelVersion> versions;

    private GetGradientaiOpenaiApiKeysOpenaiApiKeyModel() {}
    /**
     * @return Agreement information for the model
     * 
     */
    public List<GetGradientaiOpenaiApiKeysOpenaiApiKeyModelAgreement> agreements() {
     ...
     * 
     */
    public List<GetGradientaiOpenaiApiKeysOpenaiApiKeyModelVersion> versions() {
    ...
    public static Builder builder(GetGradientaiOpenaiApiKeysOpenaiApiKeyModel defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<GetGradientaiOpenaiApiKeysOpenaiApiKeyModelVersion> versions;
        public Builder() {}
        public Builder(GetGradientaiOpenaiApiKeysOpenaiApiKeyModel defaults) {
        ...
        @CustomType.Setter
        public Builder agreements(@Nullable List<GetGradientaiOpenaiApiKeysOpenaiApiKeyModelAgreement> agreements) {

            this.agreements = agreements;
            return this;
        }
        public Builder agreements(GetGradientaiOpenaiApiKeysOpenaiApiKeyModelAgreement... agreements) {
            return agreements(List.of(agreements));
        }
        @CustomType.Setter
        public Builder createdAt(String createdAt) {
            if (createdAt == null) {
              throw new MissingRequiredPropertyException("GetGradientaiOpenaiApiKeysOpenaiApiKeyModel", "createdAt");
            }
        ...
        public Builder updatedAt(String updatedAt) {
            if (updatedAt == null) {
              throw new MissingRequiredPropertyException("GetGradientaiOpenaiApiKeysOpenaiApiKeyModel", "updatedAt");
            }
        ...
        @CustomType.Setter
        public Builder versions(@Nullable List<GetGradientaiOpenaiApiKeysOpenaiApiKeyModelVersion> versions) {

            this.versions = versions;
            return this;
        }
        public Builder versions(GetGradientaiOpenaiApiKeysOpenaiApiKeyModelVersion... versions) {
            return versions(List.of(versions));
        }
        public GetGradientaiOpenaiApiKeysOpenaiApiKeyModel build() {
            final var _resultValue = new GetGradientaiOpenaiApiKeysOpenaiApiKeyModel();
