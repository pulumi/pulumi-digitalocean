...
public final class GetGenaiAgentTemplateModelVersionArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetGenaiAgentTemplateModelVersionArgs Empty = new GetGenaiAgentTemplateModelVersionArgs();
    ...
    private GetGenaiAgentTemplateModelVersionArgs() {}

    private GetGenaiAgentTemplateModelVersionArgs(GetGenaiAgentTemplateModelVersionArgs $) {
        this.major = $.major;
        this.minor = $.minor;
        this.patch = $.patch;
    }
    ...
    public static Builder builder(GetGenaiAgentTemplateModelVersionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetGenaiAgentTemplateModelVersionArgs();
        }

        public Builder(GetGenaiAgentTemplateModelVersionArgs defaults) {
            $ = new GetGenaiAgentTemplateModelVersionArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetGenaiAgentTemplateModelVersionArgs build() {
            return $;
        }
    }
