...
@CustomType
public final class GetGenaiAgentsAgentModelVersion {
    /**
    ...
    private GetGenaiAgentsAgentModelVersion() {}
    /**
     * @return Major version of the model
     * 
     */
    ...
    public static Builder builder(GetGenaiAgentsAgentModelVersion defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer patch;
        public Builder() {}
        public Builder(GetGenaiAgentsAgentModelVersion defaults) {
        ...
        public GetGenaiAgentsAgentModelVersion build() {
            final var _resultValue = new GetGenaiAgentsAgentModelVersion();
