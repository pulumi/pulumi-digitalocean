...
public final class GradientaiOpenaiApiKeyModelVersionArgs extends com.pulumi.resources.ResourceArgs {

    public static final GradientaiOpenaiApiKeyModelVersionArgs Empty = new GradientaiOpenaiApiKeyModelVersionArgs();
    ...
    private GradientaiOpenaiApiKeyModelVersionArgs() {}

    private GradientaiOpenaiApiKeyModelVersionArgs(GradientaiOpenaiApiKeyModelVersionArgs $) {
        this.major = $.major;
        this.minor = $.minor;
        this.patch = $.patch;
    }
    ...
    public static Builder builder(GradientaiOpenaiApiKeyModelVersionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GradientaiOpenaiApiKeyModelVersionArgs();
        }

        public Builder(GradientaiOpenaiApiKeyModelVersionArgs defaults) {
            $ = new GradientaiOpenaiApiKeyModelVersionArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GradientaiOpenaiApiKeyModelVersionArgs build() {
            return $;
        }
    }
