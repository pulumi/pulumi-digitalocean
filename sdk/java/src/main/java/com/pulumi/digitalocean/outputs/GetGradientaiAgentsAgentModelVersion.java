...
@CustomType
public final class GetGradientaiAgentsAgentModelVersion {
    /**
    ...
    private GetGradientaiAgentsAgentModelVersion() {}
    /**
     * @return Major version of the model
     * 
     */
    ...
    public static Builder builder(GetGradientaiAgentsAgentModelVersion defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer patch;
        public Builder() {}
        public Builder(GetGradientaiAgentsAgentModelVersion defaults) {
        ...
        public GetGradientaiAgentsAgentModelVersion build() {
            final var _resultValue = new GetGradientaiAgentsAgentModelVersion();
