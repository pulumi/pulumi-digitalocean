...
@CustomType
public final class AppSpecStaticSiteBitbucket {
    /**
    ...
    private AppSpecStaticSiteBitbucket() {}
    /**
     * @return The name of the branch to use.
     * 
     */
    ...
    public static Builder builder(AppSpecStaticSiteBitbucket defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String repo;
        public Builder() {}
        public Builder(AppSpecStaticSiteBitbucket defaults) {
        ...
        public AppSpecStaticSiteBitbucket build() {
            final var _resultValue = new AppSpecStaticSiteBitbucket();
