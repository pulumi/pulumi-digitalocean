...
@CustomType
public final class GenaiAgentTemplateModelVersion {
    /**
    ...
    private GenaiAgentTemplateModelVersion() {}
    /**
     * @return Major version of the model
     * 
     */
    ...
    public static Builder builder(GenaiAgentTemplateModelVersion defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer patch;
        public Builder() {}
        public Builder(GenaiAgentTemplateModelVersion defaults) {
        ...
        public GenaiAgentTemplateModelVersion build() {
            final var _resultValue = new GenaiAgentTemplateModelVersion();
