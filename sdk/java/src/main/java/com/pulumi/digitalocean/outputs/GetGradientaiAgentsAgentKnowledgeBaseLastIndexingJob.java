...
@CustomType
public final class GetGradientaiAgentsAgentKnowledgeBaseLastIndexingJob {
    /**
    ...
    private GetGradientaiAgentsAgentKnowledgeBaseLastIndexingJob() {}
    /**
     * @return Number of completed datasources in the last indexing job
     * 
     */
    ...
    public static Builder builder(GetGradientaiAgentsAgentKnowledgeBaseLastIndexingJob defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String uuid;
        public Builder() {}
        public Builder(GetGradientaiAgentsAgentKnowledgeBaseLastIndexingJob defaults) {
        ...
        public Builder createdAt(String createdAt) {
            if (createdAt == null) {
              throw new MissingRequiredPropertyException("GetGradientaiAgentsAgentKnowledgeBaseLastIndexingJob", "createdAt");
            }
        ...
        public Builder finishedAt(String finishedAt) {
            if (finishedAt == null) {
              throw new MissingRequiredPropertyException("GetGradientaiAgentsAgentKnowledgeBaseLastIndexingJob", "finishedAt");
            }
        ...
        public Builder knowledgeBaseUuid(String knowledgeBaseUuid) {
            if (knowledgeBaseUuid == null) {
              throw new MissingRequiredPropertyException("GetGradientaiAgentsAgentKnowledgeBaseLastIndexingJob", "knowledgeBaseUuid");
            }
        ...
        public Builder startedAt(String startedAt) {
            if (startedAt == null) {
              throw new MissingRequiredPropertyException("GetGradientaiAgentsAgentKnowledgeBaseLastIndexingJob", "startedAt");
            }
        ...
        public Builder updatedAt(String updatedAt) {
            if (updatedAt == null) {
              throw new MissingRequiredPropertyException("GetGradientaiAgentsAgentKnowledgeBaseLastIndexingJob", "updatedAt");
            }
        ...
        public GetGradientaiAgentsAgentKnowledgeBaseLastIndexingJob build() {
            final var _resultValue = new GetGradientaiAgentsAgentKnowledgeBaseLastIndexingJob();
