...
public final class GetGradientaiAgentChatbotArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetGradientaiAgentChatbotArgs Empty = new GetGradientaiAgentChatbotArgs();
    ...
    private GetGradientaiAgentChatbotArgs() {}

    private GetGradientaiAgentChatbotArgs(GetGradientaiAgentChatbotArgs $) {
    ...
    public static Builder builder(GetGradientaiAgentChatbotArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetGradientaiAgentChatbotArgs();
        }

        public Builder(GetGradientaiAgentChatbotArgs defaults) {
            $ = new GetGradientaiAgentChatbotArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetGradientaiAgentChatbotArgs build() {
            return $;
        }
    }
