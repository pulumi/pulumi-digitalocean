...
@CustomType
public final class GenaiOpenaiApiKeyModelVersion {
    /**
    ...
    public static Builder builder(GenaiOpenaiApiKeyModelVersion defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer patch;
        public Builder() {}
        public Builder(GenaiOpenaiApiKeyModelVersion defaults) {
        ...
        public GenaiOpenaiApiKeyModelVersion build() {
            final var _resultValue = new GenaiOpenaiApiKeyModelVersion();
