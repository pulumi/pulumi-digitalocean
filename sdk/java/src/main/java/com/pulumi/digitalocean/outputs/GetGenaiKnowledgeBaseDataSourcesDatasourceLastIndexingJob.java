...
@CustomType
public final class GetGenaiKnowledgeBaseDataSourcesDatasourceLastIndexingJob {
    /**
    ...
    private GetGenaiKnowledgeBaseDataSourcesDatasourceLastIndexingJob() {}
    /**
     * @return Number of completed datasources in the last indexing job
     * 
     */
    ...
    public static Builder builder(GetGenaiKnowledgeBaseDataSourcesDatasourceLastIndexingJob defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String uuid;
        public Builder() {}
        public Builder(GetGenaiKnowledgeBaseDataSourcesDatasourceLastIndexingJob defaults) {
        ...
        public Builder createdAt(String createdAt) {
            if (createdAt == null) {
              throw new MissingRequiredPropertyException("GetGenaiKnowledgeBaseDataSourcesDatasourceLastIndexingJob", "createdAt");
            }
        ...
        public Builder finishedAt(String finishedAt) {
            if (finishedAt == null) {
              throw new MissingRequiredPropertyException("GetGenaiKnowledgeBaseDataSourcesDatasourceLastIndexingJob", "finishedAt");
            }
        ...
        public Builder knowledgeBaseUuid(String knowledgeBaseUuid) {
            if (knowledgeBaseUuid == null) {
              throw new MissingRequiredPropertyException("GetGenaiKnowledgeBaseDataSourcesDatasourceLastIndexingJob", "knowledgeBaseUuid");
            }
        ...
        public Builder startedAt(String startedAt) {
            if (startedAt == null) {
              throw new MissingRequiredPropertyException("GetGenaiKnowledgeBaseDataSourcesDatasourceLastIndexingJob", "startedAt");
            }
        ...
        public Builder updatedAt(String updatedAt) {
            if (updatedAt == null) {
              throw new MissingRequiredPropertyException("GetGenaiKnowledgeBaseDataSourcesDatasourceLastIndexingJob", "updatedAt");
            }
        ...
        public GetGenaiKnowledgeBaseDataSourcesDatasourceLastIndexingJob build() {
            final var _resultValue = new GetGenaiKnowledgeBaseDataSourcesDatasourceLastIndexingJob();
