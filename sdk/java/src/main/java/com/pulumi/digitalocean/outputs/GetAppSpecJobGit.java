...
@CustomType
public final class GetAppSpecJobGit {
    /**
    ...
    public static Builder builder(GetAppSpecJobGit defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(GetAppSpecJobGit defaults) {
        ...
        public Builder repoCloneUrl(@Nullable String repoCloneUrl) {
            this.repoCloneUrl = repoCloneUrl;
            return this;
        }        public GetAppSpecJobGit build() {
            return new GetAppSpecJobGit(branch, repoCloneUrl);
        }
    }
}
