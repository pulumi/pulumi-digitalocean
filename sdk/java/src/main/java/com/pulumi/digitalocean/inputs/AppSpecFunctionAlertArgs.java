...
public final class AppSpecFunctionAlertArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static Builder builder(AppSpecFunctionAlertArgs defaults) {
    ...
    public static final class Builder {
        ...
        public AppSpecFunctionAlertArgs build() {
            if ($.operator == null) {
                throw new MissingRequiredPropertyException("AppSpecFunctionAlertArgs", "operator");
            }
            if ($.rule == null) {
                throw new MissingRequiredPropertyException("AppSpecFunctionAlertArgs", "rule");
            }
            if ($.value == null) {
                throw new MissingRequiredPropertyException("AppSpecFunctionAlertArgs", "value");
            }
            if ($.window == null) {
                throw new MissingRequiredPropertyException("AppSpecFunctionAlertArgs", "window");
            }
            return $;
        }
    }
