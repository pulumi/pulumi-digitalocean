...
@CustomType
public final class AppSpecJobBitbucket {
    /**
    ...
    public static Builder builder(AppSpecJobBitbucket defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String repo;
        public Builder() {}
        public Builder(AppSpecJobBitbucket defaults) {
        ...
        public AppSpecJobBitbucket build() {
            final var _resultValue = new AppSpecJobBitbucket();
