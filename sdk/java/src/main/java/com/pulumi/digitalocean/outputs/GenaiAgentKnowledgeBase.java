...
import com.pulumi.digitalocean.outputs.GenaiAgentKnowledgeBaseLastIndexingJob;
...
@CustomType
public final class GenaiAgentKnowledgeBase {
    /**
    ...
    public static Builder builder(GenaiAgentKnowledgeBase defaults) {
