...
public final class GetDropletsFilterArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetDropletsFilterArgs Empty = new GetDropletsFilterArgs();
    ...
    private GetDropletsFilterArgs() {}

    private GetDropletsFilterArgs(GetDropletsFilterArgs $) {
        this.all = $.all;
        this.key = $.key;
    ...
    public static Builder builder(GetDropletsFilterArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetDropletsFilterArgs();
        }

        public Builder(GetDropletsFilterArgs defaults) {
            $ = new GetDropletsFilterArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetDropletsFilterArgs build() {
            if ($.key == null) {
                throw new MissingRequiredPropertyException("GetDropletsFilterArgs", "key");
            }
            if ($.values == null) {
                throw new MissingRequiredPropertyException("GetDropletsFilterArgs", "values");
            }
            return $;
        }
    }
