...
@CustomType
public final class GenaiAgentFunction {
    /**
    ...
    public static Builder builder(GenaiAgentFunction defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String uuid;
        public Builder() {}
        public Builder(GenaiAgentFunction defaults) {
        ...
        public GenaiAgentFunction build() {
            final var _resultValue = new GenaiAgentFunction();
