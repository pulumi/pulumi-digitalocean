...
public final class GetGradientaiAgentTemplateKnowledgeBaseLastIndexingJob extends com.pulumi.resources.InvokeArgs {

    public static final GetGradientaiAgentTemplateKnowledgeBaseLastIndexingJob Empty = new GetGradientaiAgentTemplateKnowledgeBaseLastIndexingJob();
    ...
    private GetGradientaiAgentTemplateKnowledgeBaseLastIndexingJob() {}

    private GetGradientaiAgentTemplateKnowledgeBaseLastIndexingJob(GetGradientaiAgentTemplateKnowledgeBaseLastIndexingJob $) {
    ...
    public static Builder builder(GetGradientaiAgentTemplateKnowledgeBaseLastIndexingJob defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetGradientaiAgentTemplateKnowledgeBaseLastIndexingJob();
        }

        public Builder(GetGradientaiAgentTemplateKnowledgeBaseLastIndexingJob defaults) {
            $ = new GetGradientaiAgentTemplateKnowledgeBaseLastIndexingJob(Objects.requireNonNull(defaults));
        }
        ...
        public GetGradientaiAgentTemplateKnowledgeBaseLastIndexingJob build() {
            if ($.createdAt == null) {
                throw new MissingRequiredPropertyException("GetGradientaiAgentTemplateKnowledgeBaseLastIndexingJob", "createdAt");
            }
            if ($.finishedAt == null) {
                throw new MissingRequiredPropertyException("GetGradientaiAgentTemplateKnowledgeBaseLastIndexingJob", "finishedAt");
            }
            if ($.knowledgeBaseUuid == null) {
                throw new MissingRequiredPropertyException("GetGradientaiAgentTemplateKnowledgeBaseLastIndexingJob", "knowledgeBaseUuid");
            }
            if ($.startedAt == null) {
                throw new MissingRequiredPropertyException("GetGradientaiAgentTemplateKnowledgeBaseLastIndexingJob", "startedAt");
            }
            if ($.updatedAt == null) {
                throw new MissingRequiredPropertyException("GetGradientaiAgentTemplateKnowledgeBaseLastIndexingJob", "updatedAt");
            }
            return $;
        }
    }
