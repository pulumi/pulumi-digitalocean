...
@CustomType
public final class GetAppSpecWorkerBitbucket {
    /**
    ...
    private GetAppSpecWorkerBitbucket() {}
    /**
     * @return The name of the branch to use.
     * 
     */
    ...
    public static Builder builder(GetAppSpecWorkerBitbucket defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String repo;
        public Builder() {}
        public Builder(GetAppSpecWorkerBitbucket defaults) {
        ...
        public GetAppSpecWorkerBitbucket build() {
            final var _resultValue = new GetAppSpecWorkerBitbucket();
