...
public final class GetGenaiAgentKnowledgeBaseLastIndexingJob extends com.pulumi.resources.InvokeArgs {

    public static final GetGenaiAgentKnowledgeBaseLastIndexingJob Empty = new GetGenaiAgentKnowledgeBaseLastIndexingJob();
    ...
    private GetGenaiAgentKnowledgeBaseLastIndexingJob() {}

    private GetGenaiAgentKnowledgeBaseLastIndexingJob(GetGenaiAgentKnowledgeBaseLastIndexingJob $) {
    ...
    public static Builder builder(GetGenaiAgentKnowledgeBaseLastIndexingJob defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetGenaiAgentKnowledgeBaseLastIndexingJob();
        }

        public Builder(GetGenaiAgentKnowledgeBaseLastIndexingJob defaults) {
            $ = new GetGenaiAgentKnowledgeBaseLastIndexingJob(Objects.requireNonNull(defaults));
        }
        ...
        public GetGenaiAgentKnowledgeBaseLastIndexingJob build() {
            if ($.createdAt == null) {
                throw new MissingRequiredPropertyException("GetGenaiAgentKnowledgeBaseLastIndexingJob", "createdAt");
            }
            if ($.finishedAt == null) {
                throw new MissingRequiredPropertyException("GetGenaiAgentKnowledgeBaseLastIndexingJob", "finishedAt");
            }
            ...
            if ($.startedAt == null) {
                throw new MissingRequiredPropertyException("GetGenaiAgentKnowledgeBaseLastIndexingJob", "startedAt");
            }
            if ($.updatedAt == null) {
                throw new MissingRequiredPropertyException("GetGenaiAgentKnowledgeBaseLastIndexingJob", "updatedAt");
            }
            return $;
        }
    }
