...
@CustomType
public final class GetGradientaiAgentsByOpenaiApiKeyAgentKnowledgeBaseLastIndexingJob {
    /**
    ...
    private GetGradientaiAgentsByOpenaiApiKeyAgentKnowledgeBaseLastIndexingJob() {}
    /**
     * @return Number of completed datasources in the last indexing job
     * 
     */
    ...
    public static Builder builder(GetGradientaiAgentsByOpenaiApiKeyAgentKnowledgeBaseLastIndexingJob defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String uuid;
        public Builder() {}
        public Builder(GetGradientaiAgentsByOpenaiApiKeyAgentKnowledgeBaseLastIndexingJob defaults) {
        ...
        public Builder createdAt(String createdAt) {
            if (createdAt == null) {
              throw new MissingRequiredPropertyException("GetGradientaiAgentsByOpenaiApiKeyAgentKnowledgeBaseLastIndexingJob", "createdAt");
            }
        ...
        public Builder finishedAt(String finishedAt) {
            if (finishedAt == null) {
              throw new MissingRequiredPropertyException("GetGradientaiAgentsByOpenaiApiKeyAgentKnowledgeBaseLastIndexingJob", "finishedAt");
            }
        ...
        public Builder knowledgeBaseUuid(String knowledgeBaseUuid) {
            if (knowledgeBaseUuid == null) {
              throw new MissingRequiredPropertyException("GetGradientaiAgentsByOpenaiApiKeyAgentKnowledgeBaseLastIndexingJob", "knowledgeBaseUuid");
            }
        ...
        public Builder startedAt(String startedAt) {
            if (startedAt == null) {
              throw new MissingRequiredPropertyException("GetGradientaiAgentsByOpenaiApiKeyAgentKnowledgeBaseLastIndexingJob", "startedAt");
            }
        ...
        public Builder updatedAt(String updatedAt) {
            if (updatedAt == null) {
              throw new MissingRequiredPropertyException("GetGradientaiAgentsByOpenaiApiKeyAgentKnowledgeBaseLastIndexingJob", "updatedAt");
            }
        ...
        public GetGradientaiAgentsByOpenaiApiKeyAgentKnowledgeBaseLastIndexingJob build() {
            final var _resultValue = new GetGradientaiAgentsByOpenaiApiKeyAgentKnowledgeBaseLastIndexingJob();
