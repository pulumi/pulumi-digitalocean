...
public final class GenaiAgentTemplateModelVersionArgs extends com.pulumi.resources.ResourceArgs {

    public static final GenaiAgentTemplateModelVersionArgs Empty = new GenaiAgentTemplateModelVersionArgs();
    ...
    private GenaiAgentTemplateModelVersionArgs() {}

    private GenaiAgentTemplateModelVersionArgs(GenaiAgentTemplateModelVersionArgs $) {
        this.major = $.major;
        this.minor = $.minor;
        this.patch = $.patch;
    }
    ...
    public static Builder builder(GenaiAgentTemplateModelVersionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GenaiAgentTemplateModelVersionArgs();
        }

        public Builder(GenaiAgentTemplateModelVersionArgs defaults) {
            $ = new GenaiAgentTemplateModelVersionArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GenaiAgentTemplateModelVersionArgs build() {
            return $;
        }
    }
