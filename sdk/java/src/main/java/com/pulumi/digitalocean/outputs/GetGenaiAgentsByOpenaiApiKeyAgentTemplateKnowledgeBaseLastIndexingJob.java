...
@CustomType
public final class GetGenaiAgentsByOpenaiApiKeyAgentTemplateKnowledgeBaseLastIndexingJob {
    /**
    ...
    private GetGenaiAgentsByOpenaiApiKeyAgentTemplateKnowledgeBaseLastIndexingJob() {}
    /**
     * @return Number of completed datasources in the last indexing job
     * 
     */
    ...
    public static Builder builder(GetGenaiAgentsByOpenaiApiKeyAgentTemplateKnowledgeBaseLastIndexingJob defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String uuid;
        public Builder() {}
        public Builder(GetGenaiAgentsByOpenaiApiKeyAgentTemplateKnowledgeBaseLastIndexingJob defaults) {
        ...
        public Builder createdAt(String createdAt) {
            if (createdAt == null) {
              throw new MissingRequiredPropertyException("GetGenaiAgentsByOpenaiApiKeyAgentTemplateKnowledgeBaseLastIndexingJob", "createdAt");
            }
        ...
        public Builder finishedAt(String finishedAt) {
            if (finishedAt == null) {
              throw new MissingRequiredPropertyException("GetGenaiAgentsByOpenaiApiKeyAgentTemplateKnowledgeBaseLastIndexingJob", "finishedAt");
            }
        ...
        public Builder knowledgeBaseUuid(String knowledgeBaseUuid) {
            if (knowledgeBaseUuid == null) {
              throw new MissingRequiredPropertyException("GetGenaiAgentsByOpenaiApiKeyAgentTemplateKnowledgeBaseLastIndexingJob", "knowledgeBaseUuid");
            }
        ...
        public Builder startedAt(String startedAt) {
            if (startedAt == null) {
              throw new MissingRequiredPropertyException("GetGenaiAgentsByOpenaiApiKeyAgentTemplateKnowledgeBaseLastIndexingJob", "startedAt");
            }
        ...
        public Builder updatedAt(String updatedAt) {
            if (updatedAt == null) {
              throw new MissingRequiredPropertyException("GetGenaiAgentsByOpenaiApiKeyAgentTemplateKnowledgeBaseLastIndexingJob", "updatedAt");
            }
        ...
        public GetGenaiAgentsByOpenaiApiKeyAgentTemplateKnowledgeBaseLastIndexingJob build() {
            final var _resultValue = new GetGenaiAgentsByOpenaiApiKeyAgentTemplateKnowledgeBaseLastIndexingJob();
