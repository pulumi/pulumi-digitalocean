...
@CustomType
public final class GetAppSpecStaticSiteGithub {
    /**
    ...
    private GetAppSpecStaticSiteGithub(
    ...
    public static Builder builder(GetAppSpecStaticSiteGithub defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(GetAppSpecStaticSiteGithub defaults) {
        ...
        public Builder repo(@Nullable String repo) {
            this.repo = repo;
            return this;
        }        public GetAppSpecStaticSiteGithub build() {
            return new GetAppSpecStaticSiteGithub(branch, deployOnPush, repo);
        }
    }
}
