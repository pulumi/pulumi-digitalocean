...
public final class GenaiAgentChatbotArgs extends com.pulumi.resources.ResourceArgs {

    public static final GenaiAgentChatbotArgs Empty = new GenaiAgentChatbotArgs();
    ...
    private GenaiAgentChatbotArgs() {}

    private GenaiAgentChatbotArgs(GenaiAgentChatbotArgs $) {
    ...
    public static Builder builder(GenaiAgentChatbotArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GenaiAgentChatbotArgs();
        }

        public Builder(GenaiAgentChatbotArgs defaults) {
            $ = new GenaiAgentChatbotArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GenaiAgentChatbotArgs build() {
            return $;
        }
    }
