...
@CustomType
public final class GetAppSpecStaticSiteGit {
    /**
    ...
    private GetAppSpecStaticSiteGit(
    ...
    public static Builder builder(GetAppSpecStaticSiteGit defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(GetAppSpecStaticSiteGit defaults) {
        ...
        public Builder repoCloneUrl(@Nullable String repoCloneUrl) {
            ...
            return new GetAppSpecStaticSiteGit(branch, repoCloneUrl);
        }
    }
}
