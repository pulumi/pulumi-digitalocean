...
public final class GetGenaiAgentModelVersionArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetGenaiAgentModelVersionArgs Empty = new GetGenaiAgentModelVersionArgs();
    ...
    private GetGenaiAgentModelVersionArgs() {}

    private GetGenaiAgentModelVersionArgs(GetGenaiAgentModelVersionArgs $) {
        this.major = $.major;
        this.minor = $.minor;
        this.patch = $.patch;
    }
    ...
    public static Builder builder(GetGenaiAgentModelVersionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetGenaiAgentModelVersionArgs();
        }

        public Builder(GetGenaiAgentModelVersionArgs defaults) {
            $ = new GetGenaiAgentModelVersionArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetGenaiAgentModelVersionArgs build() {
            return $;
        }
    }
