...
import com.pulumi.digitalocean.outputs.GetGradientaiAgentsByOpenaiApiKeyAgentTemplateKnowledgeBaseLastIndexingJob;
...
@CustomType
public final class GetGradientaiAgentsByOpenaiApiKeyAgentTemplateKnowledgeBase {
    /**
     ...
     * 
     */
    private @Nullable GetGradientaiAgentsByOpenaiApiKeyAgentTemplateKnowledgeBaseLastIndexingJob lastIndexingJob;
    /**
    ...
    private GetGradientaiAgentsByOpenaiApiKeyAgentTemplateKnowledgeBase() {}
    /**
     * @return Timestamp when the Knowledge Base was added to the Agent
     * 
     */
     ...
     * 
     */
    public Optional<GetGradientaiAgentsByOpenaiApiKeyAgentTemplateKnowledgeBaseLastIndexingJob> lastIndexingJob() {
    ...
    public static Builder builder(GetGradientaiAgentsByOpenaiApiKeyAgentTemplateKnowledgeBase defaults) {
    ...
    public static final class Builder {
        ...
        private String uuid;
        public Builder() {}
        public Builder(GetGradientaiAgentsByOpenaiApiKeyAgentTemplateKnowledgeBase defaults) {
        ...
        public Builder addedToAgentAt(String addedToAgentAt) {
            if (addedToAgentAt == null) {
              throw new MissingRequiredPropertyException("GetGradientaiAgentsByOpenaiApiKeyAgentTemplateKnowledgeBase", "addedToAgentAt");
            }
        ...
        public Builder createdAt(String createdAt) {
            if (createdAt == null) {
              throw new MissingRequiredPropertyException("GetGradientaiAgentsByOpenaiApiKeyAgentTemplateKnowledgeBase", "createdAt");
            }
        ...
        @CustomType.Setter
        public Builder lastIndexingJob(@Nullable GetGradientaiAgentsByOpenaiApiKeyAgentTemplateKnowledgeBaseLastIndexingJob lastIndexingJob) {
        ...
        public Builder updatedAt(String updatedAt) {
            if (updatedAt == null) {
              throw new MissingRequiredPropertyException("GetGradientaiAgentsByOpenaiApiKeyAgentTemplateKnowledgeBase", "updatedAt");
            }
        ...
        public Builder uuid(String uuid) {
            if (uuid == null) {
              throw new MissingRequiredPropertyException("GetGradientaiAgentsByOpenaiApiKeyAgentTemplateKnowledgeBase", "uuid");
            }
            this.uuid = uuid;
            return this;
        }
        public GetGradientaiAgentsByOpenaiApiKeyAgentTemplateKnowledgeBase build() {
            final var _resultValue = new GetGradientaiAgentsByOpenaiApiKeyAgentTemplateKnowledgeBase();
