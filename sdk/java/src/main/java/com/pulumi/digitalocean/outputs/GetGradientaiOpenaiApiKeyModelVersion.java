...
@CustomType
public final class GetGradientaiOpenaiApiKeyModelVersion {
    /**
    ...
    private GetGradientaiOpenaiApiKeyModelVersion() {}
    /**
     * @return Major version of the model
     * 
     */
    ...
    public static Builder builder(GetGradientaiOpenaiApiKeyModelVersion defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer patch;
        public Builder() {}
        public Builder(GetGradientaiOpenaiApiKeyModelVersion defaults) {
        ...
        public GetGradientaiOpenaiApiKeyModelVersion build() {
            final var _resultValue = new GetGradientaiOpenaiApiKeyModelVersion();
