...
@CustomType
public final class AppSpecServiceBitbucket {
    /**
    ...
    private AppSpecServiceBitbucket() {}
    /**
     * @return The name of the branch to use.
     * 
     */
    ...
    public static Builder builder(AppSpecServiceBitbucket defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String repo;
        public Builder() {}
        public Builder(AppSpecServiceBitbucket defaults) {
        ...
        public AppSpecServiceBitbucket build() {
            final var _resultValue = new AppSpecServiceBitbucket();
