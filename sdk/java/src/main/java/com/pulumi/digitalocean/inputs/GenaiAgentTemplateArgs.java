...
import com.pulumi.digitalocean.inputs.GenaiAgentTemplateKnowledgeBaseArgs;
import com.pulumi.digitalocean.inputs.GenaiAgentTemplateModelArgs;
...
public final class GenaiAgentTemplateArgs extends com.pulumi.resources.ResourceArgs {

    public static final GenaiAgentTemplateArgs Empty = new GenaiAgentTemplateArgs();
    ...
    private @Nullable Output<List<GenaiAgentTemplateKnowledgeBaseArgs>> knowledgeBases;

    /**
     * @return List of Knowledge Bases
     * 
     */
    public Optional<Output<List<GenaiAgentTemplateKnowledgeBaseArgs>>> knowledgeBases() {
     ...
     */
    @Import(name="models")
    private @Nullable Output<List<GenaiAgentTemplateModelArgs>> models;

    /**
     * @return Model of the Agent Template
     * 
     */
    public Optional<Output<List<GenaiAgentTemplateModelArgs>>> models() {
    ...
    private GenaiAgentTemplateArgs() {}

    private GenaiAgentTemplateArgs(GenaiAgentTemplateArgs $) {
    ...
    public static Builder builder(GenaiAgentTemplateArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GenaiAgentTemplateArgs();
        }

        public Builder(GenaiAgentTemplateArgs defaults) {
            $ = new GenaiAgentTemplateArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder knowledgeBases(@Nullable Output<List<GenaiAgentTemplateKnowledgeBaseArgs>> knowledgeBases) {
         ...
         * 
         */
        public Builder knowledgeBases(List<GenaiAgentTemplateKnowledgeBaseArgs> knowledgeBases) {
         ...
         * 
         */
        public Builder knowledgeBases(GenaiAgentTemplateKnowledgeBaseArgs... knowledgeBases) {
         ...
         * 
         */
        public Builder models(@Nullable Output<List<GenaiAgentTemplateModelArgs>> models) {
            $.models = models;
            return this;
        }
         ...
         * 
         */
        public Builder models(List<GenaiAgentTemplateModelArgs> models) {
         ...
         * 
         */
        public Builder models(GenaiAgentTemplateModelArgs... models) {
        ...
        public GenaiAgentTemplateArgs build() {
            return $;
        }
    }
