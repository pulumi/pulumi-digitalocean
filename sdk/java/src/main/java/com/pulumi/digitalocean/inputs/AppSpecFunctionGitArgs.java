...
public final class AppSpecFunctionGitArgs extends com.pulumi.resources.ResourceArgs {

    public static final AppSpecFunctionGitArgs Empty = new AppSpecFunctionGitArgs();
    ...
    private AppSpecFunctionGitArgs() {}

    private AppSpecFunctionGitArgs(AppSpecFunctionGitArgs $) {
        this.branch = $.branch;
    ...
    public static Builder builder(AppSpecFunctionGitArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AppSpecFunctionGitArgs();
        }

        public Builder(AppSpecFunctionGitArgs defaults) {
            $ = new AppSpecFunctionGitArgs(Objects.requireNonNull(defaults));
        }
        ...
        public AppSpecFunctionGitArgs build() {
            return $;
        }
    }
