...
@CustomType
public final class GetAppSpecJobBitbucket {
    /**
    ...
    private GetAppSpecJobBitbucket() {}
    /**
     * @return The name of the branch to use.
     * 
     */
    ...
    public static Builder builder(GetAppSpecJobBitbucket defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String repo;
        public Builder() {}
        public Builder(GetAppSpecJobBitbucket defaults) {
        ...
        public GetAppSpecJobBitbucket build() {
            final var _resultValue = new GetAppSpecJobBitbucket();
