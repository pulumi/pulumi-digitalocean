...
@CustomType
public final class GetGenaiOpenaiApiKeyModelVersion {
    /**
    ...
    private GetGenaiOpenaiApiKeyModelVersion() {}
    /**
     * @return Major version of the model
     * 
     */
    ...
    public static Builder builder(GetGenaiOpenaiApiKeyModelVersion defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer patch;
        public Builder() {}
        public Builder(GetGenaiOpenaiApiKeyModelVersion defaults) {
        ...
        public GetGenaiOpenaiApiKeyModelVersion build() {
            final var _resultValue = new GetGenaiOpenaiApiKeyModelVersion();
