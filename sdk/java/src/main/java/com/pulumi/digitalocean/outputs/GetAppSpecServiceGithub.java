...
@CustomType
public final class GetAppSpecServiceGithub {
    /**
    ...
    private GetAppSpecServiceGithub(
    ...
    public static Builder builder(GetAppSpecServiceGithub defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(GetAppSpecServiceGithub defaults) {
        ...
        public Builder repo(@Nullable String repo) {
            this.repo = repo;
            return this;
        }        public GetAppSpecServiceGithub build() {
            return new GetAppSpecServiceGithub(branch, deployOnPush, repo);
        }
    }
}
