...
public final class AppSpecWorkerBitbucketArgs extends com.pulumi.resources.ResourceArgs {

    public static final AppSpecWorkerBitbucketArgs Empty = new AppSpecWorkerBitbucketArgs();
    ...
    private AppSpecWorkerBitbucketArgs() {}

    private AppSpecWorkerBitbucketArgs(AppSpecWorkerBitbucketArgs $) {
        this.branch = $.branch;
    ...
    public static Builder builder(AppSpecWorkerBitbucketArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AppSpecWorkerBitbucketArgs();
        }

        public Builder(AppSpecWorkerBitbucketArgs defaults) {
            $ = new AppSpecWorkerBitbucketArgs(Objects.requireNonNull(defaults));
        }
        ...
        public AppSpecWorkerBitbucketArgs build() {
            return $;
        }
    }
