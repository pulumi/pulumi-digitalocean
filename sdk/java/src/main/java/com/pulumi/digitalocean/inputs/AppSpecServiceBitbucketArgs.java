...
public final class AppSpecServiceBitbucketArgs extends com.pulumi.resources.ResourceArgs {

    public static final AppSpecServiceBitbucketArgs Empty = new AppSpecServiceBitbucketArgs();
    ...
    private AppSpecServiceBitbucketArgs() {}

    private AppSpecServiceBitbucketArgs(AppSpecServiceBitbucketArgs $) {
        this.branch = $.branch;
    ...
    public static Builder builder(AppSpecServiceBitbucketArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AppSpecServiceBitbucketArgs();
        }

        public Builder(AppSpecServiceBitbucketArgs defaults) {
            $ = new AppSpecServiceBitbucketArgs(Objects.requireNonNull(defaults));
        }
        ...
        public AppSpecServiceBitbucketArgs build() {
            return $;
        }
    }
