...
@CustomType
public final class GetAppSpecServiceGit {
    /**
    ...
    public static Builder builder(GetAppSpecServiceGit defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(GetAppSpecServiceGit defaults) {
        ...
        public Builder repoCloneUrl(@Nullable String repoCloneUrl) {
            this.repoCloneUrl = repoCloneUrl;
            return this;
        }        public GetAppSpecServiceGit build() {
            return new GetAppSpecServiceGit(branch, repoCloneUrl);
        }
    }
}
