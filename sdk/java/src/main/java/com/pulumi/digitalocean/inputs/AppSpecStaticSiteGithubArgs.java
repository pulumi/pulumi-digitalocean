...
public final class AppSpecStaticSiteGithubArgs extends com.pulumi.resources.ResourceArgs {

    public static final AppSpecStaticSiteGithubArgs Empty = new AppSpecStaticSiteGithubArgs();
    ...
    private AppSpecStaticSiteGithubArgs() {}

    private AppSpecStaticSiteGithubArgs(AppSpecStaticSiteGithubArgs $) {
        this.branch = $.branch;
    ...
    public static Builder builder(AppSpecStaticSiteGithubArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AppSpecStaticSiteGithubArgs();
        }

        public Builder(AppSpecStaticSiteGithubArgs defaults) {
            $ = new AppSpecStaticSiteGithubArgs(Objects.requireNonNull(defaults));
        }
        ...
        public AppSpecStaticSiteGithubArgs build() {
            return $;
        }
    }
