...
public final class GenaiAgentParentAgentAnthropicApiKeyArgs extends com.pulumi.resources.ResourceArgs {

    public static final GenaiAgentParentAgentAnthropicApiKeyArgs Empty = new GenaiAgentParentAgentAnthropicApiKeyArgs();
    ...
    private GenaiAgentParentAgentAnthropicApiKeyArgs() {}

    private GenaiAgentParentAgentAnthropicApiKeyArgs(GenaiAgentParentAgentAnthropicApiKeyArgs $) {
    ...
    public static Builder builder(GenaiAgentParentAgentAnthropicApiKeyArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GenaiAgentParentAgentAnthropicApiKeyArgs();
        }

        public Builder(GenaiAgentParentAgentAnthropicApiKeyArgs defaults) {
            $ = new GenaiAgentParentAgentAnthropicApiKeyArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GenaiAgentParentAgentAnthropicApiKeyArgs build() {
            return $;
        }
    }
