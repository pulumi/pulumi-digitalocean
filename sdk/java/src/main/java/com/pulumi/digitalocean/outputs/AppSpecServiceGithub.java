...
@CustomType
public final class AppSpecServiceGithub {
    /**
    ...
    public static Builder builder(AppSpecServiceGithub defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(AppSpecServiceGithub defaults) {
        ...
        public Builder repo(@Nullable String repo) {
            this.repo = repo;
            return this;
        }        public AppSpecServiceGithub build() {
            return new AppSpecServiceGithub(branch, deployOnPush, repo);
        }
    }
}
