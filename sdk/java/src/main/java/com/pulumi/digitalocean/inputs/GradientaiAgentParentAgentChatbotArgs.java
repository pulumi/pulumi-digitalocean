...
public final class GradientaiAgentParentAgentChatbotArgs extends com.pulumi.resources.ResourceArgs {

    public static final GradientaiAgentParentAgentChatbotArgs Empty = new GradientaiAgentParentAgentChatbotArgs();
    ...
    private GradientaiAgentParentAgentChatbotArgs() {}

    private GradientaiAgentParentAgentChatbotArgs(GradientaiAgentParentAgentChatbotArgs $) {
    ...
    public static Builder builder(GradientaiAgentParentAgentChatbotArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GradientaiAgentParentAgentChatbotArgs();
        }

        public Builder(GradientaiAgentParentAgentChatbotArgs defaults) {
            $ = new GradientaiAgentParentAgentChatbotArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GradientaiAgentParentAgentChatbotArgs build() {
            return $;
        }
    }
