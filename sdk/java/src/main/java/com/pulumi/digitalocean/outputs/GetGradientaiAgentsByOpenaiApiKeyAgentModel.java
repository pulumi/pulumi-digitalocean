...
import com.pulumi.digitalocean.outputs.GetGradientaiAgentsByOpenaiApiKeyAgentModelAgreement;
import com.pulumi.digitalocean.outputs.GetGradientaiAgentsByOpenaiApiKeyAgentModelVersion;
...
@CustomType
public final class GetGradientaiAgentsByOpenaiApiKeyAgentModel {
    /**
     * @return Agreement information for the model
     * 
     */
    private @Nullable List<GetGradientaiAgentsByOpenaiApiKeyAgentModelAgreement> agreements;
    /**
     ...
     * 
     */
    private @Nullable List<GetGradientaiAgentsByOpenaiApiKeyAgentModelVersion> versions;

    private GetGradientaiAgentsByOpenaiApiKeyAgentModel() {}
    /**
     * @return Agreement information for the model
     * 
     */
    public List<GetGradientaiAgentsByOpenaiApiKeyAgentModelAgreement> agreements() {
     ...
     * 
     */
    public List<GetGradientaiAgentsByOpenaiApiKeyAgentModelVersion> versions() {
    ...
    public static Builder builder(GetGradientaiAgentsByOpenaiApiKeyAgentModel defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<GetGradientaiAgentsByOpenaiApiKeyAgentModelVersion> versions;
        public Builder() {}
        public Builder(GetGradientaiAgentsByOpenaiApiKeyAgentModel defaults) {
        ...
        @CustomType.Setter
        public Builder agreements(@Nullable List<GetGradientaiAgentsByOpenaiApiKeyAgentModelAgreement> agreements) {

            this.agreements = agreements;
            return this;
        }
        public Builder agreements(GetGradientaiAgentsByOpenaiApiKeyAgentModelAgreement... agreements) {
            return agreements(List.of(agreements));
        }
        @CustomType.Setter
        public Builder createdAt(String createdAt) {
            if (createdAt == null) {
              throw new MissingRequiredPropertyException("GetGradientaiAgentsByOpenaiApiKeyAgentModel", "createdAt");
            }
        ...
        public Builder updatedAt(String updatedAt) {
            if (updatedAt == null) {
              throw new MissingRequiredPropertyException("GetGradientaiAgentsByOpenaiApiKeyAgentModel", "updatedAt");
            }
        ...
        @CustomType.Setter
        public Builder versions(@Nullable List<GetGradientaiAgentsByOpenaiApiKeyAgentModelVersion> versions) {

            this.versions = versions;
            return this;
        }
        public Builder versions(GetGradientaiAgentsByOpenaiApiKeyAgentModelVersion... versions) {
            return versions(List.of(versions));
        }
        public GetGradientaiAgentsByOpenaiApiKeyAgentModel build() {
            final var _resultValue = new GetGradientaiAgentsByOpenaiApiKeyAgentModel();
