...
@CustomType
public final class AppSpecJobGithub {
    /**
    ...
    public static Builder builder(AppSpecJobGithub defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(AppSpecJobGithub defaults) {
        ...
        public Builder repo(@Nullable String repo) {
            this.repo = repo;
            return this;
        }        public AppSpecJobGithub build() {
            return new AppSpecJobGithub(branch, deployOnPush, repo);
        }
    }
}
