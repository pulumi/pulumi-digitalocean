...
import com.pulumi.digitalocean.inputs.GetGradientaiAgentTemplateKnowledgeBaseLastIndexingJob;
...
public final class GetGradientaiAgentTemplateKnowledgeBase extends com.pulumi.resources.InvokeArgs {

    public static final GetGradientaiAgentTemplateKnowledgeBase Empty = new GetGradientaiAgentTemplateKnowledgeBase();
    ...
    private @Nullable GetGradientaiAgentTemplateKnowledgeBaseLastIndexingJob lastIndexingJob;

    /**
     * @return Last indexing job for the Knowledge Base
     * 
     */
    public Optional<GetGradientaiAgentTemplateKnowledgeBaseLastIndexingJob> lastIndexingJob() {
    ...
    private GetGradientaiAgentTemplateKnowledgeBase() {}

    private GetGradientaiAgentTemplateKnowledgeBase(GetGradientaiAgentTemplateKnowledgeBase $) {
    ...
    public static Builder builder(GetGradientaiAgentTemplateKnowledgeBase defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetGradientaiAgentTemplateKnowledgeBase();
        }

        public Builder(GetGradientaiAgentTemplateKnowledgeBase defaults) {
            $ = new GetGradientaiAgentTemplateKnowledgeBase(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder lastIndexingJob(@Nullable GetGradientaiAgentTemplateKnowledgeBaseLastIndexingJob lastIndexingJob) {
        ...
        public GetGradientaiAgentTemplateKnowledgeBase build() {
            if ($.addedToAgentAt == null) {
                throw new MissingRequiredPropertyException("GetGradientaiAgentTemplateKnowledgeBase", "addedToAgentAt");
            }
            if ($.createdAt == null) {
                throw new MissingRequiredPropertyException("GetGradientaiAgentTemplateKnowledgeBase", "createdAt");
            }
            if ($.updatedAt == null) {
                throw new MissingRequiredPropertyException("GetGradientaiAgentTemplateKnowledgeBase", "updatedAt");
            }
            if ($.uuid == null) {
                throw new MissingRequiredPropertyException("GetGradientaiAgentTemplateKnowledgeBase", "uuid");
            }
            return $;
        }
    }
