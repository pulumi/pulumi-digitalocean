...
public final class AppSpecServiceGitlabArgs extends com.pulumi.resources.ResourceArgs {

    public static final AppSpecServiceGitlabArgs Empty = new AppSpecServiceGitlabArgs();
    ...
    private AppSpecServiceGitlabArgs() {}

    private AppSpecServiceGitlabArgs(AppSpecServiceGitlabArgs $) {
        this.branch = $.branch;
    ...
    public static Builder builder(AppSpecServiceGitlabArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AppSpecServiceGitlabArgs();
        }

        public Builder(AppSpecServiceGitlabArgs defaults) {
            $ = new AppSpecServiceGitlabArgs(Objects.requireNonNull(defaults));
        }
        ...
        public AppSpecServiceGitlabArgs build() {
            return $;
        }
    }
