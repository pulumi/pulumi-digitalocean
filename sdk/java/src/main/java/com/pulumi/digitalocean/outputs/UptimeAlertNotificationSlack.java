...
public final class UptimeAlertNotificationSlack {
    ...
    public static final class Builder {
        ...
        public Builder channel(String channel) {
            if (channel == null) {
              throw new MissingRequiredPropertyException("UptimeAlertNotificationSlack", "channel");
            }
        ...
        public Builder url(String url) {
            if (url == null) {
              throw new MissingRequiredPropertyException("UptimeAlertNotificationSlack", "url");
            }
            this.url = url;
            return this;
        }
