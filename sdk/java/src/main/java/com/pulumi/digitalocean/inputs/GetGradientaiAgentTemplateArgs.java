...
import com.pulumi.digitalocean.inputs.GetGradientaiAgentTemplateKnowledgeBaseArgs;
import com.pulumi.digitalocean.inputs.GetGradientaiAgentTemplateModelArgs;
...
public final class GetGradientaiAgentTemplateArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetGradientaiAgentTemplateArgs Empty = new GetGradientaiAgentTemplateArgs();
    ...
    private @Nullable Output<List<GetGradientaiAgentTemplateKnowledgeBaseArgs>> knowledgeBases;

    /**
     * @return List of Knowledge Bases
     * 
     */
    public Optional<Output<List<GetGradientaiAgentTemplateKnowledgeBaseArgs>>> knowledgeBases() {
     ...
     */
    @Import(name="models")
    private @Nullable Output<List<GetGradientaiAgentTemplateModelArgs>> models;

    /**
     * @return Model of the Agent Template
     * 
     */
    public Optional<Output<List<GetGradientaiAgentTemplateModelArgs>>> models() {
    ...
    private GetGradientaiAgentTemplateArgs() {}

    private GetGradientaiAgentTemplateArgs(GetGradientaiAgentTemplateArgs $) {
    ...
    public static Builder builder(GetGradientaiAgentTemplateArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetGradientaiAgentTemplateArgs();
        }

        public Builder(GetGradientaiAgentTemplateArgs defaults) {
            $ = new GetGradientaiAgentTemplateArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder knowledgeBases(@Nullable Output<List<GetGradientaiAgentTemplateKnowledgeBaseArgs>> knowledgeBases) {
         ...
         * 
         */
        public Builder knowledgeBases(List<GetGradientaiAgentTemplateKnowledgeBaseArgs> knowledgeBases) {
         ...
         * 
         */
        public Builder knowledgeBases(GetGradientaiAgentTemplateKnowledgeBaseArgs... knowledgeBases) {
         ...
         * 
         */
        public Builder models(@Nullable Output<List<GetGradientaiAgentTemplateModelArgs>> models) {
            $.models = models;
            return this;
        }
         ...
         * 
         */
        public Builder models(List<GetGradientaiAgentTemplateModelArgs> models) {
         ...
         * 
         */
        public Builder models(GetGradientaiAgentTemplateModelArgs... models) {
        ...
        public GetGradientaiAgentTemplateArgs build() {
            if ($.createdAt == null) {
                throw new MissingRequiredPropertyException("GetGradientaiAgentTemplateArgs", "createdAt");
            }
            if ($.updatedAt == null) {
                throw new MissingRequiredPropertyException("GetGradientaiAgentTemplateArgs", "updatedAt");
            }
            return $;
        }
    }
