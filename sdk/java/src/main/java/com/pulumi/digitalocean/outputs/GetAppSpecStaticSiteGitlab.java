...
@CustomType
public final class GetAppSpecStaticSiteGitlab {
    /**
    ...
    private GetAppSpecStaticSiteGitlab(
    ...
    public static Builder builder(GetAppSpecStaticSiteGitlab defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(GetAppSpecStaticSiteGitlab defaults) {
        ...
        public Builder repo(@Nullable String repo) {
            this.repo = repo;
            return this;
        }        public GetAppSpecStaticSiteGitlab build() {
            return new GetAppSpecStaticSiteGitlab(branch, deployOnPush, repo);
        }
    }
}
