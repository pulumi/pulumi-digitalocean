...
import com.pulumi.digitalocean.outputs.GetGenaiAgentsAgentTemplateKnowledgeBase;
import com.pulumi.digitalocean.outputs.GetGenaiAgentsAgentTemplateModel;
...
@CustomType
public final class GetGenaiAgentsAgentTemplate {
    /**
     ...
     * 
     */
    private @Nullable List<GetGenaiAgentsAgentTemplateKnowledgeBase> knowledgeBases;
    /**
     ...
     * 
     */
    private @Nullable List<GetGenaiAgentsAgentTemplateModel> models;
    /**
    ...
    private GetGenaiAgentsAgentTemplate() {}
    /**
     * @return Created At timestamp for the Knowledge Base
     * 
     */
     ...
     * 
     */
    public List<GetGenaiAgentsAgentTemplateKnowledgeBase> knowledgeBases() {
     ...
     * 
     */
    public List<GetGenaiAgentsAgentTemplateModel> models() {
    ...
    public static Builder builder(GetGenaiAgentsAgentTemplate defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String uuid;
        public Builder() {}
        public Builder(GetGenaiAgentsAgentTemplate defaults) {
        ...
        public Builder createdAt(String createdAt) {
            if (createdAt == null) {
              throw new MissingRequiredPropertyException("GetGenaiAgentsAgentTemplate", "createdAt");
            }
        ...
        @CustomType.Setter
        public Builder knowledgeBases(@Nullable List<GetGenaiAgentsAgentTemplateKnowledgeBase> knowledgeBases) {

            this.knowledgeBases = knowledgeBases;
            return this;
        }
        public Builder knowledgeBases(GetGenaiAgentsAgentTemplateKnowledgeBase... knowledgeBases) {
        ...
        @CustomType.Setter
        public Builder models(@Nullable List<GetGenaiAgentsAgentTemplateModel> models) {

            this.models = models;
            return this;
        }
        public Builder models(GetGenaiAgentsAgentTemplateModel... models) {
        ...
        public Builder updatedAt(String updatedAt) {
            if (updatedAt == null) {
              throw new MissingRequiredPropertyException("GetGenaiAgentsAgentTemplate", "updatedAt");
            }
        ...
        public GetGenaiAgentsAgentTemplate build() {
            final var _resultValue = new GetGenaiAgentsAgentTemplate();
