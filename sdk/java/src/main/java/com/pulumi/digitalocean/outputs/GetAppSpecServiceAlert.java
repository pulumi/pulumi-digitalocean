...
import com.pulumi.digitalocean.outputs.GetAppSpecServiceAlertDestinations;
...
public final class GetAppSpecServiceAlert {
    private @Nullable GetAppSpecServiceAlertDestinations destinations;
    /**
    ...
    public Optional<GetAppSpecServiceAlertDestinations> destinations() {
    ...
    public static final class Builder {
        ...
        @CustomType.Setter
        public Builder destinations(@Nullable GetAppSpecServiceAlertDestinations destinations) {
        ...
        public Builder operator(String operator) {
            if (operator == null) {
              throw new MissingRequiredPropertyException("GetAppSpecServiceAlert", "operator");
            }
        ...
        public Builder rule(String rule) {
            if (rule == null) {
              throw new MissingRequiredPropertyException("GetAppSpecServiceAlert", "rule");
            }
            this.rule = rule;
            return this;
        }
        ...
        public Builder value(Double value) {
            if (value == null) {
              throw new MissingRequiredPropertyException("GetAppSpecServiceAlert", "value");
            }
            this.value = value;
            return this;
        }
        ...
        public Builder window(String window) {
            if (window == null) {
              throw new MissingRequiredPropertyException("GetAppSpecServiceAlert", "window");
            }
            this.window = window;
            return this;
        }
        public GetAppSpecServiceAlert build() {
            final var _resultValue = new GetAppSpecServiceAlert();
