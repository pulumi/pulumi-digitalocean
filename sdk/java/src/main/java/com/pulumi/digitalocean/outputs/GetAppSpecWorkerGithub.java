...
@CustomType
public final class GetAppSpecWorkerGithub {
    /**
    ...
    private GetAppSpecWorkerGithub(
    ...
    public static Builder builder(GetAppSpecWorkerGithub defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(GetAppSpecWorkerGithub defaults) {
        ...
        public Builder repo(@Nullable String repo) {
            this.repo = repo;
            return this;
        }        public GetAppSpecWorkerGithub build() {
            return new GetAppSpecWorkerGithub(branch, deployOnPush, repo);
        }
    }
}
