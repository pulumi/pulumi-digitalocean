...
public final class AppSpecStaticSiteBitbucketArgs extends com.pulumi.resources.ResourceArgs {

    public static final AppSpecStaticSiteBitbucketArgs Empty = new AppSpecStaticSiteBitbucketArgs();
    ...
    private AppSpecStaticSiteBitbucketArgs() {}

    private AppSpecStaticSiteBitbucketArgs(AppSpecStaticSiteBitbucketArgs $) {
        this.branch = $.branch;
    ...
    public static Builder builder(AppSpecStaticSiteBitbucketArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AppSpecStaticSiteBitbucketArgs();
        }

        public Builder(AppSpecStaticSiteBitbucketArgs defaults) {
            $ = new AppSpecStaticSiteBitbucketArgs(Objects.requireNonNull(defaults));
        }
        ...
        public AppSpecStaticSiteBitbucketArgs build() {
            return $;
        }
    }
