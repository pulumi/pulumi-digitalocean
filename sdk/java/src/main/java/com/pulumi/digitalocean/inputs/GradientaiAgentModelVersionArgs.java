...
public final class GradientaiAgentModelVersionArgs extends com.pulumi.resources.ResourceArgs {

    public static final GradientaiAgentModelVersionArgs Empty = new GradientaiAgentModelVersionArgs();
    ...
    private GradientaiAgentModelVersionArgs() {}

    private GradientaiAgentModelVersionArgs(GradientaiAgentModelVersionArgs $) {
        this.major = $.major;
        this.minor = $.minor;
        this.patch = $.patch;
    }
    ...
    public static Builder builder(GradientaiAgentModelVersionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GradientaiAgentModelVersionArgs();
        }

        public Builder(GradientaiAgentModelVersionArgs defaults) {
            $ = new GradientaiAgentModelVersionArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GradientaiAgentModelVersionArgs build() {
            return $;
        }
    }
