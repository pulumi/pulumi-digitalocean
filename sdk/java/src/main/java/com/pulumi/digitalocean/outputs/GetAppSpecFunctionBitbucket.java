...
@CustomType
public final class GetAppSpecFunctionBitbucket {
    /**
    ...
    private GetAppSpecFunctionBitbucket() {}
    /**
     * @return The name of the branch to use.
     * 
     */
    ...
    public static Builder builder(GetAppSpecFunctionBitbucket defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String repo;
        public Builder() {}
        public Builder(GetAppSpecFunctionBitbucket defaults) {
        ...
        public GetAppSpecFunctionBitbucket build() {
            final var _resultValue = new GetAppSpecFunctionBitbucket();
