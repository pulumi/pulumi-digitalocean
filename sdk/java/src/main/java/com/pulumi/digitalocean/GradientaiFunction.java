...
import com.pulumi.digitalocean.GradientaiFunctionArgs;
...
public class GradientaiFunction extends com.pulumi.resources.CustomResource {
     ...
     */
    public GradientaiFunction(java.lang.String name) {
        this(name, GradientaiFunctionArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public GradientaiFunction(java.lang.String name, GradientaiFunctionArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public GradientaiFunction(java.lang.String name, GradientaiFunctionArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("digitalocean:index/gradientaiFunction:GradientaiFunction", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private GradientaiFunction(java.lang.String name, Output<java.lang.String> id, @Nullable GradientaiFunctionState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("digitalocean:index/gradientaiFunction:GradientaiFunction", name, state, makeResourceOptions(options, id), false);
    }

    private static GradientaiFunctionArgs makeArgs(GradientaiFunctionArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? GradientaiFunctionArgs.Empty : args;
    }
     ...
     */
    public static GradientaiFunction get(java.lang.String name, Output<java.lang.String> id, @Nullable GradientaiFunctionState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
