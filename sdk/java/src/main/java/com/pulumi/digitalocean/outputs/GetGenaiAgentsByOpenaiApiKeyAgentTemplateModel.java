...
import com.pulumi.digitalocean.outputs.GetGenaiAgentsByOpenaiApiKeyAgentTemplateModelAgreement;
import com.pulumi.digitalocean.outputs.GetGenaiAgentsByOpenaiApiKeyAgentTemplateModelVersion;
...
@CustomType
public final class GetGenaiAgentsByOpenaiApiKeyAgentTemplateModel {
    /**
     * @return Agreement information for the model
     * 
     */
    private @Nullable List<GetGenaiAgentsByOpenaiApiKeyAgentTemplateModelAgreement> agreements;
    /**
     ...
     * 
     */
    private @Nullable List<GetGenaiAgentsByOpenaiApiKeyAgentTemplateModelVersion> versions;

    private GetGenaiAgentsByOpenaiApiKeyAgentTemplateModel() {}
    /**
     * @return Agreement information for the model
     * 
     */
    public List<GetGenaiAgentsByOpenaiApiKeyAgentTemplateModelAgreement> agreements() {
     ...
     * 
     */
    public List<GetGenaiAgentsByOpenaiApiKeyAgentTemplateModelVersion> versions() {
    ...
    public static Builder builder(GetGenaiAgentsByOpenaiApiKeyAgentTemplateModel defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<GetGenaiAgentsByOpenaiApiKeyAgentTemplateModelVersion> versions;
        public Builder() {}
        public Builder(GetGenaiAgentsByOpenaiApiKeyAgentTemplateModel defaults) {
        ...
        @CustomType.Setter
        public Builder agreements(@Nullable List<GetGenaiAgentsByOpenaiApiKeyAgentTemplateModelAgreement> agreements) {

            this.agreements = agreements;
            return this;
        }
        public Builder agreements(GetGenaiAgentsByOpenaiApiKeyAgentTemplateModelAgreement... agreements) {
            return agreements(List.of(agreements));
        }
        @CustomType.Setter
        public Builder createdAt(String createdAt) {
            if (createdAt == null) {
              throw new MissingRequiredPropertyException("GetGenaiAgentsByOpenaiApiKeyAgentTemplateModel", "createdAt");
            }
        ...
        public Builder updatedAt(String updatedAt) {
            if (updatedAt == null) {
              throw new MissingRequiredPropertyException("GetGenaiAgentsByOpenaiApiKeyAgentTemplateModel", "updatedAt");
            }
        ...
        @CustomType.Setter
        public Builder versions(@Nullable List<GetGenaiAgentsByOpenaiApiKeyAgentTemplateModelVersion> versions) {

            this.versions = versions;
            return this;
        }
        public Builder versions(GetGenaiAgentsByOpenaiApiKeyAgentTemplateModelVersion... versions) {
            return versions(List.of(versions));
        }
        public GetGenaiAgentsByOpenaiApiKeyAgentTemplateModel build() {
            final var _resultValue = new GetGenaiAgentsByOpenaiApiKeyAgentTemplateModel();
