...
public final class GetGenaiKnowledgeBaseLastIndexingJob extends com.pulumi.resources.InvokeArgs {

    public static final GetGenaiKnowledgeBaseLastIndexingJob Empty = new GetGenaiKnowledgeBaseLastIndexingJob();
    ...
    private GetGenaiKnowledgeBaseLastIndexingJob() {}

    private GetGenaiKnowledgeBaseLastIndexingJob(GetGenaiKnowledgeBaseLastIndexingJob $) {
    ...
    public static Builder builder(GetGenaiKnowledgeBaseLastIndexingJob defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetGenaiKnowledgeBaseLastIndexingJob();
        }

        public Builder(GetGenaiKnowledgeBaseLastIndexingJob defaults) {
            $ = new GetGenaiKnowledgeBaseLastIndexingJob(Objects.requireNonNull(defaults));
        }
        ...
        public GetGenaiKnowledgeBaseLastIndexingJob build() {
            if ($.createdAt == null) {
                throw new MissingRequiredPropertyException("GetGenaiKnowledgeBaseLastIndexingJob", "createdAt");
            }
            if ($.finishedAt == null) {
                throw new MissingRequiredPropertyException("GetGenaiKnowledgeBaseLastIndexingJob", "finishedAt");
            }
            if ($.knowledgeBaseUuid == null) {
                throw new MissingRequiredPropertyException("GetGenaiKnowledgeBaseLastIndexingJob", "knowledgeBaseUuid");
            }
            if ($.startedAt == null) {
                throw new MissingRequiredPropertyException("GetGenaiKnowledgeBaseLastIndexingJob", "startedAt");
            }
            if ($.updatedAt == null) {
                throw new MissingRequiredPropertyException("GetGenaiKnowledgeBaseLastIndexingJob", "updatedAt");
            }
            return $;
        }
    }
