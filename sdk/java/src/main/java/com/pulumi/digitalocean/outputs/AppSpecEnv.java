...
public final class AppSpecEnv {
    ...
    public static Builder builder(AppSpecEnv defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(AppSpecEnv defaults) {
        ...
        public Builder value(@Nullable String value) {
            this.value = value;
            return this;
        }        public AppSpecEnv build() {
            return new AppSpecEnv(key, scope, type, value);
        }
    }
}
