...
import com.pulumi.digitalocean.outputs.GetGenaiAgentsByOpenaiApiKeyAgentModelAgreement;
import com.pulumi.digitalocean.outputs.GetGenaiAgentsByOpenaiApiKeyAgentModelVersion;
...
@CustomType
public final class GetGenaiAgentsByOpenaiApiKeyAgentModel {
    /**
     * @return Agreement information for the model
     * 
     */
    private @Nullable List<GetGenaiAgentsByOpenaiApiKeyAgentModelAgreement> agreements;
    /**
     ...
     * 
     */
    private @Nullable List<GetGenaiAgentsByOpenaiApiKeyAgentModelVersion> versions;

    private GetGenaiAgentsByOpenaiApiKeyAgentModel() {}
    /**
     * @return Agreement information for the model
     * 
     */
    public List<GetGenaiAgentsByOpenaiApiKeyAgentModelAgreement> agreements() {
     ...
     * 
     */
    public List<GetGenaiAgentsByOpenaiApiKeyAgentModelVersion> versions() {
    ...
    public static Builder builder(GetGenaiAgentsByOpenaiApiKeyAgentModel defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<GetGenaiAgentsByOpenaiApiKeyAgentModelVersion> versions;
        public Builder() {}
        public Builder(GetGenaiAgentsByOpenaiApiKeyAgentModel defaults) {
        ...
        @CustomType.Setter
        public Builder agreements(@Nullable List<GetGenaiAgentsByOpenaiApiKeyAgentModelAgreement> agreements) {

            this.agreements = agreements;
            return this;
        }
        public Builder agreements(GetGenaiAgentsByOpenaiApiKeyAgentModelAgreement... agreements) {
            return agreements(List.of(agreements));
        }
        @CustomType.Setter
        public Builder createdAt(String createdAt) {
            if (createdAt == null) {
              throw new MissingRequiredPropertyException("GetGenaiAgentsByOpenaiApiKeyAgentModel", "createdAt");
            }
        ...
        public Builder updatedAt(String updatedAt) {
            if (updatedAt == null) {
              throw new MissingRequiredPropertyException("GetGenaiAgentsByOpenaiApiKeyAgentModel", "updatedAt");
            }
        ...
        @CustomType.Setter
        public Builder versions(@Nullable List<GetGenaiAgentsByOpenaiApiKeyAgentModelVersion> versions) {

            this.versions = versions;
            return this;
        }
        public Builder versions(GetGenaiAgentsByOpenaiApiKeyAgentModelVersion... versions) {
            return versions(List.of(versions));
        }
        public GetGenaiAgentsByOpenaiApiKeyAgentModel build() {
            final var _resultValue = new GetGenaiAgentsByOpenaiApiKeyAgentModel();
