...
public final class GenaiOpenaiApiKeyModelVersionArgs extends com.pulumi.resources.ResourceArgs {

    public static final GenaiOpenaiApiKeyModelVersionArgs Empty = new GenaiOpenaiApiKeyModelVersionArgs();
    ...
    private GenaiOpenaiApiKeyModelVersionArgs() {}

    private GenaiOpenaiApiKeyModelVersionArgs(GenaiOpenaiApiKeyModelVersionArgs $) {
        this.major = $.major;
        this.minor = $.minor;
        this.patch = $.patch;
    }
    ...
    public static Builder builder(GenaiOpenaiApiKeyModelVersionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GenaiOpenaiApiKeyModelVersionArgs();
        }

        public Builder(GenaiOpenaiApiKeyModelVersionArgs defaults) {
            $ = new GenaiOpenaiApiKeyModelVersionArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GenaiOpenaiApiKeyModelVersionArgs build() {
            return $;
        }
    }
