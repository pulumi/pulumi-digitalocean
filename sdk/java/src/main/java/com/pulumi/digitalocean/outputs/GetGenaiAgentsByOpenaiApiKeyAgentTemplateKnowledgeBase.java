...
import com.pulumi.digitalocean.outputs.GetGenaiAgentsByOpenaiApiKeyAgentTemplateKnowledgeBaseLastIndexingJob;
...
@CustomType
public final class GetGenaiAgentsByOpenaiApiKeyAgentTemplateKnowledgeBase {
    /**
     ...
     * 
     */
    private @Nullable GetGenaiAgentsByOpenaiApiKeyAgentTemplateKnowledgeBaseLastIndexingJob lastIndexingJob;
    /**
    ...
    private GetGenaiAgentsByOpenaiApiKeyAgentTemplateKnowledgeBase() {}
    /**
     * @return Timestamp when the Knowledge Base was added to the Agent
     * 
     */
     ...
     * 
     */
    public Optional<GetGenaiAgentsByOpenaiApiKeyAgentTemplateKnowledgeBaseLastIndexingJob> lastIndexingJob() {
    ...
    public static Builder builder(GetGenaiAgentsByOpenaiApiKeyAgentTemplateKnowledgeBase defaults) {
    ...
    public static final class Builder {
        ...
        private String uuid;
        public Builder() {}
        public Builder(GetGenaiAgentsByOpenaiApiKeyAgentTemplateKnowledgeBase defaults) {
        ...
        public Builder addedToAgentAt(String addedToAgentAt) {
            if (addedToAgentAt == null) {
              throw new MissingRequiredPropertyException("GetGenaiAgentsByOpenaiApiKeyAgentTemplateKnowledgeBase", "addedToAgentAt");
            }
        ...
        public Builder createdAt(String createdAt) {
            if (createdAt == null) {
              throw new MissingRequiredPropertyException("GetGenaiAgentsByOpenaiApiKeyAgentTemplateKnowledgeBase", "createdAt");
            }
        ...
        @CustomType.Setter
        public Builder lastIndexingJob(@Nullable GetGenaiAgentsByOpenaiApiKeyAgentTemplateKnowledgeBaseLastIndexingJob lastIndexingJob) {
        ...
        public Builder updatedAt(String updatedAt) {
            if (updatedAt == null) {
              throw new MissingRequiredPropertyException("GetGenaiAgentsByOpenaiApiKeyAgentTemplateKnowledgeBase", "updatedAt");
            }
        ...
        public Builder uuid(String uuid) {
            if (uuid == null) {
              throw new MissingRequiredPropertyException("GetGenaiAgentsByOpenaiApiKeyAgentTemplateKnowledgeBase", "uuid");
            }
            this.uuid = uuid;
            return this;
        }
        public GetGenaiAgentsByOpenaiApiKeyAgentTemplateKnowledgeBase build() {
            final var _resultValue = new GetGenaiAgentsByOpenaiApiKeyAgentTemplateKnowledgeBase();
