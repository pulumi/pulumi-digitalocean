...
public final class AppSpecJobGitArgs extends com.pulumi.resources.ResourceArgs {

    public static final AppSpecJobGitArgs Empty = new AppSpecJobGitArgs();
    ...
    private AppSpecJobGitArgs() {}

    private AppSpecJobGitArgs(AppSpecJobGitArgs $) {
        this.branch = $.branch;
    ...
    public static Builder builder(AppSpecJobGitArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AppSpecJobGitArgs();
        }

        public Builder(AppSpecJobGitArgs defaults) {
            $ = new AppSpecJobGitArgs(Objects.requireNonNull(defaults));
        }
        ...
        public AppSpecJobGitArgs build() {
            return $;
        }
    }
