...
public final class AppSpecWorkerGithubArgs extends com.pulumi.resources.ResourceArgs {

    public static final AppSpecWorkerGithubArgs Empty = new AppSpecWorkerGithubArgs();
    ...
    private AppSpecWorkerGithubArgs() {}

    private AppSpecWorkerGithubArgs(AppSpecWorkerGithubArgs $) {
        this.branch = $.branch;
    ...
    public static Builder builder(AppSpecWorkerGithubArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AppSpecWorkerGithubArgs();
        }

        public Builder(AppSpecWorkerGithubArgs defaults) {
            $ = new AppSpecWorkerGithubArgs(Objects.requireNonNull(defaults));
        }
        ...
        public AppSpecWorkerGithubArgs build() {
            return $;
        }
    }
