...
public final class GradientaiFunctionState extends com.pulumi.resources.ResourceArgs {
    ...
    private GradientaiFunctionState() {}

    private GradientaiFunctionState(GradientaiFunctionState $) {
    ...
    public static Builder builder(GradientaiFunctionState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GradientaiFunctionState();
        }

        public Builder(GradientaiFunctionState defaults) {
            $ = new GradientaiFunctionState(Objects.requireNonNull(defaults));
        }
        ...
        public GradientaiFunctionState build() {
            return $;
        }
    }
