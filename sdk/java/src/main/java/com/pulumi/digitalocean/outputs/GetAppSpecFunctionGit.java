...
@CustomType
public final class GetAppSpecFunctionGit {
    /**
    ...
    public static Builder builder(GetAppSpecFunctionGit defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(GetAppSpecFunctionGit defaults) {
        ...
        public Builder repoCloneUrl(@Nullable String repoCloneUrl) {
            ...
            return new GetAppSpecFunctionGit(branch, repoCloneUrl);
        }
    }
}
