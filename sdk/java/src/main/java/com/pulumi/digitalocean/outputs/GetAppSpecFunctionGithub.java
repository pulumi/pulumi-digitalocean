...
@CustomType
public final class GetAppSpecFunctionGithub {
    /**
    ...
    private GetAppSpecFunctionGithub(
    ...
    public static Builder builder(GetAppSpecFunctionGithub defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(GetAppSpecFunctionGithub defaults) {
        ...
        public Builder repo(@Nullable String repo) {
            this.repo = repo;
            return this;
        }        public GetAppSpecFunctionGithub build() {
            return new GetAppSpecFunctionGithub(branch, deployOnPush, repo);
        }
    }
}
