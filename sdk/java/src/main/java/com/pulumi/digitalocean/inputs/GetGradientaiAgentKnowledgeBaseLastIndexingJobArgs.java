...
public final class GetGradientaiAgentKnowledgeBaseLastIndexingJobArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetGradientaiAgentKnowledgeBaseLastIndexingJobArgs Empty = new GetGradientaiAgentKnowledgeBaseLastIndexingJobArgs();
    ...
    private GetGradientaiAgentKnowledgeBaseLastIndexingJobArgs() {}

    private GetGradientaiAgentKnowledgeBaseLastIndexingJobArgs(GetGradientaiAgentKnowledgeBaseLastIndexingJobArgs $) {
    ...
    public static Builder builder(GetGradientaiAgentKnowledgeBaseLastIndexingJobArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetGradientaiAgentKnowledgeBaseLastIndexingJobArgs();
        }

        public Builder(GetGradientaiAgentKnowledgeBaseLastIndexingJobArgs defaults) {
            $ = new GetGradientaiAgentKnowledgeBaseLastIndexingJobArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetGradientaiAgentKnowledgeBaseLastIndexingJobArgs build() {
            if ($.createdAt == null) {
                throw new MissingRequiredPropertyException("GetGradientaiAgentKnowledgeBaseLastIndexingJobArgs", "createdAt");
            }
            if ($.finishedAt == null) {
                throw new MissingRequiredPropertyException("GetGradientaiAgentKnowledgeBaseLastIndexingJobArgs", "finishedAt");
            }
            if ($.knowledgeBaseUuid == null) {
                throw new MissingRequiredPropertyException("GetGradientaiAgentKnowledgeBaseLastIndexingJobArgs", "knowledgeBaseUuid");
            }
            if ($.startedAt == null) {
                throw new MissingRequiredPropertyException("GetGradientaiAgentKnowledgeBaseLastIndexingJobArgs", "startedAt");
            }
            if ($.updatedAt == null) {
                throw new MissingRequiredPropertyException("GetGradientaiAgentKnowledgeBaseLastIndexingJobArgs", "updatedAt");
            }
            return $;
        }
    }
