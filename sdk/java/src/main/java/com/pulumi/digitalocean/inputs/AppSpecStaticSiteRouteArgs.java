...
public final class AppSpecStaticSiteRouteArgs extends com.pulumi.resources.ResourceArgs {

    public static final AppSpecStaticSiteRouteArgs Empty = new AppSpecStaticSiteRouteArgs();
    ...
    private AppSpecStaticSiteRouteArgs() {}

    private AppSpecStaticSiteRouteArgs(AppSpecStaticSiteRouteArgs $) {
        this.path = $.path;
    ...
    public static Builder builder(AppSpecStaticSiteRouteArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AppSpecStaticSiteRouteArgs();
        }

        public Builder(AppSpecStaticSiteRouteArgs defaults) {
            $ = new AppSpecStaticSiteRouteArgs(Objects.requireNonNull(defaults));
        }
        ...
        public AppSpecStaticSiteRouteArgs build() {
            return $;
        }
    }
