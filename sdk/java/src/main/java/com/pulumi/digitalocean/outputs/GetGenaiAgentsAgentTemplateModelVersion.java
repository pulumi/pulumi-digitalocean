...
@CustomType
public final class GetGenaiAgentsAgentTemplateModelVersion {
    /**
    ...
    private GetGenaiAgentsAgentTemplateModelVersion() {}
    /**
     * @return Major version of the model
     * 
     */
    ...
    public static Builder builder(GetGenaiAgentsAgentTemplateModelVersion defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer patch;
        public Builder() {}
        public Builder(GetGenaiAgentsAgentTemplateModelVersion defaults) {
        ...
        public GetGenaiAgentsAgentTemplateModelVersion build() {
            final var _resultValue = new GetGenaiAgentsAgentTemplateModelVersion();
