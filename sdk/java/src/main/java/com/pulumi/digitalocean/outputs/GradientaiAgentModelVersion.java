...
@CustomType
public final class GradientaiAgentModelVersion {
    /**
    ...
    private GradientaiAgentModelVersion() {}
    /**
     * @return Major version of the model
     * 
     */
    ...
    public static Builder builder(GradientaiAgentModelVersion defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer patch;
        public Builder() {}
        public Builder(GradientaiAgentModelVersion defaults) {
        ...
        public GradientaiAgentModelVersion build() {
            final var _resultValue = new GradientaiAgentModelVersion();
