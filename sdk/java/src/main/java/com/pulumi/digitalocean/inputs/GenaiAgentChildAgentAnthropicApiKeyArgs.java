...
public final class GenaiAgentChildAgentAnthropicApiKeyArgs extends com.pulumi.resources.ResourceArgs {

    public static final GenaiAgentChildAgentAnthropicApiKeyArgs Empty = new GenaiAgentChildAgentAnthropicApiKeyArgs();
    ...
    private GenaiAgentChildAgentAnthropicApiKeyArgs() {}

    private GenaiAgentChildAgentAnthropicApiKeyArgs(GenaiAgentChildAgentAnthropicApiKeyArgs $) {
    ...
    public static Builder builder(GenaiAgentChildAgentAnthropicApiKeyArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GenaiAgentChildAgentAnthropicApiKeyArgs();
        }

        public Builder(GenaiAgentChildAgentAnthropicApiKeyArgs defaults) {
            $ = new GenaiAgentChildAgentAnthropicApiKeyArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GenaiAgentChildAgentAnthropicApiKeyArgs build() {
            return $;
        }
    }
