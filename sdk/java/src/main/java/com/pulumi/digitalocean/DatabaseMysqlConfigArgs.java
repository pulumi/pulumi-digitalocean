...
public final class DatabaseMysqlConfigArgs extends com.pulumi.resources.ResourceArgs {

    public static final DatabaseMysqlConfigArgs Empty = new DatabaseMysqlConfigArgs();
    ...
    private DatabaseMysqlConfigArgs() {}

    private DatabaseMysqlConfigArgs(DatabaseMysqlConfigArgs $) {
    ...
    public static Builder builder(DatabaseMysqlConfigArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DatabaseMysqlConfigArgs();
        }

        public Builder(DatabaseMysqlConfigArgs defaults) {
            $ = new DatabaseMysqlConfigArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DatabaseMysqlConfigArgs build() {
            if ($.clusterId == null) {
                throw new MissingRequiredPropertyException("DatabaseMysqlConfigArgs", "clusterId");
            }
            return $;
        }
    }
