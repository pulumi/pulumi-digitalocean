...
@CustomType
public final class AppSpecFunctionGithub {
    /**
    ...
    public static Builder builder(AppSpecFunctionGithub defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(AppSpecFunctionGithub defaults) {
        ...
        public Builder repo(@Nullable String repo) {
            this.repo = repo;
            return this;
        }        public AppSpecFunctionGithub build() {
            return new AppSpecFunctionGithub(branch, deployOnPush, repo);
        }
    }
}
