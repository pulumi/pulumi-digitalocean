...
public final class ReservedIpAssignmentArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public ReservedIpAssignmentArgs build() {
            if ($.dropletId == null) {
                throw new MissingRequiredPropertyException("ReservedIpAssignmentArgs", "dropletId");
            }
            if ($.ipAddress == null) {
                throw new MissingRequiredPropertyException("ReservedIpAssignmentArgs", "ipAddress");
            }
            return $;
        }
    }
