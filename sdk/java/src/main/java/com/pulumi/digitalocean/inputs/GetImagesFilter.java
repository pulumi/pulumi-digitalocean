...
public final class GetImagesFilter extends com.pulumi.resources.InvokeArgs {

    public static final GetImagesFilter Empty = new GetImagesFilter();
    ...
    private GetImagesFilter(GetImagesFilter $) {
        this.all = $.all;
        this.key = $.key;
    ...
    public static final class Builder {
        ...
        public Builder(GetImagesFilter defaults) {
            $ = new GetImagesFilter(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagesFilter build() {
            if ($.key == null) {
                throw new MissingRequiredPropertyException("GetImagesFilter", "key");
            }
            if ($.values == null) {
                throw new MissingRequiredPropertyException("GetImagesFilter", "values");
            }
            return $;
        }
    }
