...
import com.pulumi.digitalocean.outputs.GetGradientaiAgentsByOpenaiApiKeyAgentTemplateModelAgreement;
import com.pulumi.digitalocean.outputs.GetGradientaiAgentsByOpenaiApiKeyAgentTemplateModelVersion;
...
@CustomType
public final class GetGradientaiAgentsByOpenaiApiKeyAgentTemplateModel {
    /**
     * @return Agreement information for the model
     * 
     */
    private @Nullable List<GetGradientaiAgentsByOpenaiApiKeyAgentTemplateModelAgreement> agreements;
    /**
     ...
     * 
     */
    private @Nullable List<GetGradientaiAgentsByOpenaiApiKeyAgentTemplateModelVersion> versions;

    private GetGradientaiAgentsByOpenaiApiKeyAgentTemplateModel() {}
    /**
     * @return Agreement information for the model
     * 
     */
    public List<GetGradientaiAgentsByOpenaiApiKeyAgentTemplateModelAgreement> agreements() {
     ...
     * 
     */
    public List<GetGradientaiAgentsByOpenaiApiKeyAgentTemplateModelVersion> versions() {
    ...
    public static Builder builder(GetGradientaiAgentsByOpenaiApiKeyAgentTemplateModel defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<GetGradientaiAgentsByOpenaiApiKeyAgentTemplateModelVersion> versions;
        public Builder() {}
        public Builder(GetGradientaiAgentsByOpenaiApiKeyAgentTemplateModel defaults) {
        ...
        @CustomType.Setter
        public Builder agreements(@Nullable List<GetGradientaiAgentsByOpenaiApiKeyAgentTemplateModelAgreement> agreements) {

            this.agreements = agreements;
            return this;
        }
        public Builder agreements(GetGradientaiAgentsByOpenaiApiKeyAgentTemplateModelAgreement... agreements) {
            return agreements(List.of(agreements));
        }
        @CustomType.Setter
        public Builder createdAt(String createdAt) {
            if (createdAt == null) {
              throw new MissingRequiredPropertyException("GetGradientaiAgentsByOpenaiApiKeyAgentTemplateModel", "createdAt");
            }
        ...
        public Builder updatedAt(String updatedAt) {
            if (updatedAt == null) {
              throw new MissingRequiredPropertyException("GetGradientaiAgentsByOpenaiApiKeyAgentTemplateModel", "updatedAt");
            }
        ...
        @CustomType.Setter
        public Builder versions(@Nullable List<GetGradientaiAgentsByOpenaiApiKeyAgentTemplateModelVersion> versions) {

            this.versions = versions;
            return this;
        }
        public Builder versions(GetGradientaiAgentsByOpenaiApiKeyAgentTemplateModelVersion... versions) {
            return versions(List.of(versions));
        }
        public GetGradientaiAgentsByOpenaiApiKeyAgentTemplateModel build() {
            final var _resultValue = new GetGradientaiAgentsByOpenaiApiKeyAgentTemplateModel();
