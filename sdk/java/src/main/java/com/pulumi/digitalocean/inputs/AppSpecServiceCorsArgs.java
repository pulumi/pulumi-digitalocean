...
public final class AppSpecServiceCorsArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private @Nullable Output<AppSpecServiceCorsAllowOriginsArgs> allowOrigins;

    /**
     * @return The set of allowed CORS origins. This configures the Access-Control-Allow-Origin header.
     * 
     */
    public Optional<Output<AppSpecServiceCorsAllowOriginsArgs>> allowOrigins() {
    ...
    public static final class Builder {
         ...
         * 
         */
        public Builder allowOrigins(@Nullable Output<AppSpecServiceCorsAllowOriginsArgs> allowOrigins) {
