...
@CustomType
public final class GetGradientaiKnowledgeBaseDataSourcesDatasourceLastIndexingJob {
    /**
    ...
    private GetGradientaiKnowledgeBaseDataSourcesDatasourceLastIndexingJob() {}
    /**
     * @return Number of completed datasources in the last indexing job
     * 
     */
    ...
    public static Builder builder(GetGradientaiKnowledgeBaseDataSourcesDatasourceLastIndexingJob defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String uuid;
        public Builder() {}
        public Builder(GetGradientaiKnowledgeBaseDataSourcesDatasourceLastIndexingJob defaults) {
        ...
        public Builder createdAt(String createdAt) {
            if (createdAt == null) {
              throw new MissingRequiredPropertyException("GetGradientaiKnowledgeBaseDataSourcesDatasourceLastIndexingJob", "createdAt");
            }
        ...
        public Builder finishedAt(String finishedAt) {
            if (finishedAt == null) {
              throw new MissingRequiredPropertyException("GetGradientaiKnowledgeBaseDataSourcesDatasourceLastIndexingJob", "finishedAt");
            }
        ...
        public Builder knowledgeBaseUuid(String knowledgeBaseUuid) {
            if (knowledgeBaseUuid == null) {
              throw new MissingRequiredPropertyException("GetGradientaiKnowledgeBaseDataSourcesDatasourceLastIndexingJob", "knowledgeBaseUuid");
            }
        ...
        public Builder startedAt(String startedAt) {
            if (startedAt == null) {
              throw new MissingRequiredPropertyException("GetGradientaiKnowledgeBaseDataSourcesDatasourceLastIndexingJob", "startedAt");
            }
        ...
        public Builder updatedAt(String updatedAt) {
            if (updatedAt == null) {
              throw new MissingRequiredPropertyException("GetGradientaiKnowledgeBaseDataSourcesDatasourceLastIndexingJob", "updatedAt");
            }
        ...
        public GetGradientaiKnowledgeBaseDataSourcesDatasourceLastIndexingJob build() {
            final var _resultValue = new GetGradientaiKnowledgeBaseDataSourcesDatasourceLastIndexingJob();
