...
@CustomType
public final class AppSpecWorkerBitbucket {
    /**
    ...
    private AppSpecWorkerBitbucket() {}
    /**
     * @return The name of the branch to use.
     * 
     */
    ...
    public static Builder builder(AppSpecWorkerBitbucket defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String repo;
        public Builder() {}
        public Builder(AppSpecWorkerBitbucket defaults) {
        ...
        public AppSpecWorkerBitbucket build() {
            final var _resultValue = new AppSpecWorkerBitbucket();
