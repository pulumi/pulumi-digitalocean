...
public final class GetGradientaiAgentTemplateKnowledgeBaseLastIndexingJobArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetGradientaiAgentTemplateKnowledgeBaseLastIndexingJobArgs Empty = new GetGradientaiAgentTemplateKnowledgeBaseLastIndexingJobArgs();
    ...
    private GetGradientaiAgentTemplateKnowledgeBaseLastIndexingJobArgs() {}

    private GetGradientaiAgentTemplateKnowledgeBaseLastIndexingJobArgs(GetGradientaiAgentTemplateKnowledgeBaseLastIndexingJobArgs $) {
    ...
    public static Builder builder(GetGradientaiAgentTemplateKnowledgeBaseLastIndexingJobArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetGradientaiAgentTemplateKnowledgeBaseLastIndexingJobArgs();
        }

        public Builder(GetGradientaiAgentTemplateKnowledgeBaseLastIndexingJobArgs defaults) {
            $ = new GetGradientaiAgentTemplateKnowledgeBaseLastIndexingJobArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetGradientaiAgentTemplateKnowledgeBaseLastIndexingJobArgs build() {
            if ($.createdAt == null) {
                throw new MissingRequiredPropertyException("GetGradientaiAgentTemplateKnowledgeBaseLastIndexingJobArgs", "createdAt");
            }
            if ($.finishedAt == null) {
                throw new MissingRequiredPropertyException("GetGradientaiAgentTemplateKnowledgeBaseLastIndexingJobArgs", "finishedAt");
            }
            if ($.knowledgeBaseUuid == null) {
                throw new MissingRequiredPropertyException("GetGradientaiAgentTemplateKnowledgeBaseLastIndexingJobArgs", "knowledgeBaseUuid");
            }
            if ($.startedAt == null) {
                throw new MissingRequiredPropertyException("GetGradientaiAgentTemplateKnowledgeBaseLastIndexingJobArgs", "startedAt");
            }
            if ($.updatedAt == null) {
                throw new MissingRequiredPropertyException("GetGradientaiAgentTemplateKnowledgeBaseLastIndexingJobArgs", "updatedAt");
            }
            return $;
        }
    }
