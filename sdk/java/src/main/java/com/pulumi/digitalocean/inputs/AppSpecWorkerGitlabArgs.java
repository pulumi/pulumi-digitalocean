...
public final class AppSpecWorkerGitlabArgs extends com.pulumi.resources.ResourceArgs {

    public static final AppSpecWorkerGitlabArgs Empty = new AppSpecWorkerGitlabArgs();
    ...
    private AppSpecWorkerGitlabArgs() {}

    private AppSpecWorkerGitlabArgs(AppSpecWorkerGitlabArgs $) {
        this.branch = $.branch;
    ...
    public static Builder builder(AppSpecWorkerGitlabArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AppSpecWorkerGitlabArgs();
        }

        public Builder(AppSpecWorkerGitlabArgs defaults) {
            $ = new AppSpecWorkerGitlabArgs(Objects.requireNonNull(defaults));
        }
        ...
        public AppSpecWorkerGitlabArgs build() {
            return $;
        }
    }
