...
public final class GetGenaiAgentChatbotArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetGenaiAgentChatbotArgs Empty = new GetGenaiAgentChatbotArgs();
    ...
    private GetGenaiAgentChatbotArgs() {}

    private GetGenaiAgentChatbotArgs(GetGenaiAgentChatbotArgs $) {
    ...
    public static Builder builder(GetGenaiAgentChatbotArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetGenaiAgentChatbotArgs();
        }

        public Builder(GetGenaiAgentChatbotArgs defaults) {
            $ = new GetGenaiAgentChatbotArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetGenaiAgentChatbotArgs build() {
            return $;
        }
    }
