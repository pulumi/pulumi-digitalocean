...
import com.pulumi.digitalocean.inputs.GetGradientaiKnowledgeBaseLastIndexingJobArgs;
...
public final class GetGradientaiKnowledgeBaseArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetGradientaiKnowledgeBaseArgs Empty = new GetGradientaiKnowledgeBaseArgs();
    ...
    private @Nullable Output<List<GetGradientaiKnowledgeBaseLastIndexingJobArgs>> lastIndexingJobs;

    public Optional<Output<List<GetGradientaiKnowledgeBaseLastIndexingJobArgs>>> lastIndexingJobs() {
    ...
    private GetGradientaiKnowledgeBaseArgs() {}

    private GetGradientaiKnowledgeBaseArgs(GetGradientaiKnowledgeBaseArgs $) {
    ...
    public static Builder builder(GetGradientaiKnowledgeBaseArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetGradientaiKnowledgeBaseArgs();
        }

        public Builder(GetGradientaiKnowledgeBaseArgs defaults) {
            $ = new GetGradientaiKnowledgeBaseArgs(Objects.requireNonNull(defaults));
        }
        ...
        public Builder lastIndexingJobs(@Nullable Output<List<GetGradientaiKnowledgeBaseLastIndexingJobArgs>> lastIndexingJobs) {
            $.lastIndexingJobs = lastIndexingJobs;
            return this;
        }

        public Builder lastIndexingJobs(List<GetGradientaiKnowledgeBaseLastIndexingJobArgs> lastIndexingJobs) {
            return lastIndexingJobs(Output.of(lastIndexingJobs));
        }

        public Builder lastIndexingJobs(GetGradientaiKnowledgeBaseLastIndexingJobArgs... lastIndexingJobs) {
        ...
        public GetGradientaiKnowledgeBaseArgs build() {
            return $;
        }
    }
