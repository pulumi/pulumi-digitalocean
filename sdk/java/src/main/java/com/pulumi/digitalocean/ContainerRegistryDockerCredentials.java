...
public class ContainerRegistryDockerCredentials extends com.pulumi.resources.CustomResource {
     ...
     */
    public ContainerRegistryDockerCredentials(java.lang.String name) {
     ...
     */
    public ContainerRegistryDockerCredentials(java.lang.String name, ContainerRegistryDockerCredentialsArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public ContainerRegistryDockerCredentials(java.lang.String name, ContainerRegistryDockerCredentialsArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("digitalocean:index/containerRegistryDockerCredentials:ContainerRegistryDockerCredentials", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private ContainerRegistryDockerCredentials(java.lang.String name, Output<java.lang.String> id, @Nullable ContainerRegistryDockerCredentialsState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("digitalocean:index/containerRegistryDockerCredentials:ContainerRegistryDockerCredentials", name, state, makeResourceOptions(options, id), false);
    }
     ...
     */
    public static ContainerRegistryDockerCredentials get(java.lang.String name, Output<java.lang.String> id, @Nullable ContainerRegistryDockerCredentialsState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
