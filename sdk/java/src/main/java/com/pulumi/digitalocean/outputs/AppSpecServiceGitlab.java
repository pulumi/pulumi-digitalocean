...
@CustomType
public final class AppSpecServiceGitlab {
    /**
    ...
    public static Builder builder(AppSpecServiceGitlab defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(AppSpecServiceGitlab defaults) {
        ...
        public Builder repo(@Nullable String repo) {
            this.repo = repo;
            return this;
        }        public AppSpecServiceGitlab build() {
            return new AppSpecServiceGitlab(branch, deployOnPush, repo);
        }
    }
}
