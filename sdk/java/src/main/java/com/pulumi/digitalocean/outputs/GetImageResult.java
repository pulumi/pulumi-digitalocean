...
public final class GetImageResult {
    ...
    public static final class Builder {
        ...
        public Builder type(String type) {
            ...
            return new GetImageResult(created, description, distribution, errorMessage, id, image, minDiskSize, name, private_, regions, sizeGigabytes, slug, source, status, tags, type);
        }
    }
}
