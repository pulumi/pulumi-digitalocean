...
@CustomType
public final class GetGenaiAgentsByOpenaiApiKeyAgentModelVersion {
    /**
    ...
    private GetGenaiAgentsByOpenaiApiKeyAgentModelVersion() {}
    /**
     * @return Major version of the model
     * 
     */
    ...
    public static Builder builder(GetGenaiAgentsByOpenaiApiKeyAgentModelVersion defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer patch;
        public Builder() {}
        public Builder(GetGenaiAgentsByOpenaiApiKeyAgentModelVersion defaults) {
        ...
        public GetGenaiAgentsByOpenaiApiKeyAgentModelVersion build() {
            final var _resultValue = new GetGenaiAgentsByOpenaiApiKeyAgentModelVersion();
