...
import com.pulumi.digitalocean.outputs.AppSpecJobAlertDestinations;
...
@CustomType
public final class AppSpecJobAlert {
    /**
     * @return Specification for alert destination.
     * 
     */
    private @Nullable AppSpecJobAlertDestinations destinations;
    /**
     ...
     * 
     */
    public Optional<AppSpecJobAlertDestinations> destinations() {
    ...
    public static Builder builder(AppSpecJobAlert defaults) {
    ...
    public static final class Builder {
        ...
        private String window;
        public Builder() {}
        public Builder(AppSpecJobAlert defaults) {
        ...
        @CustomType.Setter
        public Builder destinations(@Nullable AppSpecJobAlertDestinations destinations) {
        ...
        public Builder operator(String operator) {
            if (operator == null) {
              throw new MissingRequiredPropertyException("AppSpecJobAlert", "operator");
            }
        ...
        public Builder rule(String rule) {
            if (rule == null) {
              throw new MissingRequiredPropertyException("AppSpecJobAlert", "rule");
            }
            this.rule = rule;
            return this;
        }
        ...
        public Builder value(Double value) {
            if (value == null) {
              throw new MissingRequiredPropertyException("AppSpecJobAlert", "value");
            }
            this.value = value;
            return this;
        }
        ...
        public Builder window(String window) {
            if (window == null) {
              throw new MissingRequiredPropertyException("AppSpecJobAlert", "window");
            }
            this.window = window;
            return this;
        }
