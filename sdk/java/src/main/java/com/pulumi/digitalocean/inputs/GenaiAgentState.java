...
public final class GenaiAgentState extends com.pulumi.resources.ResourceArgs {

    public static final GenaiAgentState Empty = new GenaiAgentState();
    ...
    private GenaiAgentState() {}

    private GenaiAgentState(GenaiAgentState $) {
    ...
    public static Builder builder(GenaiAgentState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(GenaiAgentState defaults) {
            $ = new GenaiAgentState(Objects.requireNonNull(defaults));
        }
