...
import com.pulumi.digitalocean.inputs.GetGradientaiAgentTemplateModelAgreement;
import com.pulumi.digitalocean.inputs.GetGradientaiAgentTemplateModelVersion;
...
public final class GetGradientaiAgentTemplateModel extends com.pulumi.resources.InvokeArgs {

    public static final GetGradientaiAgentTemplateModel Empty = new GetGradientaiAgentTemplateModel();
    ...
    private @Nullable List<GetGradientaiAgentTemplateModelAgreement> agreements;

    /**
     * @return Agreement information for the model
     * 
     */
    public Optional<List<GetGradientaiAgentTemplateModelAgreement>> agreements() {
    ...
    private @Nullable List<GetGradientaiAgentTemplateModelVersion> versions;

    /**
     * @return URL of the Model
     * 
     */
    public Optional<List<GetGradientaiAgentTemplateModelVersion>> versions() {
        return Optional.ofNullable(this.versions);
    }

    private GetGradientaiAgentTemplateModel() {}

    private GetGradientaiAgentTemplateModel(GetGradientaiAgentTemplateModel $) {
    ...
    public static Builder builder(GetGradientaiAgentTemplateModel defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetGradientaiAgentTemplateModel();
        }

        public Builder(GetGradientaiAgentTemplateModel defaults) {
            $ = new GetGradientaiAgentTemplateModel(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder agreements(@Nullable List<GetGradientaiAgentTemplateModelAgreement> agreements) {
         ...
         * 
         */
        public Builder agreements(GetGradientaiAgentTemplateModelAgreement... agreements) {
         ...
         * 
         */
        public Builder versions(@Nullable List<GetGradientaiAgentTemplateModelVersion> versions) {
            $.versions = versions;
            return this;
        }
         ...
         * 
         */
        public Builder versions(GetGradientaiAgentTemplateModelVersion... versions) {
            return versions(List.of(versions));
        }

        public GetGradientaiAgentTemplateModel build() {
            if ($.createdAt == null) {
                throw new MissingRequiredPropertyException("GetGradientaiAgentTemplateModel", "createdAt");
            }
            if ($.updatedAt == null) {
                throw new MissingRequiredPropertyException("GetGradientaiAgentTemplateModel", "updatedAt");
            }
            return $;
        }
    }
