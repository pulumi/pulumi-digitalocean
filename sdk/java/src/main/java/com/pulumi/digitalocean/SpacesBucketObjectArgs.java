...
public final class SpacesBucketObjectArgs extends com.pulumi.resources.ResourceArgs {

    public static final SpacesBucketObjectArgs Empty = new SpacesBucketObjectArgs();
    ...
    private SpacesBucketObjectArgs() {}

    private SpacesBucketObjectArgs(SpacesBucketObjectArgs $) {
        this.acl = $.acl;
        this.bucket = $.bucket;
    ...
    public static Builder builder(SpacesBucketObjectArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new SpacesBucketObjectArgs();
        }

        public Builder(SpacesBucketObjectArgs defaults) {
            $ = new SpacesBucketObjectArgs(Objects.requireNonNull(defaults));
        }
        ...
        public SpacesBucketObjectArgs build() {
            if ($.bucket == null) {
                throw new MissingRequiredPropertyException("SpacesBucketObjectArgs", "bucket");
            }
            if ($.key == null) {
                throw new MissingRequiredPropertyException("SpacesBucketObjectArgs", "key");
            }
            if ($.region == null) {
                throw new MissingRequiredPropertyException("SpacesBucketObjectArgs", "region");
            }
            return $;
        }
    }
