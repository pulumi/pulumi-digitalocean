...
@CustomType
public final class GradientaiAgentTemplateModelVersion {
    /**
    ...
    private GradientaiAgentTemplateModelVersion() {}
    /**
     * @return Major version of the model
     * 
     */
    ...
    public static Builder builder(GradientaiAgentTemplateModelVersion defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer patch;
        public Builder() {}
        public Builder(GradientaiAgentTemplateModelVersion defaults) {
        ...
        public GradientaiAgentTemplateModelVersion build() {
            final var _resultValue = new GradientaiAgentTemplateModelVersion();
