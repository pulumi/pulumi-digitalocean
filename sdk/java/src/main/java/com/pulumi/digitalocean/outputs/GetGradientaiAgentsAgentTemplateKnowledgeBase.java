...
import com.pulumi.digitalocean.outputs.GetGradientaiAgentsAgentTemplateKnowledgeBaseLastIndexingJob;
...
@CustomType
public final class GetGradientaiAgentsAgentTemplateKnowledgeBase {
    /**
     ...
     * 
     */
    private @Nullable GetGradientaiAgentsAgentTemplateKnowledgeBaseLastIndexingJob lastIndexingJob;
    /**
    ...
    private GetGradientaiAgentsAgentTemplateKnowledgeBase() {}
    /**
     * @return Timestamp when the Knowledge Base was added to the Agent
     * 
     */
     ...
     * 
     */
    public Optional<GetGradientaiAgentsAgentTemplateKnowledgeBaseLastIndexingJob> lastIndexingJob() {
    ...
    public static Builder builder(GetGradientaiAgentsAgentTemplateKnowledgeBase defaults) {
    ...
    public static final class Builder {
        ...
        private String uuid;
        public Builder() {}
        public Builder(GetGradientaiAgentsAgentTemplateKnowledgeBase defaults) {
        ...
        public Builder addedToAgentAt(String addedToAgentAt) {
            if (addedToAgentAt == null) {
              throw new MissingRequiredPropertyException("GetGradientaiAgentsAgentTemplateKnowledgeBase", "addedToAgentAt");
            }
        ...
        public Builder createdAt(String createdAt) {
            if (createdAt == null) {
              throw new MissingRequiredPropertyException("GetGradientaiAgentsAgentTemplateKnowledgeBase", "createdAt");
            }
        ...
        @CustomType.Setter
        public Builder lastIndexingJob(@Nullable GetGradientaiAgentsAgentTemplateKnowledgeBaseLastIndexingJob lastIndexingJob) {
        ...
        public Builder updatedAt(String updatedAt) {
            if (updatedAt == null) {
              throw new MissingRequiredPropertyException("GetGradientaiAgentsAgentTemplateKnowledgeBase", "updatedAt");
            }
        ...
        public Builder uuid(String uuid) {
            if (uuid == null) {
              throw new MissingRequiredPropertyException("GetGradientaiAgentsAgentTemplateKnowledgeBase", "uuid");
            }
            this.uuid = uuid;
            return this;
        }
        public GetGradientaiAgentsAgentTemplateKnowledgeBase build() {
            final var _resultValue = new GetGradientaiAgentsAgentTemplateKnowledgeBase();
