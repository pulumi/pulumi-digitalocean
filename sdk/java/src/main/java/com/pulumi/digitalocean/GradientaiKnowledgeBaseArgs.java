...
public final class GradientaiKnowledgeBaseArgs extends com.pulumi.resources.ResourceArgs {

    public static final GradientaiKnowledgeBaseArgs Empty = new GradientaiKnowledgeBaseArgs();
    ...
    private @Nullable Output<List<GradientaiKnowledgeBaseLastIndexingJobArgs>> lastIndexingJobs;

    /**
     * @return The last indexing job for the knowledge base.
     * 
     */
    public Optional<Output<List<GradientaiKnowledgeBaseLastIndexingJobArgs>>> lastIndexingJobs() {
    ...
    private GradientaiKnowledgeBaseArgs() {}

    private GradientaiKnowledgeBaseArgs(GradientaiKnowledgeBaseArgs $) {
    ...
    public static Builder builder(GradientaiKnowledgeBaseArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GradientaiKnowledgeBaseArgs();
        }

        public Builder(GradientaiKnowledgeBaseArgs defaults) {
            $ = new GradientaiKnowledgeBaseArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder lastIndexingJobs(@Nullable Output<List<GradientaiKnowledgeBaseLastIndexingJobArgs>> lastIndexingJobs) {
         ...
         * 
         */
        public Builder lastIndexingJobs(List<GradientaiKnowledgeBaseLastIndexingJobArgs> lastIndexingJobs) {
         ...
         * 
         */
        public Builder lastIndexingJobs(GradientaiKnowledgeBaseLastIndexingJobArgs... lastIndexingJobs) {
        ...
        public GradientaiKnowledgeBaseArgs build() {
            if ($.datasources == null) {
                throw new MissingRequiredPropertyException("GradientaiKnowledgeBaseArgs", "datasources");
            }
            if ($.embeddingModelUuid == null) {
                throw new MissingRequiredPropertyException("GradientaiKnowledgeBaseArgs", "embeddingModelUuid");
            }
            if ($.projectId == null) {
                throw new MissingRequiredPropertyException("GradientaiKnowledgeBaseArgs", "projectId");
            }
            if ($.region == null) {
                throw new MissingRequiredPropertyException("GradientaiKnowledgeBaseArgs", "region");
            }
            return $;
        }
    }
