...
@CustomType
public final class GetGenaiAgentsAgentTemplateKnowledgeBaseLastIndexingJob {
    /**
    ...
    private GetGenaiAgentsAgentTemplateKnowledgeBaseLastIndexingJob() {}
    /**
     * @return Number of completed datasources in the last indexing job
     * 
     */
    ...
    public static Builder builder(GetGenaiAgentsAgentTemplateKnowledgeBaseLastIndexingJob defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String uuid;
        public Builder() {}
        public Builder(GetGenaiAgentsAgentTemplateKnowledgeBaseLastIndexingJob defaults) {
        ...
        public Builder createdAt(String createdAt) {
            if (createdAt == null) {
              throw new MissingRequiredPropertyException("GetGenaiAgentsAgentTemplateKnowledgeBaseLastIndexingJob", "createdAt");
            }
        ...
        public Builder finishedAt(String finishedAt) {
            if (finishedAt == null) {
              throw new MissingRequiredPropertyException("GetGenaiAgentsAgentTemplateKnowledgeBaseLastIndexingJob", "finishedAt");
            }
        ...
        public Builder knowledgeBaseUuid(String knowledgeBaseUuid) {
            if (knowledgeBaseUuid == null) {
              throw new MissingRequiredPropertyException("GetGenaiAgentsAgentTemplateKnowledgeBaseLastIndexingJob", "knowledgeBaseUuid");
            }
        ...
        public Builder startedAt(String startedAt) {
            if (startedAt == null) {
              throw new MissingRequiredPropertyException("GetGenaiAgentsAgentTemplateKnowledgeBaseLastIndexingJob", "startedAt");
            }
        ...
        public Builder updatedAt(String updatedAt) {
            if (updatedAt == null) {
              throw new MissingRequiredPropertyException("GetGenaiAgentsAgentTemplateKnowledgeBaseLastIndexingJob", "updatedAt");
            }
        ...
        public GetGenaiAgentsAgentTemplateKnowledgeBaseLastIndexingJob build() {
            final var _resultValue = new GetGenaiAgentsAgentTemplateKnowledgeBaseLastIndexingJob();
