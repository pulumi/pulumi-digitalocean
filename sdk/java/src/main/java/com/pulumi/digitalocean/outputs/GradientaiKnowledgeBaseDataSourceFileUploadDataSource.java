...
@CustomType
public final class GradientaiKnowledgeBaseDataSourceFileUploadDataSource {
    /**
    ...
    private GradientaiKnowledgeBaseDataSourceFileUploadDataSource() {}
    /**
     * @return The original name of the uploaded file
     * 
     */
    ...
    public static Builder builder(GradientaiKnowledgeBaseDataSourceFileUploadDataSource defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String storedObjectKey;
        public Builder() {}
        public Builder(GradientaiKnowledgeBaseDataSourceFileUploadDataSource defaults) {
        ...
        public GradientaiKnowledgeBaseDataSourceFileUploadDataSource build() {
            final var _resultValue = new GradientaiKnowledgeBaseDataSourceFileUploadDataSource();
