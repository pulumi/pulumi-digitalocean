...
@CustomType
public final class AppSpecServiceGit {
    /**
    ...
    public static Builder builder(AppSpecServiceGit defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(AppSpecServiceGit defaults) {
        ...
        public Builder repoCloneUrl(@Nullable String repoCloneUrl) {
            ...
            return new AppSpecServiceGit(branch, repoCloneUrl);
        }
    }
}
