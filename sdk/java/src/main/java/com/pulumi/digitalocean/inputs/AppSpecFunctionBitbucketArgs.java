...
public final class AppSpecFunctionBitbucketArgs extends com.pulumi.resources.ResourceArgs {

    public static final AppSpecFunctionBitbucketArgs Empty = new AppSpecFunctionBitbucketArgs();
    ...
    private AppSpecFunctionBitbucketArgs() {}

    private AppSpecFunctionBitbucketArgs(AppSpecFunctionBitbucketArgs $) {
        this.branch = $.branch;
    ...
    public static Builder builder(AppSpecFunctionBitbucketArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AppSpecFunctionBitbucketArgs();
        }

        public Builder(AppSpecFunctionBitbucketArgs defaults) {
            $ = new AppSpecFunctionBitbucketArgs(Objects.requireNonNull(defaults));
        }
        ...
        public AppSpecFunctionBitbucketArgs build() {
            return $;
        }
    }
