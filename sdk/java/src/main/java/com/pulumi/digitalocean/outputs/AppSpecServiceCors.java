...
import com.pulumi.digitalocean.outputs.AppSpecServiceCorsAllowOrigins;
...
@CustomType
public final class AppSpecServiceCors {
    /**
     ...
     * 
     */
    private final @Nullable AppSpecServiceCorsAllowOrigins allowOrigins;
    /**
    ...
    private AppSpecServiceCors(
        ...
        @CustomType.Parameter("allowOrigins") @Nullable AppSpecServiceCorsAllowOrigins allowOrigins,
     ...
     * 
     */
    public Optional<AppSpecServiceCorsAllowOrigins> allowOrigins() {
    ...
    public static Builder builder(AppSpecServiceCors defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable AppSpecServiceCorsAllowOrigins allowOrigins;
        ...
        public Builder(AppSpecServiceCors defaults) {
        ...
        public Builder allowOrigins(@Nullable AppSpecServiceCorsAllowOrigins allowOrigins) {
            this.allowOrigins = allowOrigins;
            return this;
        }
        ...
        public Builder maxAge(@Nullable String maxAge) {
            ...
            return new AppSpecServiceCors(allowCredentials, allowHeaders, allowMethods, allowOrigins, exposeHeaders, maxAge);
        }
    }
}
