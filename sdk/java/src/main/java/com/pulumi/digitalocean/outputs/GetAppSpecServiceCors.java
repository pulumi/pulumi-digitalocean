...
import com.pulumi.digitalocean.outputs.GetAppSpecServiceCorsAllowOrigins;
...
@CustomType
public final class GetAppSpecServiceCors {
    /**
     ...
     * 
     */
    private final @Nullable GetAppSpecServiceCorsAllowOrigins allowOrigins;
    /**
    ...
    private GetAppSpecServiceCors(
        ...
        @CustomType.Parameter("allowOrigins") @Nullable GetAppSpecServiceCorsAllowOrigins allowOrigins,
     ...
     * 
     */
    public Optional<GetAppSpecServiceCorsAllowOrigins> allowOrigins() {
    ...
    public static Builder builder(GetAppSpecServiceCors defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable GetAppSpecServiceCorsAllowOrigins allowOrigins;
        ...
        public Builder(GetAppSpecServiceCors defaults) {
        ...
        public Builder allowOrigins(@Nullable GetAppSpecServiceCorsAllowOrigins allowOrigins) {
            this.allowOrigins = allowOrigins;
            return this;
        }
        ...
        public Builder maxAge(@Nullable String maxAge) {
            this.maxAge = maxAge;
            return this;
        }        public GetAppSpecServiceCors build() {
            return new GetAppSpecServiceCors(allowCredentials, allowHeaders, allowMethods, allowOrigins, exposeHeaders, maxAge);
        }
    }
}
