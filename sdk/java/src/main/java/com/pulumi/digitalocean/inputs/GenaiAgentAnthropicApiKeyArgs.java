...
public final class GenaiAgentAnthropicApiKeyArgs extends com.pulumi.resources.ResourceArgs {

    public static final GenaiAgentAnthropicApiKeyArgs Empty = new GenaiAgentAnthropicApiKeyArgs();
    ...
    private GenaiAgentAnthropicApiKeyArgs() {}

    private GenaiAgentAnthropicApiKeyArgs(GenaiAgentAnthropicApiKeyArgs $) {
    ...
    public static Builder builder(GenaiAgentAnthropicApiKeyArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GenaiAgentAnthropicApiKeyArgs();
        }

        public Builder(GenaiAgentAnthropicApiKeyArgs defaults) {
            $ = new GenaiAgentAnthropicApiKeyArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GenaiAgentAnthropicApiKeyArgs build() {
            return $;
        }
    }
