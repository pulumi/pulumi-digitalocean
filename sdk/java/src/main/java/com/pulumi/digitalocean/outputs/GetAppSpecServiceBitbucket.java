...
@CustomType
public final class GetAppSpecServiceBitbucket {
    /**
    ...
    private GetAppSpecServiceBitbucket() {}
    /**
     * @return The name of the branch to use.
     * 
     */
    ...
    public static Builder builder(GetAppSpecServiceBitbucket defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String repo;
        public Builder() {}
        public Builder(GetAppSpecServiceBitbucket defaults) {
        ...
        public GetAppSpecServiceBitbucket build() {
            final var _resultValue = new GetAppSpecServiceBitbucket();
