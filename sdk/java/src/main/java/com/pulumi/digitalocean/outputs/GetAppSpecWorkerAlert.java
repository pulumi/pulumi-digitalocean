...
import com.pulumi.digitalocean.outputs.GetAppSpecWorkerAlertDestinations;
...
public final class GetAppSpecWorkerAlert {
    private @Nullable GetAppSpecWorkerAlertDestinations destinations;
    /**
    ...
    public Optional<GetAppSpecWorkerAlertDestinations> destinations() {
    ...
    public static final class Builder {
        ...
        @CustomType.Setter
        public Builder destinations(@Nullable GetAppSpecWorkerAlertDestinations destinations) {
        ...
        public Builder operator(String operator) {
            if (operator == null) {
              throw new MissingRequiredPropertyException("GetAppSpecWorkerAlert", "operator");
            }
        ...
        public Builder rule(String rule) {
            if (rule == null) {
              throw new MissingRequiredPropertyException("GetAppSpecWorkerAlert", "rule");
            }
            this.rule = rule;
            return this;
        }
        ...
        public Builder value(Double value) {
            if (value == null) {
              throw new MissingRequiredPropertyException("GetAppSpecWorkerAlert", "value");
            }
            this.value = value;
            return this;
        }
        ...
        public Builder window(String window) {
            if (window == null) {
              throw new MissingRequiredPropertyException("GetAppSpecWorkerAlert", "window");
            }
            this.window = window;
            return this;
        }
