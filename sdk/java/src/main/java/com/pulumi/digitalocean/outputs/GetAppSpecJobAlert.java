...
import com.pulumi.digitalocean.outputs.GetAppSpecJobAlertDestinations;
...
@CustomType
public final class GetAppSpecJobAlert {
    private @Nullable GetAppSpecJobAlertDestinations destinations;
    /**
    ...
    private GetAppSpecJobAlert() {}
    public Optional<GetAppSpecJobAlertDestinations> destinations() {
    ...
    public static Builder builder(GetAppSpecJobAlert defaults) {
    ...
    public static final class Builder {
        ...
        private String window;
        public Builder() {}
        public Builder(GetAppSpecJobAlert defaults) {
        ...
        @CustomType.Setter
        public Builder destinations(@Nullable GetAppSpecJobAlertDestinations destinations) {
        ...
        public GetAppSpecJobAlert build() {
            final var _resultValue = new GetAppSpecJobAlert();
