...
public final class GetGradientaiKnowledgeBaseLastIndexingJobArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetGradientaiKnowledgeBaseLastIndexingJobArgs Empty = new GetGradientaiKnowledgeBaseLastIndexingJobArgs();
    ...
    private GetGradientaiKnowledgeBaseLastIndexingJobArgs() {}

    private GetGradientaiKnowledgeBaseLastIndexingJobArgs(GetGradientaiKnowledgeBaseLastIndexingJobArgs $) {
    ...
    public static Builder builder(GetGradientaiKnowledgeBaseLastIndexingJobArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetGradientaiKnowledgeBaseLastIndexingJobArgs();
        }

        public Builder(GetGradientaiKnowledgeBaseLastIndexingJobArgs defaults) {
            $ = new GetGradientaiKnowledgeBaseLastIndexingJobArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetGradientaiKnowledgeBaseLastIndexingJobArgs build() {
            if ($.createdAt == null) {
                throw new MissingRequiredPropertyException("GetGradientaiKnowledgeBaseLastIndexingJobArgs", "createdAt");
            }
            if ($.finishedAt == null) {
                throw new MissingRequiredPropertyException("GetGradientaiKnowledgeBaseLastIndexingJobArgs", "finishedAt");
            }
            if ($.knowledgeBaseUuid == null) {
                throw new MissingRequiredPropertyException("GetGradientaiKnowledgeBaseLastIndexingJobArgs", "knowledgeBaseUuid");
            }
            if ($.startedAt == null) {
                throw new MissingRequiredPropertyException("GetGradientaiKnowledgeBaseLastIndexingJobArgs", "startedAt");
            }
            if ($.updatedAt == null) {
                throw new MissingRequiredPropertyException("GetGradientaiKnowledgeBaseLastIndexingJobArgs", "updatedAt");
            }
            return $;
        }
    }
