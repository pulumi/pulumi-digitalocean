...
public final class GetGenaiKnowledgeBaseLastIndexingJobArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetGenaiKnowledgeBaseLastIndexingJobArgs Empty = new GetGenaiKnowledgeBaseLastIndexingJobArgs();
    ...
    private GetGenaiKnowledgeBaseLastIndexingJobArgs() {}

    private GetGenaiKnowledgeBaseLastIndexingJobArgs(GetGenaiKnowledgeBaseLastIndexingJobArgs $) {
    ...
    public static Builder builder(GetGenaiKnowledgeBaseLastIndexingJobArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetGenaiKnowledgeBaseLastIndexingJobArgs();
        }

        public Builder(GetGenaiKnowledgeBaseLastIndexingJobArgs defaults) {
            $ = new GetGenaiKnowledgeBaseLastIndexingJobArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetGenaiKnowledgeBaseLastIndexingJobArgs build() {
            if ($.createdAt == null) {
                throw new MissingRequiredPropertyException("GetGenaiKnowledgeBaseLastIndexingJobArgs", "createdAt");
            }
            if ($.finishedAt == null) {
                throw new MissingRequiredPropertyException("GetGenaiKnowledgeBaseLastIndexingJobArgs", "finishedAt");
            }
            if ($.knowledgeBaseUuid == null) {
                throw new MissingRequiredPropertyException("GetGenaiKnowledgeBaseLastIndexingJobArgs", "knowledgeBaseUuid");
            }
            if ($.startedAt == null) {
                throw new MissingRequiredPropertyException("GetGenaiKnowledgeBaseLastIndexingJobArgs", "startedAt");
            }
            if ($.updatedAt == null) {
                throw new MissingRequiredPropertyException("GetGenaiKnowledgeBaseLastIndexingJobArgs", "updatedAt");
            }
            return $;
        }
    }
