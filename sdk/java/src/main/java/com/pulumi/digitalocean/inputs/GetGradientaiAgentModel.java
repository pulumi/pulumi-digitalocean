...
import com.pulumi.digitalocean.inputs.GetGradientaiAgentModelAgreement;
import com.pulumi.digitalocean.inputs.GetGradientaiAgentModelVersion;
...
public final class GetGradientaiAgentModel extends com.pulumi.resources.InvokeArgs {

    public static final GetGradientaiAgentModel Empty = new GetGradientaiAgentModel();
    ...
    private @Nullable List<GetGradientaiAgentModelAgreement> agreements;

    /**
     * @return Agreement information for the model
     * 
     */
    public Optional<List<GetGradientaiAgentModelAgreement>> agreements() {
    ...
    private @Nullable List<GetGradientaiAgentModelVersion> versions;

    /**
     * @return URL of the Model
     * 
     */
    public Optional<List<GetGradientaiAgentModelVersion>> versions() {
        return Optional.ofNullable(this.versions);
    }

    private GetGradientaiAgentModel() {}

    private GetGradientaiAgentModel(GetGradientaiAgentModel $) {
    ...
    public static Builder builder(GetGradientaiAgentModel defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetGradientaiAgentModel();
        }

        public Builder(GetGradientaiAgentModel defaults) {
            $ = new GetGradientaiAgentModel(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder agreements(@Nullable List<GetGradientaiAgentModelAgreement> agreements) {
         ...
         * 
         */
        public Builder agreements(GetGradientaiAgentModelAgreement... agreements) {
         ...
         * 
         */
        public Builder versions(@Nullable List<GetGradientaiAgentModelVersion> versions) {
            $.versions = versions;
            return this;
        }
         ...
         * 
         */
        public Builder versions(GetGradientaiAgentModelVersion... versions) {
            return versions(List.of(versions));
        }

        public GetGradientaiAgentModel build() {
            if ($.createdAt == null) {
                throw new MissingRequiredPropertyException("GetGradientaiAgentModel", "createdAt");
            }
            if ($.updatedAt == null) {
                throw new MissingRequiredPropertyException("GetGradientaiAgentModel", "updatedAt");
            }
            return $;
        }
    }
