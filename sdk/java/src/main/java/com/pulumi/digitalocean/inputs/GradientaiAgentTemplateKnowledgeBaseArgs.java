...
import com.pulumi.digitalocean.inputs.GradientaiAgentTemplateKnowledgeBaseLastIndexingJobArgs;
...
public final class GradientaiAgentTemplateKnowledgeBaseArgs extends com.pulumi.resources.ResourceArgs {

    public static final GradientaiAgentTemplateKnowledgeBaseArgs Empty = new GradientaiAgentTemplateKnowledgeBaseArgs();
    ...
    private @Nullable Output<GradientaiAgentTemplateKnowledgeBaseLastIndexingJobArgs> lastIndexingJob;

    /**
     * @return Last indexing job for the Knowledge Base
     * 
     */
    public Optional<Output<GradientaiAgentTemplateKnowledgeBaseLastIndexingJobArgs>> lastIndexingJob() {
    ...
    private GradientaiAgentTemplateKnowledgeBaseArgs() {}

    private GradientaiAgentTemplateKnowledgeBaseArgs(GradientaiAgentTemplateKnowledgeBaseArgs $) {
    ...
    public static Builder builder(GradientaiAgentTemplateKnowledgeBaseArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GradientaiAgentTemplateKnowledgeBaseArgs();
        }

        public Builder(GradientaiAgentTemplateKnowledgeBaseArgs defaults) {
            $ = new GradientaiAgentTemplateKnowledgeBaseArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder lastIndexingJob(@Nullable Output<GradientaiAgentTemplateKnowledgeBaseLastIndexingJobArgs> lastIndexingJob) {
         ...
         * 
         */
        public Builder lastIndexingJob(GradientaiAgentTemplateKnowledgeBaseLastIndexingJobArgs lastIndexingJob) {
        ...
        public GradientaiAgentTemplateKnowledgeBaseArgs build() {
            return $;
        }
    }
