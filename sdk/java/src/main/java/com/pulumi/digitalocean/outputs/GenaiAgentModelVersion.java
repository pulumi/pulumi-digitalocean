...
@CustomType
public final class GenaiAgentModelVersion {
    /**
    ...
    private GenaiAgentModelVersion() {}
    /**
     * @return Major version of the model
     * 
     */
    ...
    public static Builder builder(GenaiAgentModelVersion defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer patch;
        public Builder() {}
        public Builder(GenaiAgentModelVersion defaults) {
        ...
        public GenaiAgentModelVersion build() {
            final var _resultValue = new GenaiAgentModelVersion();
