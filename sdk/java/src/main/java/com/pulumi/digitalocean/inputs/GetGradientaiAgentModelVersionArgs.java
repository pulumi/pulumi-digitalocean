...
public final class GetGradientaiAgentModelVersionArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetGradientaiAgentModelVersionArgs Empty = new GetGradientaiAgentModelVersionArgs();
    ...
    private GetGradientaiAgentModelVersionArgs() {}

    private GetGradientaiAgentModelVersionArgs(GetGradientaiAgentModelVersionArgs $) {
        this.major = $.major;
        this.minor = $.minor;
        this.patch = $.patch;
    }
    ...
    public static Builder builder(GetGradientaiAgentModelVersionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetGradientaiAgentModelVersionArgs();
        }

        public Builder(GetGradientaiAgentModelVersionArgs defaults) {
            $ = new GetGradientaiAgentModelVersionArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetGradientaiAgentModelVersionArgs build() {
            return $;
        }
    }
