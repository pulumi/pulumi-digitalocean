...
import com.pulumi.digitalocean.outputs.GetAppSpecIngressRuleCorsAllowOrigins;
...
@CustomType
public final class GetAppSpecIngressRuleCors {
    /**
     ...
     * 
     */
    private @Nullable GetAppSpecIngressRuleCorsAllowOrigins allowOrigins;
    /**
    ...
    private GetAppSpecIngressRuleCors() {}
    /**
     * @return Whether browsers should expose the response to the client-side JavaScript code when the request&#39;s credentials mode is `include`. This configures the `Access-Control-Allow-Credentials` header.
     * 
     */
     ...
     * 
     */
    public Optional<GetAppSpecIngressRuleCorsAllowOrigins> allowOrigins() {
    ...
    public static Builder builder(GetAppSpecIngressRuleCors defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String maxAge;
        public Builder() {}
        public Builder(GetAppSpecIngressRuleCors defaults) {
        ...
        @CustomType.Setter
        public Builder allowOrigins(@Nullable GetAppSpecIngressRuleCorsAllowOrigins allowOrigins) {
