...
@CustomType
public final class AppSpecJobGitlab {
    /**
    ...
    public static Builder builder(AppSpecJobGitlab defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(AppSpecJobGitlab defaults) {
        ...
        public Builder repo(@Nullable String repo) {
            this.repo = repo;
            return this;
        }        public AppSpecJobGitlab build() {
            return new AppSpecJobGitlab(branch, deployOnPush, repo);
        }
    }
}
