...
@CustomType
public final class GetGenaiOpenaiApiKeysOpenaiApiKeyModelVersion {
    /**
    ...
    private GetGenaiOpenaiApiKeysOpenaiApiKeyModelVersion() {}
    /**
     * @return Major version of the model
     * 
     */
    ...
    public static Builder builder(GetGenaiOpenaiApiKeysOpenaiApiKeyModelVersion defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer patch;
        public Builder() {}
        public Builder(GetGenaiOpenaiApiKeysOpenaiApiKeyModelVersion defaults) {
        ...
        public GetGenaiOpenaiApiKeysOpenaiApiKeyModelVersion build() {
            final var _resultValue = new GetGenaiOpenaiApiKeysOpenaiApiKeyModelVersion();
