...
@CustomType
public final class GetAppSpecServiceGitlab {
    /**
    ...
    private GetAppSpecServiceGitlab(
    ...
    public static Builder builder(GetAppSpecServiceGitlab defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(GetAppSpecServiceGitlab defaults) {
        ...
        public Builder repo(@Nullable String repo) {
            this.repo = repo;
            return this;
        }        public GetAppSpecServiceGitlab build() {
            return new GetAppSpecServiceGitlab(branch, deployOnPush, repo);
        }
    }
}
