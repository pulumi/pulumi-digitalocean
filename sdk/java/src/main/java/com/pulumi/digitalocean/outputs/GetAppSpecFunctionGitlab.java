...
@CustomType
public final class GetAppSpecFunctionGitlab {
    /**
    ...
    private GetAppSpecFunctionGitlab(
    ...
    public static Builder builder(GetAppSpecFunctionGitlab defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(GetAppSpecFunctionGitlab defaults) {
        ...
        public Builder repo(@Nullable String repo) {
            this.repo = repo;
            return this;
        }        public GetAppSpecFunctionGitlab build() {
            return new GetAppSpecFunctionGitlab(branch, deployOnPush, repo);
        }
    }
}
