...
public final class AppSpecServiceCorsAllowOriginsArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private AppSpecServiceCorsAllowOriginsArgs() {}

    private AppSpecServiceCorsAllowOriginsArgs(AppSpecServiceCorsAllowOriginsArgs $) {
        this.exact = $.exact;
        this.prefix = $.prefix;
        this.regex = $.regex;
    }
    ...
    public static Builder builder(AppSpecServiceCorsAllowOriginsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AppSpecServiceCorsAllowOriginsArgs();
        }

        public Builder(AppSpecServiceCorsAllowOriginsArgs defaults) {
            $ = new AppSpecServiceCorsAllowOriginsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public AppSpecServiceCorsAllowOriginsArgs build() {
            return $;
        }
    }
