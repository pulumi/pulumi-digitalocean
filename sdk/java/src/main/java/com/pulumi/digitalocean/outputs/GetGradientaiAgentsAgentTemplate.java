...
import com.pulumi.digitalocean.outputs.GetGradientaiAgentsAgentTemplateKnowledgeBase;
import com.pulumi.digitalocean.outputs.GetGradientaiAgentsAgentTemplateModel;
...
@CustomType
public final class GetGradientaiAgentsAgentTemplate {
    /**
     ...
     * 
     */
    private @Nullable List<GetGradientaiAgentsAgentTemplateKnowledgeBase> knowledgeBases;
    /**
     ...
     * 
     */
    private @Nullable List<GetGradientaiAgentsAgentTemplateModel> models;
    /**
    ...
    private GetGradientaiAgentsAgentTemplate() {}
    /**
     * @return Created At timestamp for the Knowledge Base
     * 
     */
     ...
     * 
     */
    public List<GetGradientaiAgentsAgentTemplateKnowledgeBase> knowledgeBases() {
     ...
     * 
     */
    public List<GetGradientaiAgentsAgentTemplateModel> models() {
    ...
    public static Builder builder(GetGradientaiAgentsAgentTemplate defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String uuid;
        public Builder() {}
        public Builder(GetGradientaiAgentsAgentTemplate defaults) {
        ...
        public Builder createdAt(String createdAt) {
            if (createdAt == null) {
              throw new MissingRequiredPropertyException("GetGradientaiAgentsAgentTemplate", "createdAt");
            }
        ...
        @CustomType.Setter
        public Builder knowledgeBases(@Nullable List<GetGradientaiAgentsAgentTemplateKnowledgeBase> knowledgeBases) {

            this.knowledgeBases = knowledgeBases;
            return this;
        }
        public Builder knowledgeBases(GetGradientaiAgentsAgentTemplateKnowledgeBase... knowledgeBases) {
        ...
        @CustomType.Setter
        public Builder models(@Nullable List<GetGradientaiAgentsAgentTemplateModel> models) {

            this.models = models;
            return this;
        }
        public Builder models(GetGradientaiAgentsAgentTemplateModel... models) {
        ...
        public Builder updatedAt(String updatedAt) {
            if (updatedAt == null) {
              throw new MissingRequiredPropertyException("GetGradientaiAgentsAgentTemplate", "updatedAt");
            }
        ...
        public GetGradientaiAgentsAgentTemplate build() {
            final var _resultValue = new GetGradientaiAgentsAgentTemplate();
