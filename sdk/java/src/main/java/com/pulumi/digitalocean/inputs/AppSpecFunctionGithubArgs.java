...
public final class AppSpecFunctionGithubArgs extends com.pulumi.resources.ResourceArgs {

    public static final AppSpecFunctionGithubArgs Empty = new AppSpecFunctionGithubArgs();
    ...
    private AppSpecFunctionGithubArgs() {}

    private AppSpecFunctionGithubArgs(AppSpecFunctionGithubArgs $) {
        this.branch = $.branch;
    ...
    public static Builder builder(AppSpecFunctionGithubArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AppSpecFunctionGithubArgs();
        }

        public Builder(AppSpecFunctionGithubArgs defaults) {
            $ = new AppSpecFunctionGithubArgs(Objects.requireNonNull(defaults));
        }
        ...
        public AppSpecFunctionGithubArgs build() {
            return $;
        }
    }
