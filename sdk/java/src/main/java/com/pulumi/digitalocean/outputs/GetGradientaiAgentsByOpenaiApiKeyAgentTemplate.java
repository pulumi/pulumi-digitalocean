...
import com.pulumi.digitalocean.outputs.GetGradientaiAgentsByOpenaiApiKeyAgentTemplateKnowledgeBase;
import com.pulumi.digitalocean.outputs.GetGradientaiAgentsByOpenaiApiKeyAgentTemplateModel;
...
@CustomType
public final class GetGradientaiAgentsByOpenaiApiKeyAgentTemplate {
    /**
     ...
     * 
     */
    private @Nullable List<GetGradientaiAgentsByOpenaiApiKeyAgentTemplateKnowledgeBase> knowledgeBases;
    /**
     ...
     * 
     */
    private @Nullable List<GetGradientaiAgentsByOpenaiApiKeyAgentTemplateModel> models;
    /**
    ...
    private GetGradientaiAgentsByOpenaiApiKeyAgentTemplate() {}
    /**
     * @return Created At timestamp for the Knowledge Base
     * 
     */
     ...
     * 
     */
    public List<GetGradientaiAgentsByOpenaiApiKeyAgentTemplateKnowledgeBase> knowledgeBases() {
     ...
     * 
     */
    public List<GetGradientaiAgentsByOpenaiApiKeyAgentTemplateModel> models() {
    ...
    public static Builder builder(GetGradientaiAgentsByOpenaiApiKeyAgentTemplate defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String uuid;
        public Builder() {}
        public Builder(GetGradientaiAgentsByOpenaiApiKeyAgentTemplate defaults) {
        ...
        public Builder createdAt(String createdAt) {
            if (createdAt == null) {
              throw new MissingRequiredPropertyException("GetGradientaiAgentsByOpenaiApiKeyAgentTemplate", "createdAt");
            }
        ...
        @CustomType.Setter
        public Builder knowledgeBases(@Nullable List<GetGradientaiAgentsByOpenaiApiKeyAgentTemplateKnowledgeBase> knowledgeBases) {

            this.knowledgeBases = knowledgeBases;
            return this;
        }
        public Builder knowledgeBases(GetGradientaiAgentsByOpenaiApiKeyAgentTemplateKnowledgeBase... knowledgeBases) {
        ...
        @CustomType.Setter
        public Builder models(@Nullable List<GetGradientaiAgentsByOpenaiApiKeyAgentTemplateModel> models) {

            this.models = models;
            return this;
        }
        public Builder models(GetGradientaiAgentsByOpenaiApiKeyAgentTemplateModel... models) {
        ...
        public Builder updatedAt(String updatedAt) {
            if (updatedAt == null) {
              throw new MissingRequiredPropertyException("GetGradientaiAgentsByOpenaiApiKeyAgentTemplate", "updatedAt");
            }
        ...
        public GetGradientaiAgentsByOpenaiApiKeyAgentTemplate build() {
            final var _resultValue = new GetGradientaiAgentsByOpenaiApiKeyAgentTemplate();
