...
@CustomType
public final class AppSpecStaticSiteGitlab {
    /**
    ...
    private AppSpecStaticSiteGitlab(
    ...
    public static Builder builder(AppSpecStaticSiteGitlab defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(AppSpecStaticSiteGitlab defaults) {
        ...
        public Builder repo(@Nullable String repo) {
            this.repo = repo;
            return this;
        }        public AppSpecStaticSiteGitlab build() {
            return new AppSpecStaticSiteGitlab(branch, deployOnPush, repo);
        }
    }
}
