...
namespace Pulumi.DigitalOcean
{
    ...
    public partial class GradientaiKnowledgeBase : global::Pulumi.CustomResource
    {
        ...
        public Output<ImmutableArray<Outputs.GradientaiKnowledgeBaseLastIndexingJob>> LastIndexingJobs { get; private set; } = null!;
        ...
        public GradientaiKnowledgeBase(string name, GradientaiKnowledgeBaseArgs args, CustomResourceOptions? options = null)
            : base("digitalocean:index/gradientaiKnowledgeBase:GradientaiKnowledgeBase", name, args ?? new GradientaiKnowledgeBaseArgs(), MakeResourceOptions(options, ""))
        {
        }

        private GradientaiKnowledgeBase(string name, Input<string> id, GradientaiKnowledgeBaseState? state = null, CustomResourceOptions? options = null)
            : base("digitalocean:index/gradientaiKnowledgeBase:GradientaiKnowledgeBase", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static GradientaiKnowledgeBase Get(string name, Input<string> id, GradientaiKnowledgeBaseState? state = null, CustomResourceOptions? options = null)
        {
            return new GradientaiKnowledgeBase(name, id, state, options);
        }
    }

    public sealed class GradientaiKnowledgeBaseArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// The time when the knowledge base was added to the agent.
        /// </summary>
        ...
        private InputList<Inputs.GradientaiKnowledgeBaseLastIndexingJobArgs>? _lastIndexingJobs;

        /// <summary>
        /// The last indexing job for the knowledge base.
        /// </summary>
        public InputList<Inputs.GradientaiKnowledgeBaseLastIndexingJobArgs> LastIndexingJobs
        {
            get => _lastIndexingJobs ?? (_lastIndexingJobs = new InputList<Inputs.GradientaiKnowledgeBaseLastIndexingJobArgs>());
        ...
        public GradientaiKnowledgeBaseArgs()
        {
        }
        public static new GradientaiKnowledgeBaseArgs Empty => new GradientaiKnowledgeBaseArgs();
    }

    public sealed class GradientaiKnowledgeBaseState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// The time when the knowledge base was added to the agent.
        /// </summary>
        ...
        [Input("lastIndexingJobs")]
        private InputList<Inputs.GradientaiKnowledgeBaseLastIndexingJobGetArgs>? _lastIndexingJobs;

        /// <summary>
        /// The last indexing job for the knowledge base.
        /// </summary>
        public InputList<Inputs.GradientaiKnowledgeBaseLastIndexingJobGetArgs> LastIndexingJobs
        {
            get => _lastIndexingJobs ?? (_lastIndexingJobs = new InputList<Inputs.GradientaiKnowledgeBaseLastIndexingJobGetArgs>());
            set => _lastIndexingJobs = value;
        }
        ...
        public GradientaiKnowledgeBaseState()
        {
        }
        public static new GradientaiKnowledgeBaseState Empty => new GradientaiKnowledgeBaseState();
    }
}
