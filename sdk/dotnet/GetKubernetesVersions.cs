...
namespace Pulumi.DigitalOcean
{
    public static partial class Invokes
    {
        ...
        public static Task<GetKubernetesVersionsResult> GetKubernetesVersions(GetKubernetesVersionsArgs? args = null, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetKubernetesVersionsResult>("digitalocean:index/getKubernetesVersions:getKubernetesVersions", args ?? ResourceArgs.Empty, options.WithVersion());
    }

    public sealed class GetKubernetesVersionsArgs : Pulumi.ResourceArgs
    {
        [Input("versionPrefix")]
