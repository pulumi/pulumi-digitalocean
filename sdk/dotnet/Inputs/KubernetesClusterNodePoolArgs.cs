...
namespace Pulumi.DigitalOcean.Inputs
{
    ...
    public sealed class KubernetesClusterNodePoolArgs : global::Pulumi.ResourceArgs
    {
        ...
        [Input("nodes")]
        private InputList<Inputs.KubernetesClusterNodePoolNodeArgs>? _nodes;

        /// <summary>
        /// A list of nodes in the pool. Each node exports the following attributes:
        /// </summary>
        public InputList<Inputs.KubernetesClusterNodePoolNodeArgs> Nodes
        {
            get => _nodes ?? (_nodes = new InputList<Inputs.KubernetesClusterNodePoolNodeArgs>());
            set => _nodes = value;
        }
