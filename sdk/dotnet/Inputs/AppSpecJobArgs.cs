...
namespace Pulumi.DigitalOcean.Inputs
{
    ...
    public sealed class AppSpecJobArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        public InputList<Inputs.AppSpecJobAlertArgs> Alerts
        {
            get => _alerts ?? (_alerts = new InputList<Inputs.AppSpecJobAlertArgs>());
            set => _alerts = value;
        }
        ...
        /// </summary>
        [Input("bitbucket")]
        public Input<Inputs.AppSpecJobBitbucketArgs>? Bitbucket { get; set; }
        ...
        [Input("envs")]
        private InputList<Inputs.AppSpecJobEnvArgs>? _envs;

        /// <summary>
        /// Describes an environment variable made available to an app competent.
        /// </summary>
        public InputList<Inputs.AppSpecJobEnvArgs> Envs
        {
            get => _envs ?? (_envs = new InputList<Inputs.AppSpecJobEnvArgs>());
            set => _envs = value;
        }
        ...
        /// </summary>
        [Input("git")]
        public Input<Inputs.AppSpecJobGitArgs>? Git { get; set; }

        /// <summary>
        /// A GitHub repo to use as the component's source. DigitalOcean App Platform must have [access to the repository](https://cloud.digitalocean.com/apps/github/install). Only one of `git`, `github`, `gitlab`, or `image` may be set.
        /// </summary>
        [Input("github")]
        public Input<Inputs.AppSpecJobGithubArgs>? Github { get; set; }

        /// <summary>
        /// A Gitlab repo to use as the component's source. DigitalOcean App Platform must have [access to the repository](https://cloud.digitalocean.com/apps/gitlab/install). Only one of `git`, `github`, `gitlab`, or `image` may be set.
        /// </summary>
        [Input("gitlab")]
        public Input<Inputs.AppSpecJobGitlabArgs>? Gitlab { get; set; }

        /// <summary>
        /// An image to use as the component's source. Only one of `git`, `github`, `gitlab`, or `image` may be set.
        /// </summary>
        [Input("image")]
        public Input<Inputs.AppSpecJobImageArgs>? Image { get; set; }
        ...
        private InputList<Inputs.AppSpecJobLogDestinationArgs>? _logDestinations;

        /// <summary>
        /// Describes a log forwarding destination.
        /// </summary>
        public InputList<Inputs.AppSpecJobLogDestinationArgs> LogDestinations
        {
            get => _logDestinations ?? (_logDestinations = new InputList<Inputs.AppSpecJobLogDestinationArgs>());
        ...
        /// </summary>
        [Input("termination")]
        public Input<Inputs.AppSpecJobTerminationArgs>? Termination { get; set; }
