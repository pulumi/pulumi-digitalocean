...
export class GenaiIndexingJobCancel extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'digitalocean:index/genaiIndexingJobCancel:GenaiIndexingJobCancel';

    /**
     * Returns true if the given object is an instance of GenaiIndexingJobCancel.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is GenaiIndexingJobCancel {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === GenaiIndexingJobCancel.__pulumiType;
    }
    ...
    constructor(name: string, argsOrState?: GenaiIndexingJobCancelArgs | GenaiIndexingJobCancelState, opts?: pulumi.CustomResourceOptions) {
        ...
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as GenaiIndexingJobCancelState | undefined;
            ...
            const args = argsOrState as GenaiIndexingJobCancelArgs | undefined;
        ...
        super(GenaiIndexingJobCancel.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface GenaiIndexingJobCancelState {
    /**
     * Number of data sources that were completed before cancellation.
     */
 ...
 */
export interface GenaiIndexingJobCancelArgs {
    /**
     * The UUID of the indexing job to cancel.
     */
    uuid: pulumi.Input<string>;
