 ...
 * ```
 */
export class DatabaseAdvancedPostgresqlConfig extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DatabaseAdvancedPostgresqlConfigState, opts?: pulumi.CustomResourceOptions): DatabaseAdvancedPostgresqlConfig {
        return new DatabaseAdvancedPostgresqlConfig(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'digitalocean:index/databaseAdvancedPostgresqlConfig:DatabaseAdvancedPostgresqlConfig';
     ...
     */
    public static isInstance(obj: any): obj is DatabaseAdvancedPostgresqlConfig {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === DatabaseAdvancedPostgresqlConfig.__pulumiType;
    }
     ...
     */
    declare public readonly pgParameters: pulumi.Output<{[key: string]: string} | undefined>;
    ...
    constructor(name: string, argsOrState?: DatabaseAdvancedPostgresqlConfigArgs | DatabaseAdvancedPostgresqlConfigState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as DatabaseAdvancedPostgresqlConfigState | undefined;
            resourceInputs["clusterId"] = state?.clusterId;
            resourceInputs["pgParameters"] = state?.pgParameters;
        } else {
            const args = argsOrState as DatabaseAdvancedPostgresqlConfigArgs | undefined;
            if (args?.clusterId === undefined && !opts.urn) {
                throw new Error("Missing required property 'clusterId'");
            }
            resourceInputs["clusterId"] = args?.clusterId;
            resourceInputs["pgParameters"] = args?.pgParameters;
        }
        opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts);
        super(DatabaseAdvancedPostgresqlConfig.__pulumiType, name, resourceInputs, opts);
    }
}
...
export interface DatabaseAdvancedPostgresqlConfigState {
     ...
     * A map of PostgreSQL GUC parameter names to their string values. Only parameters included in this map are managed by Terraform. Values use PostgreSQL GUC syntax (for example, `workMem` is specified in kilobytes unless a unit suffix is provided).
     */
    pgParameters?: pulumi.Input<{[key: string]: pulumi.Input<string>} | undefined>;
}
