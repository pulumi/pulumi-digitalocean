 ...
 * ```
 */
export class DatabaseAdvancedMysqlConfig extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DatabaseAdvancedMysqlConfigState, opts?: pulumi.CustomResourceOptions): DatabaseAdvancedMysqlConfig {
        return new DatabaseAdvancedMysqlConfig(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'digitalocean:index/databaseAdvancedMysqlConfig:DatabaseAdvancedMysqlConfig';
     ...
     */
    public static isInstance(obj: any): obj is DatabaseAdvancedMysqlConfig {
     ...
     */
    declare public readonly mysqlParameters: pulumi.Output<{[key: string]: string} | undefined>;
    ...
    constructor(name: string, argsOrState?: DatabaseAdvancedMysqlConfigArgs | DatabaseAdvancedMysqlConfigState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as DatabaseAdvancedMysqlConfigState | undefined;
            resourceInputs["clusterId"] = state?.clusterId;
            resourceInputs["mysqlParameters"] = state?.mysqlParameters;
        } else {
            const args = argsOrState as DatabaseAdvancedMysqlConfigArgs | undefined;
...
export interface DatabaseAdvancedMysqlConfigState {
     ...
     * A map of MySQL system variable names to their string values. Only parameters included in this map are managed by Terraform.
     */
    mysqlParameters?: pulumi.Input<{[key: string]: pulumi.Input<string>} | undefined>;
}
