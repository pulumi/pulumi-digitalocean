...
export class GradientaiKnowledgeBase extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'digitalocean:index/gradientaiKnowledgeBase:GradientaiKnowledgeBase';

    /**
     * Returns true if the given object is an instance of GradientaiKnowledgeBase.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is GradientaiKnowledgeBase {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === GradientaiKnowledgeBase.__pulumiType;
    }
     ...
     */
    declare public readonly lastIndexingJobs: pulumi.Output<outputs.GradientaiKnowledgeBaseLastIndexingJob[] | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: GradientaiKnowledgeBaseArgs | GradientaiKnowledgeBaseState, opts?: pulumi.CustomResourceOptions) {
        ...
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as GradientaiKnowledgeBaseState | undefined;
            ...
            const args = argsOrState as GradientaiKnowledgeBaseArgs | undefined;
