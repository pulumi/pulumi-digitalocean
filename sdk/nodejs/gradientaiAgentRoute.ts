...
export class GradientaiAgentRoute extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'digitalocean:index/gradientaiAgentRoute:GradientaiAgentRoute';

    /**
     * Returns true if the given object is an instance of GradientaiAgentRoute.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is GradientaiAgentRoute {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === GradientaiAgentRoute.__pulumiType;
    }
    ...
    constructor(name: string, argsOrState?: GradientaiAgentRouteArgs | GradientaiAgentRouteState, opts?: pulumi.CustomResourceOptions) {
        ...
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as GradientaiAgentRouteState | undefined;
            ...
            const args = argsOrState as GradientaiAgentRouteArgs | undefined;
 ...
 */
export interface GradientaiAgentRouteState {
    /**
     * The UUID of the child agent.
     */
 ...
 */
export interface GradientaiAgentRouteArgs {
    /**
     * The UUID of the child agent.
     */
    childAgentUuid: pulumi.Input<string>;
