...
__all__ = [
    ...
    'AwaitableGetGradientaiIndexingJobResult',
    'get_gradientai_indexing_job',
    'get_gradientai_indexing_job_output',
]
...
class AwaitableGetGradientaiIndexingJobResult(GetGradientaiIndexingJobResult):
...
def get_gradientai_indexing_job(uuid: Optional[_builtins.str] = None,
                                opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetGradientaiIndexingJobResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('digitalocean:index/getGradientaiIndexingJob:getGradientaiIndexingJob', __args__, opts=opts, typ=GetGradientaiIndexingJobResult).value

    return AwaitableGetGradientaiIndexingJobResult(
...
def get_gradientai_indexing_job_output(uuid: Optional[pulumi.Input[_builtins.str]] = None,
                                       opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetGradientaiIndexingJobResult]:
    """
    Use this data source to access information about an existing resource.
    """
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke_output('digitalocean:index/getGradientaiIndexingJob:getGradientaiIndexingJob', __args__, opts=opts, typ=GetGradientaiIndexingJobResult)
    return __ret__.apply(lambda __response__: GetGradientaiIndexingJobResult(
