...
__all__ = ['GradientaiKnowledgeBaseArgs', 'GradientaiKnowledgeBase']
...
class GradientaiKnowledgeBase(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: GradientaiKnowledgeBaseArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Create a GradientaiKnowledgeBase resource with the given unique name, props, and options.
        :param str resource_name: The name of the resource.
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(GradientaiKnowledgeBaseArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = GradientaiKnowledgeBaseArgs.__new__(GradientaiKnowledgeBaseArgs)
    ...
    def get(resource_name: str,
        ...
        __props__ = _GradientaiKnowledgeBaseState.__new__(_GradientaiKnowledgeBaseState)
        ...
        __props__.__dict__["tags"] = tags
        __props__.__dict__["vpc_uuid"] = vpc_uuid
        return GradientaiKnowledgeBase(resource_name, opts=opts, __props__=__props__)
    ...
    @_builtins.property
    @pulumi.getter(name="lastIndexingJobs")
    def last_indexing_jobs(self) -> pulumi.Output[Optional[Sequence['outputs.GradientaiKnowledgeBaseLastIndexingJob']]]:
        """
        The last indexing job for the knowledge base.
        """
        return pulumi.get(self, "last_indexing_jobs")
