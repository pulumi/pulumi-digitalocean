...
__all__ = ['DatabaseAdvancedMysqlConfigArgs', 'DatabaseAdvancedMysqlConfig']

@pulumi.input_type
class DatabaseAdvancedMysqlConfigArgs:
    def __init__(__self__, *,
                 cluster_id: pulumi.Input[_builtins.str],
                 mysql_parameters: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None):
        """
        The set of arguments for constructing a DatabaseAdvancedMysqlConfig resource.

        :param pulumi.Input[_builtins.str] cluster_id: The ID of the target MySQL Advanced Edition cluster.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] mysql_parameters: A map of MySQL system variable names to their string values. Only parameters included in this map are managed by Terraform.
        """
        pulumi.set(__self__, "cluster_id", cluster_id)
        if mysql_parameters is not None:
            pulumi.set(__self__, "mysql_parameters", mysql_parameters)
    ...
    def mysql_parameters(self) -> pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]]:
        """
        ...
        """
        return pulumi.get(self, "mysql_parameters")

    @mysql_parameters.setter
    def mysql_parameters(self, value: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]]):
        pulumi.set(self, "mysql_parameters", value)


@pulumi.input_type
class _DatabaseAdvancedMysqlConfigState:
    def __init__(__self__, *,
...
@pulumi.type_token("digitalocean:index/databaseAdvancedMysqlConfig:DatabaseAdvancedMysqlConfig")
class DatabaseAdvancedMysqlConfig(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: DatabaseAdvancedMysqlConfigArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Provides a virtual resource that can be used to change advanced configuration
        options for a DigitalOcean managed MySQL Advanced Edition (`advanced_mysql`)
        ...
        * `windowing_use_high_precision` - (Optional) High precision window functions. Default: `ON`.
        ...
        :param str resource_name: The name of the resource.
        :param DatabaseAdvancedMysqlConfigArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(DatabaseAdvancedMysqlConfigArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = DatabaseAdvancedMysqlConfigArgs.__new__(DatabaseAdvancedMysqlConfigArgs)

            if cluster_id is None and not opts.urn:
                raise TypeError("Missing required property 'cluster_id'")
            __props__.__dict__["cluster_id"] = cluster_id
            __props__.__dict__["mysql_parameters"] = mysql_parameters
        super(DatabaseAdvancedMysqlConfig, __self__).__init__(
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            cluster_id: pulumi.Input[Optional[_builtins.str]] = None,
            mysql_parameters: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None) -> 'DatabaseAdvancedMysqlConfig':
        """
        ...
        __props__ = _DatabaseAdvancedMysqlConfigState.__new__(_DatabaseAdvancedMysqlConfigState)

        __props__.__dict__["cluster_id"] = cluster_id
        __props__.__dict__["mysql_parameters"] = mysql_parameters
        return DatabaseAdvancedMysqlConfig(resource_name, opts=opts, __props__=__props__)
    ...
    @_builtins.property
    @pulumi.getter(name="mysqlParameters")
    def mysql_parameters(self) -> pulumi.Output[Optional[Mapping[str, _builtins.str]]]:
        """
        A map of MySQL system variable names to their string values. Only parameters included in this map are managed by Terraform.
        """
        return pulumi.get(self, "mysql_parameters")
