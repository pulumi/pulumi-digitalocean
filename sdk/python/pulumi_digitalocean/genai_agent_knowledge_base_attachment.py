...
class GenaiAgentKnowledgeBaseAttachmentArgs:
    def __init__(__self__, *,
                 agent_uuid: pulumi.Input[builtins.str],
                 knowledge_base_uuid: pulumi.Input[builtins.str]):
        """
        The set of arguments for constructing a GenaiAgentKnowledgeBaseAttachment resource.
        :param pulumi.Input[builtins.str] agent_uuid: A unique identifier for an agent.
        :param pulumi.Input[builtins.str] knowledge_base_uuid: A unique identifier for a knowledge base.
        """
    ...
    def agent_uuid(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @agent_uuid.setter
    def agent_uuid(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "agent_uuid", value)

    @property
    @pulumi.getter(name="knowledgeBaseUuid")
    def knowledge_base_uuid(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def knowledge_base_uuid(self, value: pulumi.Input[builtins.str]):
...
class GenaiAgentKnowledgeBaseAttachment(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            agent_uuid: Optional[pulumi.Input[builtins.str]] = None,
            knowledge_base_uuid: Optional[pulumi.Input[builtins.str]] = None) -> 'GenaiAgentKnowledgeBaseAttachment':
        """
    ...
    @property
    @pulumi.getter(name="agentUuid")
    def agent_uuid(self) -> pulumi.Output[builtins.str]:
        """
        A unique identifier for an agent.
        """
        return pulumi.get(self, "agent_uuid")
    ...
    @property
    @pulumi.getter(name="knowledgeBaseUuid")
    def knowledge_base_uuid(self) -> pulumi.Output[builtins.str]:
        """
        A unique identifier for a knowledge base.
        """
        return pulumi.get(self, "knowledge_base_uuid")
