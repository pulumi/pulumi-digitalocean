...
def get_genai_agents_by_openai_api_key(uuid: Optional[builtins.str] = None,
...
def get_genai_agents_by_openai_api_key_output(uuid: Optional[pulumi.Input[builtins.str]] = None,
