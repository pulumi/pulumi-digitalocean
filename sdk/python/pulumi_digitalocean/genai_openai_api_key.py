...
class GenaiOpenaiApiKeyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] api_key: The OpenAI API key.
        :param pulumi.Input[Sequence[pulumi.Input['GenaiOpenaiApiKeyModelArgs']]] models: Models associated with the OpenAI API key
        :param pulumi.Input[builtins.str] name: A name for the API key.
        """
...
class _GenaiOpenaiApiKeyState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] api_key: The OpenAI API key.
        :param pulumi.Input[builtins.str] created_at: When the API key was created.
        :param pulumi.Input[builtins.str] created_by: Who created the API key.
        :param pulumi.Input[builtins.str] deleted_at: When the API key was deleted.
        :param pulumi.Input[Sequence[pulumi.Input['GenaiOpenaiApiKeyModelArgs']]] models: Models associated with the OpenAI API key
        :param pulumi.Input[builtins.str] name: A name for the API key.
        :param pulumi.Input[builtins.str] updated_at: When the API key was last updated.
        :param pulumi.Input[builtins.str] uuid: The UUID of the API key.
        """
...
class GenaiOpenaiApiKey(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[builtins.str]] = None,
            updated_at: Optional[pulumi.Input[builtins.str]] = None,
            uuid: Optional[pulumi.Input[builtins.str]] = None) -> 'GenaiOpenaiApiKey':
        """
