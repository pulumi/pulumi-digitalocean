...
def get_genai_openai_api_keys(filters: Optional[Sequence[Union['GetGenaiOpenaiApiKeysFilterArgs', 'GetGenaiOpenaiApiKeysFilterArgsDict', 'outputs.GetGenaiOpenaiApiKeysFilterResult']]] = None,
                              sorts: Optional[Sequence[Union['GetGenaiOpenaiApiKeysSortArgs', 'GetGenaiOpenaiApiKeysSortArgsDict', 'outputs.GetGenaiOpenaiApiKeysSortResult']]] = None,
...
def get_genai_openai_api_keys_output(filters: pulumi.Input[Optional[Optional[Sequence[Union['GetGenaiOpenaiApiKeysFilterArgs', 'GetGenaiOpenaiApiKeysFilterArgsDict', 'outputs.GetGenaiOpenaiApiKeysFilterResult']]]]] = None,
                                     sorts: pulumi.Input[Optional[Optional[Sequence[Union['GetGenaiOpenaiApiKeysSortArgs', 'GetGenaiOpenaiApiKeysSortArgsDict', 'outputs.GetGenaiOpenaiApiKeysSortResult']]]]] = None,
