...
__all__ = [
    ...
    'AwaitableGetGradientaiKnowledgeBaseResult',
    'get_gradientai_knowledge_base',
...
class GetGradientaiKnowledgeBaseResult:
    ...
    def last_indexing_jobs(self) -> Optional[Sequence['outputs.GetGradientaiKnowledgeBaseLastIndexingJobResult']]:
...
class AwaitableGetGradientaiKnowledgeBaseResult(GetGradientaiKnowledgeBaseResult):
...
def get_gradientai_knowledge_base(added_to_agent_at: Optional[_builtins.str] = None,
                                  ...
                                  last_indexing_jobs: Optional[Sequence[Union['GetGradientaiKnowledgeBaseLastIndexingJobArgs', 'GetGradientaiKnowledgeBaseLastIndexingJobArgsDict', 'outputs.GetGradientaiKnowledgeBaseLastIndexingJobResult']]] = None,
                                  ...
                                  opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetGradientaiKnowledgeBaseResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('digitalocean:index/getGradientaiKnowledgeBase:getGradientaiKnowledgeBase', __args__, opts=opts, typ=GetGradientaiKnowledgeBaseResult).value

    return AwaitableGetGradientaiKnowledgeBaseResult(
...
def get_gradientai_knowledge_base_output(added_to_agent_at: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                                         database_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                                         embedding_model_uuid: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                                         is_public: pulumi.Input[Optional[Optional[_builtins.bool]]] = None,
                                         last_indexing_jobs: pulumi.Input[Optional[Optional[Sequence[Union['GetGradientaiKnowledgeBaseLastIndexingJobArgs', 'GetGradientaiKnowledgeBaseLastIndexingJobArgsDict', 'outputs.GetGradientaiKnowledgeBaseLastIndexingJobResult']]]]] = None,
                                         ...
                                         opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetGradientaiKnowledgeBaseResult]:
    """
    Use this data source to access information about an existing resource.
    """
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke_output('digitalocean:index/getGradientaiKnowledgeBase:getGradientaiKnowledgeBase', __args__, opts=opts, typ=GetGradientaiKnowledgeBaseResult)
    return __ret__.apply(lambda __response__: GetGradientaiKnowledgeBaseResult(
