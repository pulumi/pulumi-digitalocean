...
__all__ = [
    ...
    'AwaitableGetGradientaiOpenaiApiKeyResult',
    'get_gradientai_openai_api_key',
...
class GetGradientaiOpenaiApiKeyResult:
    ...
    @_builtins.property
    @pulumi.getter
    def models(self) -> Sequence['outputs.GetGradientaiOpenaiApiKeyModelResult']:
...
class AwaitableGetGradientaiOpenaiApiKeyResult(GetGradientaiOpenaiApiKeyResult):
...
def get_gradientai_openai_api_key(uuid: Optional[_builtins.str] = None,
                                  opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetGradientaiOpenaiApiKeyResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('digitalocean:index/getGradientaiOpenaiApiKey:getGradientaiOpenaiApiKey', __args__, opts=opts, typ=GetGradientaiOpenaiApiKeyResult).value

    return AwaitableGetGradientaiOpenaiApiKeyResult(
...
def get_gradientai_openai_api_key_output(uuid: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('digitalocean:index/getGradientaiOpenaiApiKey:getGradientaiOpenaiApiKey', __args__, opts=opts, typ=GetGradientaiOpenaiApiKeyResult)
    return __ret__.apply(lambda __response__: GetGradientaiOpenaiApiKeyResult(
