...
class GradientaiKnowledgeBaseDataSource(pulumi.CustomResource):
    ...
    def get(resource_name: str,
        ...
        __props__ = _GradientaiKnowledgeBaseDataSourceState.__new__(_GradientaiKnowledgeBaseDataSourceState)

        __props__.__dict__["knowledge_base_uuid"] = knowledge_base_uuid
        __props__.__dict__["spaces_data_source"] = spaces_data_source
        __props__.__dict__["web_crawler_data_source"] = web_crawler_data_source
        return GradientaiKnowledgeBaseDataSource(resource_name, opts=opts, __props__=__props__)
    ...
    @_builtins.property
    @pulumi.getter(name="spacesDataSource")
    def spaces_data_source(self) -> pulumi.Output[Optional['outputs.GradientaiKnowledgeBaseDataSourceSpacesDataSource']]:
        return pulumi.get(self, "spaces_data_source")

    @_builtins.property
    @pulumi.getter(name="webCrawlerDataSource")
    def web_crawler_data_source(self) -> pulumi.Output[Optional['outputs.GradientaiKnowledgeBaseDataSourceWebCrawlerDataSource']]:
        return pulumi.get(self, "web_crawler_data_source")
