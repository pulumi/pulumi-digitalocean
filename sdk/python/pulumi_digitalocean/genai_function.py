...
class GenaiFunctionArgs:
    def __init__(__self__, *,
                 ...
                 faas_namespace: pulumi.Input[builtins.str],
                 function_name: pulumi.Input[builtins.str],
                 input_schema: pulumi.Input[builtins.str],
                 faas_name: Optional[pulumi.Input[builtins.str]] = None,
                 output_schema: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a GenaiFunction resource.
        :param pulumi.Input[builtins.str] agent_id: The name of the GenAI resource.
        :param pulumi.Input[builtins.str] description: The region where the GenAI resource will be created.
        :param pulumi.Input[builtins.str] faas_namespace: The current status of the GenAI resource.
        :param pulumi.Input[builtins.str] function_name: The creation timestamp of the GenAI resource.
        :param pulumi.Input[builtins.str] input_schema: The input schema of the GenAI resource.
        :param pulumi.Input[builtins.str] faas_name: The model to use for the GenAI resource.
        :param pulumi.Input[builtins.str] output_schema: The output schema of the GenAI resource.
        """
    ...
    def faas_namespace(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def faas_namespace(self, value: pulumi.Input[builtins.str]):
    ...
    def input_schema(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @input_schema.setter
    def input_schema(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "input_schema", value)

    @property
    @pulumi.getter(name="faasName")
    def faas_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @faas_name.setter
    def faas_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _GenaiFunctionState:
    def __init__(__self__, *,
                 ...
                 faas_name: Optional[pulumi.Input[builtins.str]] = None,
                 faas_namespace: Optional[pulumi.Input[builtins.str]] = None,
                 function_name: Optional[pulumi.Input[builtins.str]] = None,
                 function_uuid: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] faas_namespace: The current status of the GenAI resource.
        :param pulumi.Input[builtins.str] function_name: The creation timestamp of the GenAI resource.
        :param pulumi.Input[builtins.str] function_uuid: The unique identifier of the GenAI function.
        :param pulumi.Input[builtins.str] input_schema: The input schema of the GenAI resource.
        :param pulumi.Input[builtins.str] output_schema: The output schema of the GenAI resource.
        """
    ...
    @property
    @pulumi.getter(name="faasNamespace")
    def faas_namespace(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The current status of the GenAI resource.
        """
        return pulumi.get(self, "faas_namespace")
    ...
    @faas_namespace.setter
    def faas_namespace(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "faas_namespace", value)
    ...
    def function_uuid(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def function_uuid(self, value: Optional[pulumi.Input[builtins.str]]):
...
class GenaiFunction(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            function_uuid: Optional[pulumi.Input[builtins.str]] = None,
            input_schema: Optional[pulumi.Input[builtins.str]] = None,
            output_schema: Optional[pulumi.Input[builtins.str]] = None) -> 'GenaiFunction':
        """
    ...
    @property
    @pulumi.getter(name="faasName")
    def faas_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The model to use for the GenAI resource.
        """
        return pulumi.get(self, "faas_name")
    ...
    @property
    @pulumi.getter(name="faasNamespace")
    def faas_namespace(self) -> pulumi.Output[builtins.str]:
        """
        The current status of the GenAI resource.
        """
        return pulumi.get(self, "faas_namespace")
    ...
    @property
    @pulumi.getter(name="functionUuid")
    def function_uuid(self) -> pulumi.Output[builtins.str]:
        """
        The unique identifier of the GenAI function.
        """
        return pulumi.get(self, "function_uuid")
    ...
    @property
    @pulumi.getter(name="inputSchema")
    def input_schema(self) -> pulumi.Output[builtins.str]:
        """
        The input schema of the GenAI resource.
        """
        return pulumi.get(self, "input_schema")
    ...
    @property
    @pulumi.getter(name="outputSchema")
    def output_schema(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The output schema of the GenAI resource.
        """
        return pulumi.get(self, "output_schema")
