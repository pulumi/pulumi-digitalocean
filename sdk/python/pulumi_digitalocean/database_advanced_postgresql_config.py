...
__all__ = ['DatabaseAdvancedPostgresqlConfigArgs', 'DatabaseAdvancedPostgresqlConfig']

@pulumi.input_type
class DatabaseAdvancedPostgresqlConfigArgs:
    def __init__(__self__, *,
                 cluster_id: pulumi.Input[_builtins.str],
                 pg_parameters: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None):
        """
        The set of arguments for constructing a DatabaseAdvancedPostgresqlConfig resource.

        :param pulumi.Input[_builtins.str] cluster_id: The ID of the target PostgreSQL Advanced Edition cluster.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] pg_parameters: A map of PostgreSQL GUC parameter names to their string values. Only parameters included in this map are managed by Terraform. Values use PostgreSQL GUC syntax (for example, `work_mem` is specified in kilobytes unless a unit suffix is provided).
        """
        pulumi.set(__self__, "cluster_id", cluster_id)
        if pg_parameters is not None:
            pulumi.set(__self__, "pg_parameters", pg_parameters)
    ...
    @_builtins.property
    @pulumi.getter(name="pgParameters")
    def pg_parameters(self) -> pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]]:
        """
        A map of PostgreSQL GUC parameter names to their string values. Only parameters included in this map are managed by Terraform. Values use PostgreSQL GUC syntax (for example, `work_mem` is specified in kilobytes unless a unit suffix is provided).
        """
        return pulumi.get(self, "pg_parameters")

    @pg_parameters.setter
    def pg_parameters(self, value: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]]):
        pulumi.set(self, "pg_parameters", value)


@pulumi.input_type
class _DatabaseAdvancedPostgresqlConfigState:
    def __init__(__self__, *,
...
@pulumi.type_token("digitalocean:index/databaseAdvancedPostgresqlConfig:DatabaseAdvancedPostgresqlConfig")
class DatabaseAdvancedPostgresqlConfig(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__,
        ...
        * `xmloption` - (Optional) Sets whether XML data in implicit parsing and serialization operations is to be considered as documents or content fragments. Default: `content`.
        ...
        :param str resource_name: The name of the resource.
        :param DatabaseAdvancedPostgresqlConfigArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(DatabaseAdvancedPostgresqlConfigArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = DatabaseAdvancedPostgresqlConfigArgs.__new__(DatabaseAdvancedPostgresqlConfigArgs)

            if cluster_id is None and not opts.urn:
                raise TypeError("Missing required property 'cluster_id'")
            __props__.__dict__["cluster_id"] = cluster_id
            __props__.__dict__["pg_parameters"] = pg_parameters
        super(DatabaseAdvancedPostgresqlConfig, __self__).__init__(
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            cluster_id: pulumi.Input[Optional[_builtins.str]] = None,
            pg_parameters: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None) -> 'DatabaseAdvancedPostgresqlConfig':
        """
        ...
        __props__ = _DatabaseAdvancedPostgresqlConfigState.__new__(_DatabaseAdvancedPostgresqlConfigState)

        __props__.__dict__["cluster_id"] = cluster_id
        __props__.__dict__["pg_parameters"] = pg_parameters
        return DatabaseAdvancedPostgresqlConfig(resource_name, opts=opts, __props__=__props__)
    ...
    @_builtins.property
    @pulumi.getter(name="pgParameters")
    def pg_parameters(self) -> pulumi.Output[Optional[Mapping[str, _builtins.str]]]:
        """
        A map of PostgreSQL GUC parameter names to their string values. Only parameters included in this map are managed by Terraform. Values use PostgreSQL GUC syntax (for example, `work_mem` is specified in kilobytes unless a unit suffix is provided).
        """
        return pulumi.get(self, "pg_parameters")
