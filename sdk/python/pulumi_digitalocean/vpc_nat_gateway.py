...
class VpcNatGatewayArgs:
    def __init__(__self__, *,
                 ...
                 egresses: pulumi.Input[Optional[Sequence[pulumi.Input['VpcNatGatewayEgressArgs']]]] = None,
                 icmp_timeout_seconds: pulumi.Input[Optional[_builtins.int]] = None,
                 name: pulumi.Input[Optional[_builtins.str]] = None,
                 project_id: pulumi.Input[Optional[_builtins.str]] = None,
                 tcp_timeout_seconds: pulumi.Input[Optional[_builtins.int]] = None,
                 udp_timeout_seconds: pulumi.Input[Optional[_builtins.int]] = None):
        """
    ...
    @_builtins.property
    @pulumi.getter
    def egresses(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['VpcNatGatewayEgressArgs']]]]:
        """
    ...
    @egresses.setter
    def egresses(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['VpcNatGatewayEgressArgs']]]]):
        pulumi.set(self, "egresses", value)

    @_builtins.property
    @pulumi.getter(name="icmpTimeoutSeconds")
    def icmp_timeout_seconds(self) -> pulumi.Input[Optional[_builtins.int]]:
        """
    ...
    def icmp_timeout_seconds(self, value: pulumi.Input[Optional[_builtins.int]]):
    ...
    def tcp_timeout_seconds(self) -> pulumi.Input[Optional[_builtins.int]]:
        """
    ...
    def tcp_timeout_seconds(self, value: pulumi.Input[Optional[_builtins.int]]):
        pulumi.set(self, "tcp_timeout_seconds", value)

    @_builtins.property
    @pulumi.getter(name="udpTimeoutSeconds")
    def udp_timeout_seconds(self) -> pulumi.Input[Optional[_builtins.int]]:
        """
    ...
    def udp_timeout_seconds(self, value: pulumi.Input[Optional[_builtins.int]]):
...
class _VpcNatGatewayState:
    def __init__(__self__, *,
                 ...
                 vpcs: pulumi.Input[Optional[Sequence[pulumi.Input['VpcNatGatewayVpcArgs']]]] = None):
        """
    ...
    @_builtins.property
    @pulumi.getter
    def vpcs(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['VpcNatGatewayVpcArgs']]]]:
        """
        The ingress VPC configuration of the VPC NAT Gateway, the supported arguments are
        documented below.
        """
    ...
    @vpcs.setter
    def vpcs(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['VpcNatGatewayVpcArgs']]]]):
        pulumi.set(self, "vpcs", value)
...
class VpcNatGateway(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 egresses: pulumi.Input[Optional[Sequence[pulumi.Input[Union['VpcNatGatewayEgressArgs', 'VpcNatGatewayEgressArgsDict', 'outputs.VpcNatGatewayEgress']]]]] = None,
                 icmp_timeout_seconds: pulumi.Input[Optional[_builtins.int]] = None,
                 name: pulumi.Input[Optional[_builtins.str]] = None,
                 project_id: pulumi.Input[Optional[_builtins.str]] = None,
                 region: pulumi.Input[Optional[_builtins.str]] = None,
                 ...
                 type: pulumi.Input[Optional[_builtins.str]] = None,
                 udp_timeout_seconds: pulumi.Input[Optional[_builtins.int]] = None,
                 vpcs: pulumi.Input[Optional[Sequence[pulumi.Input[Union['VpcNatGatewayVpcArgs', 'VpcNatGatewayVpcArgsDict', 'outputs.VpcNatGatewayVpc']]]]] = None,
                 __props__=None):
        """
        ...
        :param pulumi.Input[Sequence[pulumi.Input[Union['VpcNatGatewayEgressArgs', 'VpcNatGatewayEgressArgsDict', 'outputs.VpcNatGatewayEgress']]]] egresses: Embeds the list of public egresses assigned to the VPC NAT Gateway: resolves as list of
               `public_gateways` embedding the reserved `ipv4` addresses.
        :param pulumi.Input[_builtins.int] icmp_timeout_seconds: The egress timeout value for ICMP connections of the VPC NAT Gateway.
        :param pulumi.Input[_builtins.str] name: The name of the VPC NAT Gateway.
        :param pulumi.Input[_builtins.str] project_id: ID of the project to which the VPC NAT Gateway will be assigned.
        ...
        :param pulumi.Input[_builtins.str] type: The type of the VPC NAT Gateway.
        :param pulumi.Input[_builtins.int] udp_timeout_seconds: The egress timeout value for UDP connections of the VPC NAT Gateway.
        :param pulumi.Input[Sequence[pulumi.Input[Union['VpcNatGatewayVpcArgs', 'VpcNatGatewayVpcArgsDict', 'outputs.VpcNatGatewayVpc']]]] vpcs: The ingress VPC configuration of the VPC NAT Gateway, the supported arguments are
               documented below.
        """
        ...
    @overload
    ...
    def get(resource_name: str,
            ...
            udp_timeout_seconds: pulumi.Input[Optional[_builtins.int]] = None,
            updated_at: pulumi.Input[Optional[_builtins.str]] = None,
            vpcs: pulumi.Input[Optional[Sequence[pulumi.Input[Union['VpcNatGatewayVpcArgs', 'VpcNatGatewayVpcArgsDict', 'outputs.VpcNatGatewayVpc']]]]] = None) -> 'VpcNatGateway':
        """
