...
__all__ = [
    ...
    'AwaitableGetGradientaiAgentResult',
    'get_gradientai_agent',
...
class GetGradientaiAgentResult:
    ...
    def agent_guardrails(self) -> Optional[Sequence['outputs.GetGradientaiAgentAgentGuardrailResult']]:
    ...
    def anthropic_api_keys(self) -> Optional[Sequence['outputs.GetGradientaiAgentAnthropicApiKeyResult']]:
        return pulumi.get(self, "anthropic_api_keys")

    @_builtins.property
    @pulumi.getter(name="apiKeyInfos")
    def api_key_infos(self) -> Optional[Sequence['outputs.GetGradientaiAgentApiKeyInfoResult']]:
        return pulumi.get(self, "api_key_infos")

    @_builtins.property
    @pulumi.getter(name="apiKeys")
    def api_keys(self) -> Optional[Sequence['outputs.GetGradientaiAgentApiKeyResult']]:
        return pulumi.get(self, "api_keys")

    @_builtins.property
    @pulumi.getter(name="chatbotIdentifiers")
    def chatbot_identifiers(self) -> Optional[Sequence['outputs.GetGradientaiAgentChatbotIdentifierResult']]:
        return pulumi.get(self, "chatbot_identifiers")

    @_builtins.property
    @pulumi.getter
    def chatbots(self) -> Optional[Sequence['outputs.GetGradientaiAgentChatbotResult']]:
        return pulumi.get(self, "chatbots")

    @_builtins.property
    @pulumi.getter(name="childAgents")
    def child_agents(self) -> Sequence['outputs.GetGradientaiAgentChildAgentResult']:
    ...
    @_builtins.property
    @pulumi.getter
    def deployments(self) -> Optional[Sequence['outputs.GetGradientaiAgentDeploymentResult']]:
    ...
    @_builtins.property
    @pulumi.getter
    def functions(self) -> Optional[Sequence['outputs.GetGradientaiAgentFunctionResult']]:
    ...
    def knowledge_bases(self) -> Optional[Sequence['outputs.GetGradientaiAgentKnowledgeBaseResult']]:
    ...
    @_builtins.property
    @pulumi.getter
    def models(self) -> Sequence['outputs.GetGradientaiAgentModelResult']:
    ...
    def open_ai_api_keys(self) -> Optional[Sequence['outputs.GetGradientaiAgentOpenAiApiKeyResult']]:
        return pulumi.get(self, "open_ai_api_keys")

    @_builtins.property
    @pulumi.getter(name="parentAgents")
    def parent_agents(self) -> Sequence['outputs.GetGradientaiAgentParentAgentResult']:
    ...
    @_builtins.property
    @pulumi.getter
    def templates(self) -> Optional[Sequence['outputs.GetGradientaiAgentTemplateResult']]:
...
class AwaitableGetGradientaiAgentResult(GetGradientaiAgentResult):
...
def get_gradientai_agent(agent_guardrails: Optional[Sequence[Union['GetGradientaiAgentAgentGuardrailArgs', 'GetGradientaiAgentAgentGuardrailArgsDict', 'outputs.GetGradientaiAgentAgentGuardrailResult']]] = None,
                         agent_id: Optional[_builtins.str] = None,
                         anthropic_api_keys: Optional[Sequence[Union['GetGradientaiAgentAnthropicApiKeyArgs', 'GetGradientaiAgentAnthropicApiKeyArgsDict', 'outputs.GetGradientaiAgentAnthropicApiKeyResult']]] = None,
                         api_key_infos: Optional[Sequence[Union['GetGradientaiAgentApiKeyInfoArgs', 'GetGradientaiAgentApiKeyInfoArgsDict', 'outputs.GetGradientaiAgentApiKeyInfoResult']]] = None,
                         api_keys: Optional[Sequence[Union['GetGradientaiAgentApiKeyArgs', 'GetGradientaiAgentApiKeyArgsDict', 'outputs.GetGradientaiAgentApiKeyResult']]] = None,
                         chatbot_identifiers: Optional[Sequence[Union['GetGradientaiAgentChatbotIdentifierArgs', 'GetGradientaiAgentChatbotIdentifierArgsDict', 'outputs.GetGradientaiAgentChatbotIdentifierResult']]] = None,
                         chatbots: Optional[Sequence[Union['GetGradientaiAgentChatbotArgs', 'GetGradientaiAgentChatbotArgsDict', 'outputs.GetGradientaiAgentChatbotResult']]] = None,
                         deployments: Optional[Sequence[Union['GetGradientaiAgentDeploymentArgs', 'GetGradientaiAgentDeploymentArgsDict', 'outputs.GetGradientaiAgentDeploymentResult']]] = None,
                         description: Optional[_builtins.str] = None,
                         functions: Optional[Sequence[Union['GetGradientaiAgentFunctionArgs', 'GetGradientaiAgentFunctionArgsDict', 'outputs.GetGradientaiAgentFunctionResult']]] = None,
                         if_case: Optional[_builtins.str] = None,
                         k: Optional[_builtins.int] = None,
                         knowledge_bases: Optional[Sequence[Union['GetGradientaiAgentKnowledgeBaseArgs', 'GetGradientaiAgentKnowledgeBaseArgsDict', 'outputs.GetGradientaiAgentKnowledgeBaseResult']]] = None,
                         max_tokens: Optional[_builtins.int] = None,
                         models: Optional[Sequence[Union['GetGradientaiAgentModelArgs', 'GetGradientaiAgentModelArgsDict', 'outputs.GetGradientaiAgentModelResult']]] = None,
                         open_ai_api_keys: Optional[Sequence[Union['GetGradientaiAgentOpenAiApiKeyArgs', 'GetGradientaiAgentOpenAiApiKeyArgsDict', 'outputs.GetGradientaiAgentOpenAiApiKeyResult']]] = None,
                         ...
                         templates: Optional[Sequence[Union['GetGradientaiAgentTemplateArgs', 'GetGradientaiAgentTemplateArgsDict', 'outputs.GetGradientaiAgentTemplateResult']]] = None,
                         top_p: Optional[_builtins.float] = None,
                         url: Optional[_builtins.str] = None,
                         user_id: Optional[_builtins.str] = None,
                         opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetGradientaiAgentResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('digitalocean:index/getGradientaiAgent:getGradientaiAgent', __args__, opts=opts, typ=GetGradientaiAgentResult).value

    return AwaitableGetGradientaiAgentResult(
...
def get_gradientai_agent_output(agent_guardrails: pulumi.Input[Optional[Optional[Sequence[Union['GetGradientaiAgentAgentGuardrailArgs', 'GetGradientaiAgentAgentGuardrailArgsDict', 'outputs.GetGradientaiAgentAgentGuardrailResult']]]]] = None,
                                agent_id: pulumi.Input[Optional[_builtins.str]] = None,
                                anthropic_api_keys: pulumi.Input[Optional[Optional[Sequence[Union['GetGradientaiAgentAnthropicApiKeyArgs', 'GetGradientaiAgentAnthropicApiKeyArgsDict', 'outputs.GetGradientaiAgentAnthropicApiKeyResult']]]]] = None,
                                api_key_infos: pulumi.Input[Optional[Optional[Sequence[Union['GetGradientaiAgentApiKeyInfoArgs', 'GetGradientaiAgentApiKeyInfoArgsDict', 'outputs.GetGradientaiAgentApiKeyInfoResult']]]]] = None,
                                api_keys: pulumi.Input[Optional[Optional[Sequence[Union['GetGradientaiAgentApiKeyArgs', 'GetGradientaiAgentApiKeyArgsDict', 'outputs.GetGradientaiAgentApiKeyResult']]]]] = None,
                                chatbot_identifiers: pulumi.Input[Optional[Optional[Sequence[Union['GetGradientaiAgentChatbotIdentifierArgs', 'GetGradientaiAgentChatbotIdentifierArgsDict', 'outputs.GetGradientaiAgentChatbotIdentifierResult']]]]] = None,
                                chatbots: pulumi.Input[Optional[Optional[Sequence[Union['GetGradientaiAgentChatbotArgs', 'GetGradientaiAgentChatbotArgsDict', 'outputs.GetGradientaiAgentChatbotResult']]]]] = None,
                                deployments: pulumi.Input[Optional[Optional[Sequence[Union['GetGradientaiAgentDeploymentArgs', 'GetGradientaiAgentDeploymentArgsDict', 'outputs.GetGradientaiAgentDeploymentResult']]]]] = None,
                                description: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                                functions: pulumi.Input[Optional[Optional[Sequence[Union['GetGradientaiAgentFunctionArgs', 'GetGradientaiAgentFunctionArgsDict', 'outputs.GetGradientaiAgentFunctionResult']]]]] = None,
                                if_case: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                                k: pulumi.Input[Optional[Optional[_builtins.int]]] = None,
                                knowledge_bases: pulumi.Input[Optional[Optional[Sequence[Union['GetGradientaiAgentKnowledgeBaseArgs', 'GetGradientaiAgentKnowledgeBaseArgsDict', 'outputs.GetGradientaiAgentKnowledgeBaseResult']]]]] = None,
                                max_tokens: pulumi.Input[Optional[Optional[_builtins.int]]] = None,
                                models: pulumi.Input[Optional[Optional[Sequence[Union['GetGradientaiAgentModelArgs', 'GetGradientaiAgentModelArgsDict', 'outputs.GetGradientaiAgentModelResult']]]]] = None,
                                open_ai_api_keys: pulumi.Input[Optional[Optional[Sequence[Union['GetGradientaiAgentOpenAiApiKeyArgs', 'GetGradientaiAgentOpenAiApiKeyArgsDict', 'outputs.GetGradientaiAgentOpenAiApiKeyResult']]]]] = None,
                                retrieval_method: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                                route_created_by: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                                route_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                                route_uuid: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                                tags: pulumi.Input[Optional[Optional[Sequence[_builtins.str]]]] = None,
                                temperature: pulumi.Input[Optional[Optional[_builtins.float]]] = None,
                                templates: pulumi.Input[Optional[Optional[Sequence[Union['GetGradientaiAgentTemplateArgs', 'GetGradientaiAgentTemplateArgsDict', 'outputs.GetGradientaiAgentTemplateResult']]]]] = None,
                                top_p: pulumi.Input[Optional[Optional[_builtins.float]]] = None,
                                url: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                                user_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                                opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetGradientaiAgentResult]:
    """
    Use this data source to access information about an existing resource.
    """
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke_output('digitalocean:index/getGradientaiAgent:getGradientaiAgent', __args__, opts=opts, typ=GetGradientaiAgentResult)
    return __ret__.apply(lambda __response__: GetGradientaiAgentResult(
