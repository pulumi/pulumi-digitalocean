...
def get_genai_knowledge_base_data_sources(knowledge_base_uuid: Optional[builtins.str] = None,
...
def get_genai_knowledge_base_data_sources_output(knowledge_base_uuid: Optional[pulumi.Input[builtins.str]] = None,
