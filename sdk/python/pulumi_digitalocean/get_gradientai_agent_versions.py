...
__all__ = [
    ...
    'AwaitableGetGradientaiAgentVersionsResult',
    'get_gradientai_agent_versions',
...
class GetGradientaiAgentVersionsResult:
    ...
    def agent_versions(self) -> Sequence['outputs.GetGradientaiAgentVersionsAgentVersionResult']:
        return pulumi.get(self, "agent_versions")

    @_builtins.property
    @pulumi.getter
    def filters(self) -> Optional[Sequence['outputs.GetGradientaiAgentVersionsFilterResult']]:
    ...
    @_builtins.property
    @pulumi.getter
    def sorts(self) -> Optional[Sequence['outputs.GetGradientaiAgentVersionsSortResult']]:
        return pulumi.get(self, "sorts")


class AwaitableGetGradientaiAgentVersionsResult(GetGradientaiAgentVersionsResult):
...
def get_gradientai_agent_versions(agent_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('digitalocean:index/getGradientaiAgentVersions:getGradientaiAgentVersions', __args__, opts=opts, typ=GetGradientaiAgentVersionsResult).value

    return AwaitableGetGradientaiAgentVersionsResult(
...
def get_gradientai_agent_versions_output(agent_id: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('digitalocean:index/getGradientaiAgentVersions:getGradientaiAgentVersions', __args__, opts=opts, typ=GetGradientaiAgentVersionsResult)
    return __ret__.apply(lambda __response__: GetGradientaiAgentVersionsResult(
