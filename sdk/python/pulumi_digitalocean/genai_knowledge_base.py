...
class GenaiKnowledgeBaseArgs:
    def __init__(__self__, *,
                 ...
                 embedding_model_uuid: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] embedding_model_uuid: The unique identifier of the embedding model
        :param pulumi.Input[builtins.str] project_id: The unique identifier of the project to which the knowledge base belongs.
        :param pulumi.Input[builtins.str] added_to_agent_at: The time when the knowledge base was added to the agent.
        :param pulumi.Input[builtins.str] database_id: The unique identifier of the DigitalOcean OpenSearch database this knowledge base will use
        :param pulumi.Input[builtins.bool] is_public: Indicates whether the knowledge base is public or private.
        ...
        :param pulumi.Input[builtins.str] vpc_uuid: The unique identifier of the VPC to which the knowledge base belongs.
        """
    ...
    def embedding_model_uuid(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def embedding_model_uuid(self, value: pulumi.Input[builtins.str]):
...
class _GenaiKnowledgeBaseState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] added_to_agent_at: The time when the knowledge base was added to the agent.
        :param pulumi.Input[builtins.str] created_at: The time when the knowledge base was created.
        :param pulumi.Input[builtins.str] database_id: The unique identifier of the DigitalOcean OpenSearch database this knowledge base will use
        :param pulumi.Input[Sequence[pulumi.Input['GenaiKnowledgeBaseDatasourceArgs']]] datasources: Data sources for the knowledge base
        :param pulumi.Input[builtins.str] embedding_model_uuid: The unique identifier of the embedding model
        :param pulumi.Input[builtins.bool] is_public: Indicates whether the knowledge base is public or private.
...
class GenaiKnowledgeBase(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            region: Optional[pulumi.Input[builtins.str]] = None,
            tags: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            vpc_uuid: Optional[pulumi.Input[builtins.str]] = None) -> 'GenaiKnowledgeBase':
        """
    ...
    @property
    @pulumi.getter(name="addedToAgentAt")
    def added_to_agent_at(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The time when the knowledge base was added to the agent.
        """
        return pulumi.get(self, "added_to_agent_at")
    ...
    @property
    @pulumi.getter(name="embeddingModelUuid")
    def embedding_model_uuid(self) -> pulumi.Output[builtins.str]:
        """
        The unique identifier of the embedding model
        """
        return pulumi.get(self, "embedding_model_uuid")
    ...
    @property
    @pulumi.getter(name="vpcUuid")
    def vpc_uuid(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The unique identifier of the VPC to which the knowledge base belongs.
        """
        return pulumi.get(self, "vpc_uuid")
