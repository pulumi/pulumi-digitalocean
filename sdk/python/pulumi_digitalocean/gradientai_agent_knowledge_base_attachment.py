...
__all__ = ['GradientaiAgentKnowledgeBaseAttachmentArgs', 'GradientaiAgentKnowledgeBaseAttachment']
...
class GradientaiAgentKnowledgeBaseAttachment(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        Create a GradientaiAgentKnowledgeBaseAttachment resource with the given unique name, props, and options.
        :param str resource_name: The name of the resource.
        :param GradientaiAgentKnowledgeBaseAttachmentArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(GradientaiAgentKnowledgeBaseAttachmentArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = GradientaiAgentKnowledgeBaseAttachmentArgs.__new__(GradientaiAgentKnowledgeBaseAttachmentArgs)
    ...
    def get(resource_name: str,
        ...
        __props__ = _GradientaiAgentKnowledgeBaseAttachmentState.__new__(_GradientaiAgentKnowledgeBaseAttachmentState)

        __props__.__dict__["agent_uuid"] = agent_uuid
        __props__.__dict__["knowledge_base_uuid"] = knowledge_base_uuid
        return GradientaiAgentKnowledgeBaseAttachment(resource_name, opts=opts, __props__=__props__)
